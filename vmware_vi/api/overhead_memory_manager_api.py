...
class OverheadMemoryManagerApi:
    ...
    @validate_call
    def overhead_memory_manager_lookup_vm_overhead_memory(
        self,
        ...
        lookup_vm_overhead_memory_request_type: LookupVmOverheadMemoryRequestType,
        ...
        :type mo_id: str
        :param lookup_vm_overhead_memory_request_type: (required)
        :type lookup_vm_overhead_memory_request_type: LookupVmOverheadMemoryRequestType
        ...
        _param = self._overhead_memory_manager_lookup_vm_overhead_memory_serialize(
            mo_id=mo_id,
            lookup_vm_overhead_memory_request_type=lookup_vm_overhead_memory_request_type,
    ...
    @validate_call
    def overhead_memory_manager_lookup_vm_overhead_memory_with_http_info(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        lookup_vm_overhead_memory_request_type: LookupVmOverheadMemoryRequestType,
        _request_timeout: Union[
    ...
    @validate_call
    def overhead_memory_manager_lookup_vm_overhead_memory_without_preload_content(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        lookup_vm_overhead_memory_request_type: LookupVmOverheadMemoryRequestType,
        _request_timeout: Union[
    ...
    def _overhead_memory_manager_lookup_vm_overhead_memory_serialize(
        self,
        mo_id,
        lookup_vm_overhead_memory_request_type,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if lookup_vm_overhead_memory_request_type is not None:
            _body_params = lookup_vm_overhead_memory_request_type
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/OverheadMemoryManager/{moId}/LookupVmOverheadMemory',
