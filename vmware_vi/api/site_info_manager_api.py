...
class SiteInfoManagerApi:
    ...
    @validate_call
    def site_info_manager_get_site_info(
        self,
        ...
        _param = self._site_info_manager_get_site_info_serialize(
            mo_id=mo_id,
    ...
    @validate_call
    def site_info_manager_get_site_info_with_http_info(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def site_info_manager_get_site_info_without_preload_content(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
    ...
    def _site_info_manager_get_site_info_serialize(
        self,
        mo_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/SiteInfoManager/{moId}/GetSiteInfo',
