...
class HostAuthenticationManagerApi:
    ...
    @validate_call
    def host_authentication_manager_get_info(
        self,
        ...
        _param = self._host_authentication_manager_get_info_serialize(
            mo_id=mo_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "HostAuthenticationManagerInfo"
    ...
    @validate_call
    def host_authentication_manager_get_info_with_http_info(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HostAuthenticationManagerInfo]:
        """Information about Active Directory membership. 
    ...
    @validate_call
    def host_authentication_manager_get_info_without_preload_content(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
    ...
    def _host_authentication_manager_get_info_serialize(
        self,
        mo_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/HostAuthenticationManager/{moId}/info',
    ...
    @validate_call
    def host_authentication_manager_get_supported_store(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._host_authentication_manager_get_supported_store_serialize(
            mo_id=mo_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def host_authentication_manager_get_supported_store_with_http_info(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def host_authentication_manager_get_supported_store_without_preload_content(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
    ...
    def _host_authentication_manager_get_supported_store_serialize(
        self,
        mo_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/HostAuthenticationManager/{moId}/supportedStore',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
