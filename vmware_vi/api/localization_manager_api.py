...
class LocalizationManagerApi:
    ...
    @validate_call
    def localization_manager_get_catalog(
        self,
    ...
    ) -> List[LocalizationManagerMessageCatalog]:
        ...
        _param = self._localization_manager_get_catalog_serialize(
            mo_id=mo_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[LocalizationManagerMessageCatalog]"
    ...
    @validate_call
    def localization_manager_get_catalog_with_http_info(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LocalizationManagerMessageCatalog]]:
        """Fetches the descriptions of all the client-side localization message catalogs available for the current session locale. 
    ...
    @validate_call
    def localization_manager_get_catalog_without_preload_content(
        self,
        mo_id: Annotated[StrictStr, Field(description="A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.")],
        _request_timeout: Union[
            None,
    ...
    def _localization_manager_get_catalog_serialize(
        self,
        mo_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/LocalizationManager/{moId}/catalog',
