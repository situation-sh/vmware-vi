...
class ArrayOfComputeResourceHostSPBMLicenseInfoHostSPBMLicenseState(Any):
    """
    A boxed array of *ComputeResourceHostSPBMLicenseInfoHostSPBMLicenseState_enum*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[ComputeResourceHostSPBMLicenseInfoHostSPBMLicenseStateEnum] = Field(alias="_value")
