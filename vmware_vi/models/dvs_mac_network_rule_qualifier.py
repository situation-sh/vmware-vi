...
class DvsMacNetworkRuleQualifier(DvsNetworkRuleQualifier):
    """
    ...
    """ # noqa: E501
    source_address: Optional[MacAddress] = Field(default=None, alias="sourceAddress")
    destination_address: Optional[MacAddress] = Field(default=None, alias="destinationAddress")
    protocol: Optional[IntExpression] = None
    vlan_id: Optional[IntExpression] = Field(default=None, alias="vlanId")
