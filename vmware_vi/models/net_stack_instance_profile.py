...
class NetStackInstanceProfile(ApplyProfile):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Linkable identifier.  ***Since:*** vSphere API 5.5 ")
    dns_config: NetworkProfileDnsConfigProfile = Field(alias="dnsConfig")
    ip_route_config: IpRouteProfile = Field(alias="ipRouteConfig")
