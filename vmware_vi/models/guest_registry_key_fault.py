...
class GuestRegistryKeyFault(GuestRegistryFault):
    ...
    """ # noqa: E501
    key_name: StrictStr = Field(description="The full path to the windows registry key.  ***Since:*** vSphere API 6.0 ", alias="keyName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestRegistryKeyFault failed to lookup discriminator value from " +
...
GuestRegistryKeyFault.model_rebuild(raise_errors=False)
