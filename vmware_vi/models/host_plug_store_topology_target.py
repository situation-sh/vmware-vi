...
class HostPlugStoreTopologyTarget(DataObject):
    """
    This data object represents target information.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    key: StrictStr = Field(description="The identifier of the target.  This will be a string representing the transport information of the target.  ***Since:*** vSphere API 4.0 ")
