...
class BaseConfigInfo(DataObject):
    """
    ...
    """ # noqa: E501
    id: ID
    name: StrictStr = Field(description="Descriptive name of this object.  ***Since:*** vSphere API 6.5 ")
    create_time: datetime = Field(description="The date and time this object was created.  ***Since:*** vSphere API 6.5 ", alias="createTime")
    ...
    relocation_disabled: Optional[StrictBool] = Field(default=None, description="Is virtual storage object relocation disabled.  If not set, the default value is false.  ***Since:*** vSphere API 6.7 ", alias="relocationDisabled")
    native_snapshot_supported: Optional[StrictBool] = Field(default=None, description="Is virtual storage object supports native snapshot.  If not set, the default value is false.  ***Since:*** vSphere API 6.7 ", alias="nativeSnapshotSupported")
    changed_block_tracking_enabled: Optional[StrictBool] = Field(default=None, description="If Virtua storage object has changed block tracking enabled.  If not set, the default value is false.  ***Since:*** vSphere API 6.7 ", alias="changedBlockTrackingEnabled")
    backing: BaseConfigInfoBackingInfo
    metadata: Optional[List[KeyValue]] = Field(default=None, description="Metadata associated with the FCD if available.  ***Since:*** vSphere API 7.0.2.0 ")
    vclock: Optional[VslmVClockInfo] = None
    iofilter: Optional[List[StrictStr]] = Field(default=None, description="IDs of the IO Filters associated with the virtual disk.  See *IoFilterInfo.id*. The client cannot modify this information on a virtual machine.  ***Since:*** vSphere API 6.7 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("BaseConfigInfo failed to lookup discriminator value from " +
...
BaseConfigInfo.model_rebuild(raise_errors=False)
