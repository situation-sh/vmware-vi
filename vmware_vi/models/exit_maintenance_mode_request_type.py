...
class ExitMaintenanceModeRequestType(BaseModel):
    """
    The parameters of *HostSystem.ExitMaintenanceMode_Task*. 
    """ # noqa: E501
    timeout: StrictInt = Field(description="Number of seconds to wait for the exit maintenance mode to succeed. If the timeout is less than or equal to zero, there is no timeout. ")
