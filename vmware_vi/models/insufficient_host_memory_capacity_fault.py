...
class InsufficientHostMemoryCapacityFault(InsufficientHostCapacityFault):
    ...
    """ # noqa: E501
    unreserved: StrictInt = Field(description="The memory available on the host in bytes.  ***Since:*** vSphere API 4.0 ")
    requested: StrictInt = Field(description="The memory resource amount requested in the failed operation in bytes.  ***Since:*** vSphere API 4.0 ")
