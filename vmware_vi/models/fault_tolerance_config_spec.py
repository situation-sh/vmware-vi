...
class FaultToleranceConfigSpec(DataObject):
    """
    ...
    """ # noqa: E501
    meta_data_path: Optional[FaultToleranceMetaSpec] = Field(default=None, alias="metaDataPath")
    secondary_vm_spec: Optional[FaultToleranceVMConfigSpec] = Field(default=None, alias="secondaryVmSpec")
