...
class DeleteRegistryValueInGuestRequestType(BaseModel):
    """
    The parameters of *GuestWindowsRegistryManager.DeleteRegistryValueInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    value_name: GuestRegValueNameSpec = Field(alias="valueName")
    __properties: ClassVar[List[str]] = ["vm", "auth", "valueName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of value_name
        if self.value_name:
            _dict['valueName'] = self.value_name.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "valueName": GuestRegValueNameSpec.from_dict(obj.get("valueName")) if obj.get("valueName") is not None else None
        })
        return _obj
