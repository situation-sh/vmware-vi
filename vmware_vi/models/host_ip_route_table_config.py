...
class HostIpRouteTableConfig(DataObject):
    """
    ...
    """ # noqa: E501
    ip_route: Optional[List[HostIpRouteOp]] = Field(default=None, description="The array of Routing ops (routes to be added/removed)  ***Since:*** vSphere API 4.0 ", alias="ipRoute")
    ipv6_route: Optional[List[HostIpRouteOp]] = Field(default=None, alias="ipv6Route")
