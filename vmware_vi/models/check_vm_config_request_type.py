...
class CheckVmConfigRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["spec", "vm", "host", "pool", "testType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "spec": VirtualMachineConfigSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
