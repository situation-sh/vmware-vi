...
class GuestRegValueDataSpec(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestRegValueDataSpec failed to lookup discriminator value from " +
...
GuestRegValueDataSpec.model_rebuild(raise_errors=False)
