...
class VmCloneEvent(VmEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmCloneEvent failed to lookup discriminator value from " +
...
VmCloneEvent.model_rebuild(raise_errors=False)
