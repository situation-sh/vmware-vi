...
class UnsupportedDatastore(VmConfigFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("UnsupportedDatastore failed to lookup discriminator value from " +
...
UnsupportedDatastore.model_rebuild(raise_errors=False)
