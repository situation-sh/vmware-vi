...
class StorageProfile(ApplyProfile):
    ...
    """ # noqa: E501
    nas_storage: Optional[List[NasStorageProfile]] = Field(default=None, description="List of NAS storage subprofiles.  Use the *NasStorageProfile.key* property to access a subprofile in the list.  ***Since:*** vSphere API 4.0 ", alias="nasStorage")
