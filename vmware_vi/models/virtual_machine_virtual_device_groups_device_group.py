...
class VirtualMachineVirtualDeviceGroupsDeviceGroup(DataObject):
    """
    Base device group type. 
    """ # noqa: E501
    group_instance_key: StrictInt = Field(description="Group instance key.  Unique integer referencing device group. During group creation client should use a temporary negative number. Once group is added to the virtual machine, server generates non-negative integer that stays constant during group lifetime. See *VirtualDevice.key* for details. ", alias="groupInstanceKey")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineVirtualDeviceGroupsDeviceGroup failed to lookup discriminator value from " +
...
VirtualMachineVirtualDeviceGroupsDeviceGroup.model_rebuild(raise_errors=False)
