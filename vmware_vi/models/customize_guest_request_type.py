...
class CustomizeGuestRequestType(BaseModel):
    """
    ...
    config_params: Optional[List[OptionValue]] = Field(default=None, description="addtional key/value pair list to support third party customization. ", alias="configParams")
    __properties: ClassVar[List[str]] = ["vm", "auth", "spec", "configParams"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in config_params (list)
        _items = []
        if self.config_params:
            for _item in self.config_params:
                if _item:
                    _items.append(_item.to_dict())
            _dict['configParams'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": CustomizationSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
            "configParams": [OptionValue.from_dict(_item) for _item in obj.get("configParams")] if obj.get("configParams") is not None else None
        })
        return _obj
