...
class ServiceLocatorSAMLCredential(ServiceLocatorCredential):
    """
    ...
    """ # noqa: E501
    token: Optional[SecretStr] = Field(default=None, description="The SAML token for authentication  ***Since:*** vSphere API 6.0 ")
