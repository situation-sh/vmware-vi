...
class VirtualMachineFileLayoutExDiskLayout(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictInt = Field(description="Identifier for the virtual disk in *VirtualHardware.device*.  ***Since:*** vSphere API 4.0 ")
    chain: Optional[List[VirtualMachineFileLayoutExDiskUnit]] = Field(default=None, description="The disk-unit chain that makes up this virtual disk.  ***Since:*** vSphere API 4.0 ")
