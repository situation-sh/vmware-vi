...
class VirtualMachineProfileSpec(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineProfileSpec failed to lookup discriminator value from " +
...
VirtualMachineProfileSpec.model_rebuild(raise_errors=False)
