...
class CertMgrRevokeCertificatesRequestType(BaseModel):
    """
    The parameters of *CertificateManager.CertMgrRevokeCertificates_Task*. 
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="the hosts on which the certificates need to be revoked  Refers instances of *HostSystem*. ")
