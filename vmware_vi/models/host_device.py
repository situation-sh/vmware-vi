...
class HostDevice(DataObject):
    """
    This data object type defines a device on the host. 
    """ # noqa: E501
    device_name: StrictStr = Field(description="The name of the device on the host.  For example, /dev/cdrom or \\\\\\\\serverX\\\\device\\_name. ", alias="deviceName")
    device_type: StrictStr = Field(description="Device type when available: floppy, mouse, cdrom, disk, scsi device, or adapter. ", alias="deviceType")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostDevice failed to lookup discriminator value from " +
...
HostDevice.model_rebuild(raise_errors=False)
