...
class OvfImport(OvfFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfImport failed to lookup discriminator value from " +
...
OvfImport.model_rebuild(raise_errors=False)
