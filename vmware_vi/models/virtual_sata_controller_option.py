...
class VirtualSATAControllerOption(VirtualControllerOption):
    ...
    """ # noqa: E501
    num_sata_disks: IntOption = Field(alias="numSATADisks")
    num_sata_cdroms: IntOption = Field(alias="numSATACdroms")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualSATAControllerOption failed to lookup discriminator value from " +
...
VirtualSATAControllerOption.model_rebuild(raise_errors=False)
