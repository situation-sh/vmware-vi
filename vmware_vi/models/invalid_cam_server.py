...
class InvalidCAMServer(ActiveDirectoryFault):
    ...
    """ # noqa: E501
    cam_server: StrictStr = Field(description="The address of the CAM server.  ***Since:*** vSphere API 5.0 ", alias="camServer")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidCAMServer failed to lookup discriminator value from " +
...
InvalidCAMServer.model_rebuild(raise_errors=False)
