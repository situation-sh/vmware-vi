...
class DeviceUnsupportedForVmVersion(InvalidDeviceSpec):
    ...
    """ # noqa: E501
    current_version: StrictStr = Field(description="The current version of the virtual machine.  ***Since:*** vSphere API 4.0 ", alias="currentVersion")
    expected_version: StrictStr = Field(description="The minimum expected virtual mahcine version needed to support this device.  ***Since:*** vSphere API 4.0 ", alias="expectedVersion")
