...
class VirtualAppLinkInfo(DataObject):
    """
    Deprecated as of vSphere API 5.1.  Linked child information.  ***Since:*** vSphere API 4.1 
    """ # noqa: E501
    key: ManagedObjectReference
    destroy_with_parent: Optional[StrictBool] = Field(default=None, description="Whether the entity should be removed, when this vApp is removed  ***Since:*** vSphere API 4.1 ", alias="destroyWithParent")
