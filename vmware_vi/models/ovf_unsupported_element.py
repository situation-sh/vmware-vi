...
class OvfUnsupportedElement(OvfUnsupportedPackage):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the unsupported element  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfUnsupportedElement failed to lookup discriminator value from " +
...
OvfUnsupportedElement.model_rebuild(raise_errors=False)
