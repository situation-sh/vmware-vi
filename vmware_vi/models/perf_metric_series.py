...
class PerfMetricSeries(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PerfMetricSeries failed to lookup discriminator value from " +
...
PerfMetricSeries.model_rebuild(raise_errors=False)
