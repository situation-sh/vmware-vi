...
class HostVnicConnectedToCustomizedDVPortEvent(HostEvent):
    ...
    prev_port_key: Optional[StrictStr] = Field(default=None, description="Information about the previous Virtual NIC that is using the DVport.  ***Since:*** vSphere API 6.5 ", alias="prevPortKey")
