...
class HostVFlashResourceConfigurationResult(DataObject):
    """
    ...
    """ # noqa: E501
    device_path: Optional[List[StrictStr]] = Field(default=None, description="The original array of device path which user had specified  ***Since:*** vSphere API 5.5 ", alias="devicePath")
    vffs: Optional[HostVffsVolume] = None
    disk_configuration_result: Optional[List[HostDiskConfigurationResult]] = Field(default=None, description="Array of device operation results.  ***Since:*** vSphere API 5.5 ", alias="diskConfigurationResult")
