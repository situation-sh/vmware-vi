...
class VMwareDVSPvlanConfigSpec(DataObject):
    """
    This class defines the configuration of a PVLAN map entry  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    pvlan_entry: VMwareDVSPvlanMapEntry = Field(alias="pvlanEntry")
    operation: StrictStr = Field(description="Operation type.  See *ConfigSpecOperation_enum* for valid values, except for the \"edit\" value, which is not supported.  ***Since:*** vSphere API 4.0 ")
