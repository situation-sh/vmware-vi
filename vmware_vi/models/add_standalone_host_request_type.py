...
class AddStandaloneHostRequestType(BaseModel):
    """
    ...
    add_connected: StrictBool = Field(description="Flag to specify whether or not the host should be connected as soon as it is added. The host will not be added if a connection attempt is made and fails. ", alias="addConnected")
    license: Optional[StrictStr] = Field(default=None, description="Provide a licenseKey or licenseKeyType. See *LicenseManager* ")
    __properties: ClassVar[List[str]] = ["spec", "compResSpec", "addConnected", "license"]
