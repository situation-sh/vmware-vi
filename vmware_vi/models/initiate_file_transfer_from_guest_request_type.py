...
class InitiateFileTransferFromGuestRequestType(BaseModel):
    """
    The parameters of *GuestFileManager.InitiateFileTransferFromGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    guest_file_path: StrictStr = Field(description="The complete path to the file inside the guest that has to be transferred to the client. It cannot be a path to a directory or a symbolic link. ", alias="guestFilePath")
    __properties: ClassVar[List[str]] = ["vm", "auth", "guestFilePath"]
