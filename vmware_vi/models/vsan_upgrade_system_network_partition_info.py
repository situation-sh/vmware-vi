...
class VsanUpgradeSystemNetworkPartitionInfo(DataObject):
    """
    Information about a particular group of hosts making up a network partition.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    hosts: List[ManagedObjectReference] = Field(description="Hosts that make up the network partition  ***Since:*** vSphere API 6.0  Refers instances of *HostSystem*. ")
