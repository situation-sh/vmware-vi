...
class HostVirtualSwitchBondBridge(HostVirtualSwitchBridge):
    ...
    """ # noqa: E501
    nic_device: List[StrictStr] = Field(description="The list of keys of the physical network adapters to be bridged. ", alias="nicDevice")
    beacon: Optional[HostVirtualSwitchBeaconConfig] = None
