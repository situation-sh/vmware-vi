...
class VirtualUSBRemoteClientBackingInfo(VirtualDeviceRemoteDeviceBackingInfo):
    """
    The virtual remote client USB device backing class.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    hostname: StrictStr = Field(description="Hostname of the remote client where the physical USB device resides.  ***Since:*** vSphere API 5.0 ")
