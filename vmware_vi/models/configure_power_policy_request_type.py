...
class ConfigurePowerPolicyRequestType(BaseModel):
    """
    The parameters of *HostPowerSystem.ConfigurePowerPolicy*. 
    """ # noqa: E501
    key: StrictInt = Field(description="A key from one of the policies in *PowerSystemCapability.availablePolicy*. ")
