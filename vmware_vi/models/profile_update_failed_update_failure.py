...
class ProfileUpdateFailedUpdateFailure(DataObject):
    """
    ProfileUpdateFailedUpdateFailure
    """ # noqa: E501
    profile_path: ProfilePropertyPath = Field(alias="profilePath")
    err_msg: LocalizableMessage = Field(alias="errMsg")
