...
class UpdateAnswerFileRequestType(BaseModel):
    """
    The parameters of *HostProfileManager.UpdateAnswerFile_Task*. 
    """ # noqa: E501
    host: ManagedObjectReference
    config_spec: AnswerFileCreateSpec = Field(alias="configSpec")
    __properties: ClassVar[List[str]] = ["host", "configSpec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "configSpec": AnswerFileCreateSpec.from_dict(obj.get("configSpec")) if obj.get("configSpec") is not None else None
        })
        return _obj
