...
class VirtualEthernetCardOption(VirtualDeviceOption):
    ...
    """ # noqa: E501
    supported_oui: ChoiceOption = Field(alias="supportedOUI")
    mac_type: ChoiceOption = Field(alias="macType")
    wake_on_lan_enabled: BoolOption = Field(alias="wakeOnLanEnabled")
    vm_direct_path_gen2_supported: Optional[StrictBool] = Field(default=None, description="Deprecated as of vSphere API 8.0. VMDirectPath Gen 2 is no longer supported and there is no replacement.  Flag to indicate whether VMDirectPath Gen 2 is available on this device.  ***Since:*** vSphere API 4.1 ", alias="vmDirectPathGen2Supported")
    upt_compatibility_enabled: Optional[BoolOption] = Field(default=None, alias="uptCompatibilityEnabled")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualEthernetCardOption failed to lookup discriminator value from " +
...
VirtualEthernetCardOption.model_rebuild(raise_errors=False)
