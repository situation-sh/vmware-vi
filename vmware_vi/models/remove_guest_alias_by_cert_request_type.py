...
class RemoveGuestAliasByCertRequestType(BaseModel):
    """
    ...
    base64_cert: StrictStr = Field(description="The X.509 certificate to be removed, in base64 encoded DER format. ", alias="base64Cert")
    __properties: ClassVar[List[str]] = ["vm", "auth", "username", "base64Cert"]
