...
class VirtualMachineBaseIndependentFilterSpec(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineBaseIndependentFilterSpec failed to lookup discriminator value from " +
...
VirtualMachineBaseIndependentFilterSpec.model_rebuild(raise_errors=False)
