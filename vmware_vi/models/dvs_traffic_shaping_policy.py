...
class DVSTrafficShapingPolicy(InheritablePolicy):
    ...
    average_bandwidth: Optional[LongPolicy] = Field(default=None, alias="averageBandwidth")
    peak_bandwidth: Optional[LongPolicy] = Field(default=None, alias="peakBandwidth")
    burst_size: Optional[LongPolicy] = Field(default=None, alias="burstSize")
