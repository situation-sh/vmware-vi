...
class VirtualVmxnet3Option(VirtualVmxnetOption):
    ...
    """ # noqa: E501
    uptv2_enabled: Optional[BoolOption] = Field(default=None, alias="uptv2Enabled")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualVmxnet3Option failed to lookup discriminator value from " +
...
VirtualVmxnet3Option.model_rebuild(raise_errors=False)
