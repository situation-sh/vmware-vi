...
class SetMaxQueueDepthRequestType(BaseModel):
    """
    The parameters of *HostDatastoreSystem.SetMaxQueueDepth*. 
    """ # noqa: E501
    datastore: ManagedObjectReference
    max_qdepth: StrictInt = Field(description="Max queue depth value for a datastore ", alias="maxQdepth")
    __properties: ClassVar[List[str]] = ["datastore", "maxQdepth"]
