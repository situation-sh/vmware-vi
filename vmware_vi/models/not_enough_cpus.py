...
class NotEnoughCpus(VirtualHardwareCompatibilityIssue):
    ...
    """ # noqa: E501
    num_cpu_dest: StrictInt = Field(description="The number of CPUs present on the host. ", alias="numCpuDest")
    num_cpu_vm: StrictInt = Field(description="The number of virtual CPUs present in the virtual machine. ", alias="numCpuVm")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("NotEnoughCpus failed to lookup discriminator value from " +
...
NotEnoughCpus.model_rebuild(raise_errors=False)
