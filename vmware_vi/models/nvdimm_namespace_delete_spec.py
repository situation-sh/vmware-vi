...
class NvdimmNamespaceDeleteSpec(DataObject):
    """
    Arguments for deleting a namespace  ***Since:*** vSphere API 6.7 
    """ # noqa: E501
    uuid: StrictStr = Field(description="Universally unique identifier of the namespace to be deleted  ***Since:*** vSphere API 6.7 ")
