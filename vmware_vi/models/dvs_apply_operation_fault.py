...
class DvsApplyOperationFault(DvsFault):
    ...
    """ # noqa: E501
    object_fault: List[DvsApplyOperationFaultFaultOnObject] = Field(description="Faults occurred on the host during a DistributedVirtualSwitch operation.  ***Since:*** vSphere API 5.1 ", alias="objectFault")
