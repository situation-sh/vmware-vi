...
class SecurityError(RuntimeFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("SecurityError failed to lookup discriminator value from " +
...
SecurityError.model_rebuild(raise_errors=False)
