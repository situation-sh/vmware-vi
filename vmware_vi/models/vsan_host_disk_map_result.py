...
class VsanHostDiskMapResult(DataObject):
    """
    ...
    disk_result: Optional[List[VsanHostDiskResult]] = Field(default=None, description="List of results for each disk in the mapping.  ***Since:*** vSphere API 5.5 ", alias="diskResult")
