...
class VirtualMachineVMCIDeviceOptionFilterSpecOption(DataObject):
    """
    ...
    lower_dst_port_boundary: LongOption = Field(alias="lowerDstPortBoundary")
    upper_dst_port_boundary: LongOption = Field(alias="upperDstPortBoundary")
