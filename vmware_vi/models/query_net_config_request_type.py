...
class QueryNetConfigRequestType(BaseModel):
    """
    The parameters of *HostVirtualNicManager.QueryNetConfig*. 
    """ # noqa: E501
    nic_type: StrictStr = Field(description="The *HostVirtualNicManagerNicType_enum* ", alias="nicType")
    __properties: ClassVar[List[str]] = ["nicType"]
