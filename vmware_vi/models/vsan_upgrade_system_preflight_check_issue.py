...
class VsanUpgradeSystemPreflightCheckIssue(DataObject):
    """
    ...
    """ # noqa: E501
    msg: StrictStr = Field(description="Message describing the issue.  ***Since:*** vSphere API 6.0 ")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','VsanUpgradeSystemAPIBrokenIssue': 'VsanUpgradeSystemAPIBrokenIssue','VsanUpgradeSystemAutoClaimEnabledOnHostsIssue': 'VsanUpgradeSystemAutoClaimEnabledOnHostsIssue','VsanUpgradeSystemHostsDisconnectedIssue': 'VsanUpgradeSystemHostsDisconnectedIssue','VsanUpgradeSystemMissingHostsInClusterIssue': 'VsanUpgradeSystemMissingHostsInClusterIssue','VsanUpgradeSystemNetworkPartitionIssue': 'VsanUpgradeSystemNetworkPartitionIssue','VsanUpgradeSystemNotEnoughFreeCapacityIssue': 'VsanUpgradeSystemNotEnoughFreeCapacityIssue','VsanUpgradeSystemRogueHostsInClusterIssue': 'VsanUpgradeSystemRogueHostsInClusterIssue','VsanUpgradeSystemV2ObjectsPresentDuringDowngradeIssue': 'VsanUpgradeSystemV2ObjectsPresentDuringDowngradeIssue','VsanUpgradeSystemWrongEsxVersionIssue': 'VsanUpgradeSystemWrongEsxVersionIssue'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VsanUpgradeSystemPreflightCheckIssue failed to lookup discriminator value from " +
...
VsanUpgradeSystemPreflightCheckIssue.model_rebuild(raise_errors=False)
