...
class StorageDrsConfigSpec(DataObject):
    """
    ...
    """ # noqa: E501
    pod_config_spec: Optional[StorageDrsPodConfigSpec] = Field(default=None, alias="podConfigSpec")
    vm_config_spec: Optional[List[StorageDrsVmConfigSpec]] = Field(default=None, description="Changes to the per-virtual-machine storage DRS settings.  ***Since:*** vSphere API 5.0 ", alias="vmConfigSpec")
