...
class BackupBlobWriteFailure(DvsFault):
    ...
    """ # noqa: E501
    entity_name: StrictStr = Field(description="The entity name on which backupConfig write failed  ***Since:*** vSphere API 5.1 ", alias="entityName")
    entity_type: StrictStr = Field(description="The entity type on which backupConfig write failed  ***Since:*** vSphere API 5.1 ", alias="entityType")
    fault: MethodFault
