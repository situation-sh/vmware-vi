...
class VMotionInterfaceIssue(MigrationFault):
    ...
    """ # noqa: E501
    at_source_host: StrictBool = Field(description="Whether this error is for the source host. ", alias="atSourceHost")
    failed_host: StrictStr = Field(description="The name of the host with the bad interface. ", alias="failedHost")
    failed_host_entity: Optional[ManagedObjectReference] = Field(default=None, alias="failedHostEntity")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VMotionInterfaceIssue failed to lookup discriminator value from " +
...
VMotionInterfaceIssue.model_rebuild(raise_errors=False)
