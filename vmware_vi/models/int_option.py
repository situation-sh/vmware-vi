...
class IntOption(OptionType):
    ...
    """ # noqa: E501
    min: StrictInt = Field(description="The minimum value. ")
    max: StrictInt = Field(description="The maximum value. ")
    default_value: StrictInt = Field(description="The default value. ", alias="defaultValue")
