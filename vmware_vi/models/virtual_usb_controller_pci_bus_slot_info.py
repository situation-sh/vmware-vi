...
class VirtualUSBControllerPciBusSlotInfo(VirtualDevicePciBusSlotInfo):
    """
    ...
    """ # noqa: E501
    ehci_pci_slot_number: Optional[StrictInt] = Field(default=None, description="The pci slot number of eHCI controller.  This property should be used only when the ehciEnabled property is set to true.  ***Since:*** vSphere API 5.1 ", alias="ehciPciSlotNumber")
