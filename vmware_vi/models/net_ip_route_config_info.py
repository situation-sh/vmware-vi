...
class NetIpRouteConfigInfo(DataObject):
    """
    This data object reports the IP Route Table.  ***Since:*** vSphere API 4.1 
    """ # noqa: E501
    ip_route: Optional[List[NetIpRouteConfigInfoIpRoute]] = Field(default=None, description="IP routing table for all address families.  ***Since:*** vSphere API 4.1 ", alias="ipRoute")
