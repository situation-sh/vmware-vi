...
class HostVirtualSwitchBridge(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostVirtualSwitchBridge failed to lookup discriminator value from " +
...
HostVirtualSwitchBridge.model_rebuild(raise_errors=False)
