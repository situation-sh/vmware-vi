...
class SetRegistryValueInGuestRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["vm", "auth", "value"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "value": GuestRegValueSpec.from_dict(obj.get("value")) if obj.get("value") is not None else None
        })
        return _obj
