...
class FaultsByVM(DataObject):
    """
    VM specific faults.  This Class is used in e.g. *HostEnterMaintenanceResult*.  ***Since:*** vSphere API 6.7 
    """ # noqa: E501
    vm: ManagedObjectReference
    faults: Optional[List[MethodFault]] = Field(default=None, description="The array of faults related to the given VM.  ***Since:*** vSphere API 6.7 ")
