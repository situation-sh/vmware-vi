...
class HostProfilesEntityCustomizations(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostProfilesEntityCustomizations failed to lookup discriminator value from " +
...
HostProfilesEntityCustomizations.model_rebuild(raise_errors=False)
