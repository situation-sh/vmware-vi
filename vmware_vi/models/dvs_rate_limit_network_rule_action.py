...
class DvsRateLimitNetworkRuleAction(DvsNetworkRuleAction):
    """
    This class defines network rule action to ratelimit packets.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    packets_per_second: StrictInt = Field(description="Rate limit value specified in packets per second.  ***Since:*** vSphere API 5.5 ", alias="packetsPerSecond")
