...
class ArrayOfHostInternetScsiHbaIscsiIpv6AddressAddressConfigurationType(Any):
    """
    A boxed array of *HostInternetScsiHbaIscsiIpv6AddressAddressConfigurationType_enum*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[HostInternetScsiHbaIscsiIpv6AddressAddressConfigurationTypeEnum] = Field(alias="_value")
