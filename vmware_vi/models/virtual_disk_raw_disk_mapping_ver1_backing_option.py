...
class VirtualDiskRawDiskMappingVer1BackingOption(VirtualDeviceDeviceBackingOption):
    ...
    """ # noqa: E501
    descriptor_file_name_extensions: Optional[ChoiceOption] = Field(default=None, alias="descriptorFileNameExtensions")
    compatibility_mode: ChoiceOption = Field(alias="compatibilityMode")
