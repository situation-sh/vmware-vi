...
class LocalLicenseSource(LicenseSource):
    ...
    """ # noqa: E501
    license_keys: StrictStr = Field(description="The size of this string is implementation dependent.  It must contain ASCII or ISO Latin-1 characters only. ", alias="licenseKeys")
