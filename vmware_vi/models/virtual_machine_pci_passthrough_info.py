...
class VirtualMachinePciPassthroughInfo(VirtualMachineTargetInfo):
    ...
    """ # noqa: E501
    pci_device: HostPciDevice = Field(alias="pciDevice")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachinePciPassthroughInfo failed to lookup discriminator value from " +
...
VirtualMachinePciPassthroughInfo.model_rebuild(raise_errors=False)
