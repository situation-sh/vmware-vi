...
class HostNvmeTransportParameters(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostNvmeTransportParameters failed to lookup discriminator value from " +
...
HostNvmeTransportParameters.model_rebuild(raise_errors=False)
