...
class UpdateHostSpecificationRequestType(BaseModel):
    """
    The parameters of *HostSpecificationManager.UpdateHostSpecification*. 
    """ # noqa: E501
    host: ManagedObjectReference
    host_spec: HostSpecification = Field(alias="hostSpec")
    __properties: ClassVar[List[str]] = ["host", "hostSpec"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of host_spec
        if self.host_spec:
            _dict['hostSpec'] = self.host_spec.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hostSpec": HostSpecification.from_dict(obj.get("hostSpec")) if obj.get("hostSpec") is not None else None
        })
        return _obj
