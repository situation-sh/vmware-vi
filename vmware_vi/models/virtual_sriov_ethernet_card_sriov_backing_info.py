...
class VirtualSriovEthernetCardSriovBackingInfo(VirtualDeviceBackingInfo):
    """
    ...
    """ # noqa: E501
    physical_function_backing: Optional[VirtualPCIPassthroughDeviceBackingInfo] = Field(default=None, alias="physicalFunctionBacking")
    virtual_function_backing: Optional[VirtualPCIPassthroughDeviceBackingInfo] = Field(default=None, alias="virtualFunctionBacking")
    virtual_function_index: Optional[StrictInt] = Field(default=None, alias="virtualFunctionIndex")
