...
class VirtualMachineMetadataManagerVmMetadataInput(DataObject):
    """
    VmMetadataInput specifies the operation and metadata for a specific VM.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    operation: StrictStr = Field(description="The input operation type.  The values come from *VirtualMachineMetadataManagerVmMetadataOp_enum*  ***Since:*** vSphere API 5.5 ")
    vm_metadata: VirtualMachineMetadataManagerVmMetadata = Field(alias="vmMetadata")
