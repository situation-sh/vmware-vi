...
class HostAssignableHardwareBinding(DataObject):
    """
    Data object indicating a device instance has been allocated to a VM.  ***Since:*** vSphere API 7.0 
    """ # noqa: E501
    instance_id: StrictStr = Field(description="Instance ID of assigned device.  ***Since:*** vSphere API 7.0 ", alias="instanceId")
