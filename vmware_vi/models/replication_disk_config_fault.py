...
class ReplicationDiskConfigFault(ReplicationConfigFault):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the failure.  One of the above.  ***Since:*** vSphere API 5.0 ")
    vm_ref: Optional[ManagedObjectReference] = Field(default=None, alias="vmRef")
    key: Optional[StrictInt] = Field(default=None, description="The disk (device) key in the parent VM for identification purposes.  ***Since:*** vSphere API 5.0 ")
