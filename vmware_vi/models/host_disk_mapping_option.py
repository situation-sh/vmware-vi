...
class HostDiskMappingOption(DataObject):
    """
    The HostDiskMappingOption data object type describes the options for a virtual disk mapping to a host disk. 
    """ # noqa: E501
    physical_partition: Optional[List[HostDiskMappingPartitionOption]] = Field(default=None, description="Array of valid partitions on this physical disk.  There is no default for this array. ", alias="physicalPartition")
