...
class InsufficientMemoryResourcesFault(InsufficientResourcesFault):
    ...
    """ # noqa: E501
    unreserved: StrictInt = Field(description="The memory available in the resource pool requested in bytes. ")
    requested: StrictInt = Field(description="The memory resource amount requested in the failed operation in bytes. ")
