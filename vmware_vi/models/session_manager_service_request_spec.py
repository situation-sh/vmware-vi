...
class SessionManagerServiceRequestSpec(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("SessionManagerServiceRequestSpec failed to lookup discriminator value from " +
...
SessionManagerServiceRequestSpec.model_rebuild(raise_errors=False)
