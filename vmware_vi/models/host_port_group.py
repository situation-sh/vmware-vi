...
class HostPortGroup(DataObject):
    """
    ...
    port: Optional[List[HostPortGroupPort]] = Field(default=None, description="The ports that currently exist and are used on this port group. ")
    vswitch: Optional[HostVirtualSwitch] = None
    computed_policy: HostNetworkPolicy = Field(alias="computedPolicy")
...
HostPortGroup.model_rebuild(raise_errors=False)
