...
class VmBeingClonedEvent(VmCloneEvent):
    ...
    """ # noqa: E501
    dest_folder: FolderEventArgument = Field(alias="destFolder")
    dest_name: StrictStr = Field(description="The name of the destination virtual machine. ", alias="destName")
