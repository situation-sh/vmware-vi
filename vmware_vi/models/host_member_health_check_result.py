...
class HostMemberHealthCheckResult(DataObject):
    """
    This class defines healthcheck result of the vSphere Distributed Switch.  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    summary: Optional[StrictStr] = Field(default=None, description="The summary of health check result.  ***Since:*** vSphere API 5.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostMemberHealthCheckResult failed to lookup discriminator value from " +
...
HostMemberHealthCheckResult.model_rebuild(raise_errors=False)
