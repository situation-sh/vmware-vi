...
class PerfEntityMetricBase(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PerfEntityMetricBase failed to lookup discriminator value from " +
...
PerfEntityMetricBase.model_rebuild(raise_errors=False)
