...
class VirtualDiskSpec(DataObject):
    """
    Specification used to create or clone a virtual disk  ***Since:*** VI API 2.5 
    """ # noqa: E501
    disk_type: StrictStr = Field(description="The type of the new virtual disk.  See also *VirtualDiskType_enum*.  ***Since:*** VI API 2.5 ", alias="diskType")
    adapter_type: StrictStr = Field(description="The type of the virtual disk adapter for the new virtual disk.  See also *VirtualDiskAdapterType_enum*.  ***Since:*** VI API 2.5 ", alias="adapterType")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDiskSpec failed to lookup discriminator value from " +
...
VirtualDiskSpec.model_rebuild(raise_errors=False)
