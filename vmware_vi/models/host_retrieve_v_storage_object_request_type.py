...
class HostRetrieveVStorageObjectRequestType(BaseModel):
    """
    The parameters of *HostVStorageObjectManager.HostRetrieveVStorageObject*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    disk_info_flags: Optional[List[StrictStr]] = Field(default=None, description="Flags indicating the FCD information to be retrieved. If diskInfoFlags is unset, then all FCD information will be retrieved. See *vslmDiskInfoFlag_enum* for the list of supported values. ", alias="diskInfoFlags")
    __properties: ClassVar[List[str]] = ["id", "datastore", "diskInfoFlags"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "diskInfoFlags": obj.get("diskInfoFlags")
        })
        return _obj
