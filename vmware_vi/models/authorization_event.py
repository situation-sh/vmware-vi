...
class AuthorizationEvent(Event):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("AuthorizationEvent failed to lookup discriminator value from " +
...
AuthorizationEvent.model_rebuild(raise_errors=False)
