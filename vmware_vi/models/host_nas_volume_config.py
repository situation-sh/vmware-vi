...
class HostNasVolumeConfig(DataObject):
    """
    This describes the NAS Volume configuration containing the configurable properties on a NAS Volume  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    change_operation: Optional[StrictStr] = Field(default=None, description="Indicates the change operation to apply on this configuration specification.  See also *HostConfigChangeOperation_enum*.  ***Since:*** vSphere API 4.0 ", alias="changeOperation")
    spec: Optional[HostNasVolumeSpec] = None
