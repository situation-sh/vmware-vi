...
class UpdatePassthruConfigRequestType(BaseModel):
    """
    The parameters of *HostPciPassthruSystem.UpdatePassthruConfig*. 
    """ # noqa: E501
    config: List[HostPciPassthruConfig] = Field(description="The new PciPassthru configuration information.  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "config": [HostPciPassthruConfig.from_dict(_item) for _item in obj.get("config")] if obj.get("config") is not None else None
        })
        return _obj
