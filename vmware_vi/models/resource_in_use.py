...
class ResourceInUse(VimFault):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of resource that is in use. ")
    name: Optional[StrictStr] = Field(default=None, description="Name of the instance of the resource that is in use. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ResourceInUse failed to lookup discriminator value from " +
...
ResourceInUse.model_rebuild(raise_errors=False)
