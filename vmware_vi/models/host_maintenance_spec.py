...
class HostMaintenanceSpec(DataObject):
    """
    ...
    """ # noqa: E501
    vsan_mode: Optional[VsanHostDecommissionMode] = Field(default=None, alias="vsanMode")
    purpose: Optional[StrictStr] = Field(default=None, description="Maintenance mode reason code.  See *HostMaintenanceSpecPurpose_enum* for valid values.  ***Since:*** vSphere API 7.0 ")
