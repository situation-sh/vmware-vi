...
class DvsOperationBulkFault(DvsFault):
    ...
    """ # noqa: E501
    host_fault: List[DvsOperationBulkFaultFaultOnHost] = Field(description="Faults occurred on the host during a DistributedVirtualSwitch operation.  ***Since:*** vSphere API 4.0 ", alias="hostFault")
