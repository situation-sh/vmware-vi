...
class ArrayOfDistributedVirtualPortgroupNsxPortgroupOperationResult(Any):
    """
    A boxed array of *DistributedVirtualPortgroupNsxPortgroupOperationResult*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[DistributedVirtualPortgroupNsxPortgroupOperationResult] = Field(alias="_value")
