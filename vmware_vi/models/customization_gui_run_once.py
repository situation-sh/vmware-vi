...
class CustomizationGuiRunOnce(DataObject):
    """
    ...
    """ # noqa: E501
    command_list: List[StrictStr] = Field(description="A list of commands to run at first user logon, after guest customization. ", alias="commandList")
