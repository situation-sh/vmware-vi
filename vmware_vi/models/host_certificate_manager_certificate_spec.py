...
class HostCertificateManagerCertificateSpec(DataObject):
    """
    Represents certificate specification used for identifying a specific certificate supported by Host. 
    """ # noqa: E501
    kind: StrictStr = Field(description="The list of supported values can be found in *HostCertificateManagerCertificateKind_enum* ")
