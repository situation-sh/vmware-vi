...
class VchaClusterHealth(DataObject):
    """
    ...
    """ # noqa: E501
    runtime_info: VchaClusterRuntimeInfo = Field(alias="runtimeInfo")
    health_messages: Optional[List[LocalizableMessage]] = Field(default=None, description="A collection of Messages describing the reason for a non-healthy Cluster.  ***Since:*** vSphere API 6.5 ", alias="healthMessages")
    additional_information: Optional[List[LocalizableMessage]] = Field(default=None, description="A collection of additional information regarding the health messages.  ***Since:*** vSphere API 6.5 ", alias="additionalInformation")
