...
class VirtualEthernetCardOpaqueNetworkBackingInfo(VirtualDeviceBackingInfo):
    """
    This class defines backing for a virtual Ethernet card that connects to an opaque network.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    opaque_network_id: StrictStr = Field(description="The opaque network ID  ***Since:*** vSphere API 5.5 ", alias="opaqueNetworkId")
    opaque_network_type: StrictStr = Field(description="The opaque network type  ***Since:*** vSphere API 5.5 ", alias="opaqueNetworkType")
