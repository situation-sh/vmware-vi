...
class InvalidPropertyValue(VAppPropertyFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidPropertyValue failed to lookup discriminator value from " +
...
InvalidPropertyValue.model_rebuild(raise_errors=False)
