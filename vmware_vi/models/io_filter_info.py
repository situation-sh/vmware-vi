...
class IoFilterInfo(DataObject):
    """
    Information about an IO Filter.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    id: StrictStr = Field(description="IO Filter identifier.  ***Since:*** vSphere API 6.0 ")
    name: StrictStr = Field(description="Name of the IO Filter.  ***Since:*** vSphere API 6.0 ")
    vendor: StrictStr = Field(description="Vendor of the IO Filter.  ***Since:*** vSphere API 6.0 ")
    version: StrictStr = Field(description="Version of the IO Filter.  ***Since:*** vSphere API 6.0 ")
    type: Optional[StrictStr] = Field(default=None, description="Type of the IO Filter.  The set of possible values are listed in *IoFilterType_enum*. The property is unset if the information is not available.  ***Since:*** vSphere API 6.5 ")
    summary: Optional[StrictStr] = Field(default=None, description="Short description of the IO Filter.  The property is unset if the information is not available.  ***Since:*** vSphere API 6.0 ")
    release_date: Optional[StrictStr] = Field(default=None, description="Release date of the IO Filter.  The property is unset if the information is not available.  ***Since:*** vSphere API 6.0 ", alias="releaseDate")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("IoFilterInfo failed to lookup discriminator value from " +
...
IoFilterInfo.model_rebuild(raise_errors=False)
