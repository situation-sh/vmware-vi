...
class ConfigureDatastorePrincipalRequestType(BaseModel):
    """
    The parameters of *HostDatastoreSystem.ConfigureDatastorePrincipal*. 
    """ # noqa: E501
    user_name: StrictStr = Field(description="Datastore principal user name. ", alias="userName")
    password: Optional[SecretStr] = Field(default=None, description="Optional password for systems that require password for user impersonation. ")
