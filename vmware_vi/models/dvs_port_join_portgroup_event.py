...
class DvsPortJoinPortgroupEvent(DvsEvent):
    ...
    portgroup_key: StrictStr = Field(description="The portgroup key.  ***Since:*** vSphere API 4.0 ", alias="portgroupKey")
    portgroup_name: StrictStr = Field(description="The portgroup name.  ***Since:*** vSphere API 4.0 ", alias="portgroupName")
