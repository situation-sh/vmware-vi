...
class UpdateIpConfigRequestType(BaseModel):
    """
    The parameters of *HostVMotionSystem.UpdateIpConfig*. 
    """ # noqa: E501
    ip_config: HostIpConfig = Field(alias="ipConfig")
    __properties: ClassVar[List[str]] = ["ipConfig"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "ipConfig": HostIpConfig.from_dict(obj.get("ipConfig")) if obj.get("ipConfig") is not None else None
        })
        return _obj
