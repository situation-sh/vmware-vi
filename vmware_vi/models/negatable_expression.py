...
class NegatableExpression(DataObject):
    """
    ...
    """ # noqa: E501
    negate: Optional[StrictBool] = Field(default=None, description="Whether the configuration needs to be negated or not.  ***Since:*** vSphere API 5.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("NegatableExpression failed to lookup discriminator value from " +
...
NegatableExpression.model_rebuild(raise_errors=False)
