...
class CustomizationSysprepFailed(CustomizationFailed):
    ...
    """ # noqa: E501
    sysprep_version: StrictStr = Field(description="The version string for the sysprep files that were included in the customization package.  ***Since:*** VI API 2.5 ", alias="sysprepVersion")
    system_version: StrictStr = Field(description="The version string for the system  ***Since:*** VI API 2.5 ", alias="systemVersion")
