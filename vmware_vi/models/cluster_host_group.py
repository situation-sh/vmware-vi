...
class ClusterHostGroup(ClusterGroupInfo):
    ...
    """ # noqa: E501
    host: Optional[List[ManagedObjectReference]] = Field(default=None, description="List of hosts that are part of this group.  A host group can contain zero or more hosts.  ***Since:*** vSphere API 4.1  Refers instances of *HostSystem*. ")
