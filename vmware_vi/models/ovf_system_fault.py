...
class OvfSystemFault(OvfFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfSystemFault failed to lookup discriminator value from " +
...
OvfSystemFault.model_rebuild(raise_errors=False)
