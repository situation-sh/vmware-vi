...
class DVPortgroupRenamedEvent(DVPortgroupEvent):
    ...
    """ # noqa: E501
    old_name: StrictStr = Field(description="The old portgroup name.  ***Since:*** vSphere API 4.0 ", alias="oldName")
    new_name: StrictStr = Field(description="The new portgroup name.  ***Since:*** vSphere API 4.0 ", alias="newName")
