...
class HostDatastoreNameConflictConnectInfo(HostDatastoreConnectInfo):
    ...
    """ # noqa: E501
    new_datastore_name: StrictStr = Field(description="To resolve a conflict with existing datastores, a suggested new name of the datastore can be provided. ", alias="newDatastoreName")
