...
class AnswerFileOptionsCreateSpec(AnswerFileCreateSpec):
    ...
    """ # noqa: E501
    user_input: Optional[List[ProfileDeferredPolicyOptionParameter]] = Field(default=None, description="List of parameters that contain host-specific data.  ***Since:*** vSphere API 5.0 ", alias="userInput")
