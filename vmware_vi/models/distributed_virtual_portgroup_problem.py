...
class DistributedVirtualPortgroupProblem(DataObject):
    """
    ...
    """ # noqa: E501
    logical_switch_uuid: StrictStr = Field(description="The problematic logical switch UUID  ***Since:*** vSphere API 7.0 ", alias="logicalSwitchUuid")
    fault: MethodFault
