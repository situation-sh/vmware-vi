...
class ArrayOfClusterComputeResourceDvsProfileDVPortgroupSpecToServiceMapping(Any):
    """
    A boxed array of *ClusterComputeResourceDvsProfileDVPortgroupSpecToServiceMapping*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[ClusterComputeResourceDvsProfileDVPortgroupSpecToServiceMapping] = Field(alias="_value")
