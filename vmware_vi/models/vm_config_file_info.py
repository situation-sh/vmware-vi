...
class VmConfigFileInfo(FileInfo):
    ...
    """ # noqa: E501
    config_version: Optional[StrictInt] = Field(default=None, alias="configVersion")
    encryption: Optional[VmConfigFileEncryptionInfo] = None
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmConfigFileInfo failed to lookup discriminator value from " +
...
VmConfigFileInfo.model_rebuild(raise_errors=False)
