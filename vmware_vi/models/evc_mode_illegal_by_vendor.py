...
class EVCModeIllegalByVendor(EVCConfigFault):
    ...
    """ # noqa: E501
    cluster_cpu_vendor: StrictStr = Field(description="The CPU vendor in use in the cluster.  ***Since:*** VI API 2.5u2 ", alias="clusterCPUVendor")
    mode_cpu_vendor: StrictStr = Field(description="The CPU vendor for the requested EVC mode.  ***Since:*** VI API 2.5u2 ", alias="modeCPUVendor")
