...
class InvalidDeviceOperation(InvalidDeviceSpec):
    ...
    """ # noqa: E501
    bad_op: Optional[VirtualDeviceConfigSpecOperationEnum] = Field(default=None, alias="badOp")
    bad_file_op: Optional[VirtualDeviceConfigSpecFileOperationEnum] = Field(default=None, alias="badFileOp")
