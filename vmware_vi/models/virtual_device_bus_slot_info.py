...
class VirtualDeviceBusSlotInfo(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceBusSlotInfo failed to lookup discriminator value from " +
...
VirtualDeviceBusSlotInfo.model_rebuild(raise_errors=False)
