...
class VmShutdownOnIsolationEvent(VmPoweredOffEvent):
    ...
    """ # noqa: E501
    isolated_host: HostEventArgument = Field(alias="isolatedHost")
    shutdown_result: Optional[StrictStr] = Field(default=None, description="Indicates if the shutdown was successful.  If the shutdown failed, the virtual machine was powered off. see *VmShutdownOnIsolationEventOperation_enum*  ***Since:*** vSphere API 4.0 ", alias="shutdownResult")
