...
class CustomizationFailed(CustomizationEvent):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="Reason why the customization failed @see CustomizationFailed.ReasonCode .  ***Since:*** vSphere API 7.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationFailed failed to lookup discriminator value from " +
...
CustomizationFailed.model_rebuild(raise_errors=False)
