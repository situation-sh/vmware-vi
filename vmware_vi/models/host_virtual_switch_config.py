...
class HostVirtualSwitchConfig(DataObject):
    """
    ...
    """ # noqa: E501
    change_operation: Optional[StrictStr] = Field(default=None, description="This property indicates the change operation to apply on this configuration specification.  See also *HostConfigChangeOperation_enum*. ", alias="changeOperation")
    name: StrictStr = Field(description="The name of the virtual switch.  Maximum length is 32 characters. ")
    spec: Optional[HostVirtualSwitchSpec] = None
