...
class VsanHostDiskMapping(DataObject):
    """
    ...
    """ # noqa: E501
    ssd: HostScsiDisk
    non_ssd: List[HostScsiDisk] = Field(description="Set of non-SSD backing *HostScsiDisk*.  ***Since:*** vSphere API 5.5 ", alias="nonSsd")
