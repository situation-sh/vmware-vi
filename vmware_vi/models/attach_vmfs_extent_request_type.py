...
class AttachVmfsExtentRequestType(BaseModel):
    """
    The parameters of *HostStorageSystem.AttachVmfsExtent*. 
    """ # noqa: E501
    vmfs_path: StrictStr = Field(description="The path of the VMFS to extend. See *FileSystemMountInfo*. ", alias="vmfsPath")
    extent: HostScsiDiskPartition
    __properties: ClassVar[List[str]] = ["vmfsPath", "extent"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "vmfsPath": obj.get("vmfsPath"),
            "extent": HostScsiDiskPartition.from_dict(obj.get("extent")) if obj.get("extent") is not None else None
        })
        return _obj
