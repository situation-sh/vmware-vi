...
class SessionEvent(Event):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("SessionEvent failed to lookup discriminator value from " +
...
SessionEvent.model_rebuild(raise_errors=False)
