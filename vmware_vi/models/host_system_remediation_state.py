...
class HostSystemRemediationState(DataObject):
    """
    ...
    """ # noqa: E501
    state: StrictStr = Field(description="The remediation or precheck remediation operation state.  See *HostSystemRemediationStateState_enum* for the valid values.  ***Since:*** vSphere API 6.7 ")
    operation_time: datetime = Field(description="For any \"running\" state, this is the starting time; for others, this is the completion time.  ***Since:*** vSphere API 6.7 ", alias="operationTime")
