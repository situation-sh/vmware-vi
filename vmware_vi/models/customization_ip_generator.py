...
class CustomizationIpGenerator(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationIpGenerator failed to lookup discriminator value from " +
...
CustomizationIpGenerator.model_rebuild(raise_errors=False)
