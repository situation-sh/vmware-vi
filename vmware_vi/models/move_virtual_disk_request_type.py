...
class MoveVirtualDiskRequestType(BaseModel):
    """
    The parameters of *VirtualDiskManager.MoveVirtualDisk_Task*. 
    """ # noqa: E501
    source_name: StrictStr = Field(description="The name of the source, either a datastore path or a URL referring to the virtual disk to be moved. ", alias="sourceName")
    source_datacenter: Optional[ManagedObjectReference] = Field(default=None, alias="sourceDatacenter")
    dest_name: StrictStr = Field(description="The name of the destination, either a datastore path or a URL referring to the destination virtual disk. ", alias="destName")
    dest_datacenter: Optional[ManagedObjectReference] = Field(default=None, alias="destDatacenter")
    force: Optional[StrictBool] = Field(default=None, description="If true, overwrite any indentically named disk at the destination. If not specified, it is assumed to be false ")
    profile: Optional[List[VirtualMachineProfileSpec]] = Field(default=None, description="User can specify new set of profile when moving virtual disk.  ***Since:*** vSphere API 5.5 ")
    __properties: ClassVar[List[str]] = ["sourceName", "sourceDatacenter", "destName", "destDatacenter", "force", "profile"]
