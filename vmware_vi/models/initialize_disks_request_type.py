...
class InitializeDisksRequestType(BaseModel):
    """
    The parameters of *HostVsanSystem.InitializeDisks_Task*. 
    """ # noqa: E501
    mapping: List[VsanHostDiskMapping] = Field(description="list of disk mappings to initialize  ***Since:*** vSphere API 5.5 ")
