...
class RevertToSnapshotRequestType(BaseModel):
    """
    The parameters of *VirtualMachineSnapshot.RevertToSnapshot_Task*. 
    """ # noqa: E501
    host: Optional[ManagedObjectReference] = None
    suppress_power_on: Optional[StrictBool] = Field(default=None, description="(optional) If set to true, the virtual machine will not be powered on regardless of the power state when the snapshot was created. Default to false. ", alias="suppressPowerOn")
