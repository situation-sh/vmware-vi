...
class ArrayOfVirtualEthernetCardDistributedVirtualPortBackingInfo(Any):
    """
    A boxed array of *VirtualEthernetCardDistributedVirtualPortBackingInfo*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[VirtualEthernetCardDistributedVirtualPortBackingInfo] = Field(alias="_value")
