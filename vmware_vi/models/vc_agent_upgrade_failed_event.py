...
class VcAgentUpgradeFailedEvent(HostEvent):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason why the upgrade failed, if known.  See *AgentInstallFailedReason_enum*  ***Since:*** vSphere API 4.0 ")
