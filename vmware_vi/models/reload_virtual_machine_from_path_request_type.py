...
class ReloadVirtualMachineFromPathRequestType(BaseModel):
    """
    The parameters of *VirtualMachine.reloadVirtualMachineFromPath_Task*. 
    """ # noqa: E501
    configuration_path: StrictStr = Field(alias="configurationPath")
    __properties: ClassVar[List[str]] = ["configurationPath"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configurationPath": obj.get("configurationPath")
        })
        return _obj
