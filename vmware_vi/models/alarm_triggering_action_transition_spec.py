...
class AlarmTriggeringActionTransitionSpec(DataObject):
    """
    ...
    """ # noqa: E501
    start_state: ManagedEntityStatusEnum = Field(alias="startState")
    final_state: ManagedEntityStatusEnum = Field(alias="finalState")
    repeats: StrictBool = Field(description="Whether or not the action repeats, as per the actionFrequency defined in the enclosing Alarm.  ***Since:*** vSphere API 4.0 ")
