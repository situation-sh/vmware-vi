...
class VirtualDeviceFileBackingInfo(VirtualDeviceBackingInfo):
    ...
    """ # noqa: E501
    file_name: StrictStr = Field(description="Filename for the host file used in this backing. ", alias="fileName")
    datastore: Optional[ManagedObjectReference] = None
    backing_object_id: Optional[StrictStr] = Field(default=None, description="Backing object's durable and unmutable identifier.  Each backing object has a unique identifier which is not settable.  ***Since:*** vSphere API 5.5 ", alias="backingObjectId")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','VirtualCdromIsoBackingInfo': 'VirtualCdromIsoBackingInfo','VirtualDiskFlatVer1BackingInfo': 'VirtualDiskFlatVer1BackingInfo','VirtualDiskFlatVer2BackingInfo': 'VirtualDiskFlatVer2BackingInfo','VirtualDiskLocalPMemBackingInfo': 'VirtualDiskLocalPMemBackingInfo','VirtualDiskRawDiskMappingVer1BackingInfo': 'VirtualDiskRawDiskMappingVer1BackingInfo','VirtualDiskSeSparseBackingInfo': 'VirtualDiskSeSparseBackingInfo','VirtualDiskSparseVer1BackingInfo': 'VirtualDiskSparseVer1BackingInfo','VirtualDiskSparseVer2BackingInfo': 'VirtualDiskSparseVer2BackingInfo','VirtualFloppyImageBackingInfo': 'VirtualFloppyImageBackingInfo','VirtualNVDIMMBackingInfo': 'VirtualNVDIMMBackingInfo','VirtualParallelPortFileBackingInfo': 'VirtualParallelPortFileBackingInfo','VirtualSerialPortFileBackingInfo': 'VirtualSerialPortFileBackingInfo'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceFileBackingInfo failed to lookup discriminator value from " +
...
VirtualDeviceFileBackingInfo.model_rebuild(raise_errors=False)
