...
class ElementDescription(Description):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Enumeration or literal ID being described. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ElementDescription failed to lookup discriminator value from " +
...
ElementDescription.model_rebuild(raise_errors=False)
