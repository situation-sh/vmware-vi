...
class VirtualMachineDeviceRuntimeInfoDeviceRuntimeState(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineDeviceRuntimeInfoDeviceRuntimeState failed to lookup discriminator value from " +
...
VirtualMachineDeviceRuntimeInfoDeviceRuntimeState.model_rebuild(raise_errors=False)
