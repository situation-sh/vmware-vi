...
class NonHomeRDMVMotionNotSupported(MigrationFeatureNotSupported):
    ...
    """ # noqa: E501
    device: StrictStr = Field(description="The label of an RDM device for which an unsupported move was requested.  This is not guaranteed to be the only such device.  ***Since:*** VI API 2.5 ")
