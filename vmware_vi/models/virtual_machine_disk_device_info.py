...
class VirtualMachineDiskDeviceInfo(VirtualMachineTargetInfo):
    ...
    """ # noqa: E501
    capacity: Optional[StrictInt] = Field(default=None, description="Size of disk ")
    vm: Optional[List[ManagedObjectReference]] = Field(default=None, description="List of known virtual machines using this physical disk as a backing  Refers instances of *VirtualMachine*. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineDiskDeviceInfo failed to lookup discriminator value from " +
...
VirtualMachineDiskDeviceInfo.model_rebuild(raise_errors=False)
