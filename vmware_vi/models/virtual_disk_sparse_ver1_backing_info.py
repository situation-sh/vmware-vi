...
class VirtualDiskSparseVer1BackingInfo(VirtualDeviceFileBackingInfo):
    ...
    """ # noqa: E501
    disk_mode: StrictStr = Field(description="The disk persistence mode.  Valid values are: - *persistent* - *nonpersistent* - *undoable* - *independent_persistent* - *independent_nonpersistent* - *append*    See also *VirtualDiskMode_enum*. ", alias="diskMode")
    ...
    parent: Optional[VirtualDiskSparseVer1BackingInfo] = None
...
VirtualDiskSparseVer1BackingInfo.model_rebuild(raise_errors=False)
