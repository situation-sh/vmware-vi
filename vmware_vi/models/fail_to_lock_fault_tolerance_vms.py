...
class FailToLockFaultToleranceVMs(RuntimeFault):
    ...
    """ # noqa: E501
    vm_name: StrictStr = Field(description="The name of the vm to be locked.  ***Since:*** vSphere API 4.1 ", alias="vmName")
    vm: ManagedObjectReference
    already_locked_vm: ManagedObjectReference = Field(alias="alreadyLockedVm")
