...
class CustomFieldDefEvent(CustomFieldEvent):
    ...
    """ # noqa: E501
    field_key: StrictInt = Field(description="The unique identifier of the custom field definition. ", alias="fieldKey")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomFieldDefEvent failed to lookup discriminator value from " +
...
CustomFieldDefEvent.model_rebuild(raise_errors=False)
