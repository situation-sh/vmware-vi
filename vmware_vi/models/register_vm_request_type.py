...
class RegisterVMRequestType(BaseModel):
    """
    The parameters of *Folder.RegisterVM_Task*. 
    """ # noqa: E501
    path: StrictStr = Field(description="A datastore path to the virtual machine. ")
    ...
    as_template: StrictBool = Field(description="Flag to specify whether or not the virtual machine should be marked as a template. ", alias="asTemplate")
    pool: Optional[ManagedObjectReference] = None
    host: Optional[ManagedObjectReference] = None
    __properties: ClassVar[List[str]] = ["path", "name", "asTemplate", "pool", "host"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "pool": ManagedObjectReference.from_dict(obj.get("pool")) if obj.get("pool") is not None else None,
