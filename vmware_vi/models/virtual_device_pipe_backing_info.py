...
class VirtualDevicePipeBackingInfo(VirtualDeviceBackingInfo):
    ...
    """ # noqa: E501
    pipe_name: StrictStr = Field(description="Pipe name for the host pipe associated with this backing. ", alias="pipeName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDevicePipeBackingInfo failed to lookup discriminator value from " +
...
VirtualDevicePipeBackingInfo.model_rebuild(raise_errors=False)
