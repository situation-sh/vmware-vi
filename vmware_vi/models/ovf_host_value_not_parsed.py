...
class OvfHostValueNotParsed(OvfSystemFault):
    ...
    """ # noqa: E501
    var_property: StrictStr = Field(description="The host property field that could not be parsed.  ***Since:*** vSphere API 4.0 ", alias="property")
    value: StrictStr = Field(description="Value of the field that could not be parsed.  ***Since:*** vSphere API 4.0 ")
