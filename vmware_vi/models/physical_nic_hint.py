...
class PhysicalNicHint(DataObject):
    """
    This data object type describes each network of a physical network adapter's network hint. 
    """ # noqa: E501
    vlan_id: Optional[StrictInt] = Field(default=None, description="The optional VLAN Id of the network. ", alias="vlanId")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PhysicalNicHint failed to lookup discriminator value from " +
...
PhysicalNicHint.model_rebuild(raise_errors=False)
