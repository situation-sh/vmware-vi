...
class CustomizationIdentitySettings(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationIdentitySettings failed to lookup discriminator value from " +
...
CustomizationIdentitySettings.model_rebuild(raise_errors=False)
