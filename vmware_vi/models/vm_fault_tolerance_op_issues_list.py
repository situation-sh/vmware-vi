...
class VmFaultToleranceOpIssuesList(VmFaultToleranceIssue):
    ...
    """ # noqa: E501
    errors: Optional[List[MethodFault]] = Field(default=None, description="A list of faults representing errors  ***Since:*** vSphere API 4.0 ")
    warnings: Optional[List[MethodFault]] = None
