...
class HostAccountSpec(DataObject):
    """
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the specified account. ")
    password: Optional[SecretStr] = Field(default=None, description="The password for a user or group. ")
    description: Optional[StrictStr] = Field(default=None, description="The description of the specified account. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostAccountSpec failed to lookup discriminator value from " +
...
HostAccountSpec.model_rebuild(raise_errors=False)
