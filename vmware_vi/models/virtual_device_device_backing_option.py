...
class VirtualDeviceDeviceBackingOption(VirtualDeviceBackingOption):
    ...
    """ # noqa: E501
    auto_detect_available: BoolOption = Field(alias="autoDetectAvailable")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','VirtualCdromAtapiBackingOption': 'VirtualCdromAtapiBackingOption','VirtualCdromPassthroughBackingOption': 'VirtualCdromPassthroughBackingOption','VirtualCdromRemoteAtapiBackingOption': 'VirtualCdromRemoteAtapiBackingOption','VirtualDiskPartitionedRawDiskVer2BackingOption': 'VirtualDiskPartitionedRawDiskVer2BackingOption','VirtualDiskRawDiskMappingVer1BackingOption': 'VirtualDiskRawDiskMappingVer1BackingOption','VirtualDiskRawDiskVer2BackingOption': 'VirtualDiskRawDiskVer2BackingOption','VirtualEthernetCardLegacyNetworkBackingOption': 'VirtualEthernetCardLegacyNetworkBackingOption','VirtualEthernetCardNetworkBackingOption': 'VirtualEthernetCardNetworkBackingOption','VirtualFloppyDeviceBackingOption': 'VirtualFloppyDeviceBackingOption','VirtualPCIPassthroughDeviceBackingOption': 'VirtualPCIPassthroughDeviceBackingOption','VirtualPCIPassthroughDynamicBackingOption': 'VirtualPCIPassthroughDynamicBackingOption','VirtualParallelPortDeviceBackingOption': 'VirtualParallelPortDeviceBackingOption','VirtualPointingDeviceBackingOption': 'VirtualPointingDeviceBackingOption','VirtualSCSIPassthroughDeviceBackingOption': 'VirtualSCSIPassthroughDeviceBackingOption','VirtualSerialPortDeviceBackingOption': 'VirtualSerialPortDeviceBackingOption','VirtualSoundCardDeviceBackingOption': 'VirtualSoundCardDeviceBackingOption','VirtualUSBRemoteHostBackingOption': 'VirtualUSBRemoteHostBackingOption','VirtualUSBUSBBackingOption': 'VirtualUSBUSBBackingOption'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceDeviceBackingOption failed to lookup discriminator value from " +
...
VirtualDeviceDeviceBackingOption.model_rebuild(raise_errors=False)
