...
class ExtendedFault(VimFault):
    ...
    """ # noqa: E501
    fault_type_id: StrictStr = Field(description="The id of the type of extended fault.  ***Since:*** VI API 2.5 ", alias="faultTypeId")
    data: Optional[List[KeyValue]] = Field(default=None, description="Key/value pairs associated with fault.  ***Since:*** VI API 2.5 ")
