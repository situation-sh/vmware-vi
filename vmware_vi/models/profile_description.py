...
class ProfileDescription(DataObject):
    """
    ...
    """ # noqa: E501
    section: List[ProfileDescriptionSection] = Field(description="Sections which make up the profile description.  ***Since:*** vSphere API 4.0 ")
