...
class OvfDiskMappingNotFound(OvfSystemFault):
    ...
    """ # noqa: E501
    disk_name: StrictStr = Field(description="The disk name that is not found  ***Since:*** vSphere API 4.0 ", alias="diskName")
    vm_name: StrictStr = Field(description="The VM Name  ***Since:*** vSphere API 4.0 ", alias="vmName")
