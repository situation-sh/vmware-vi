...
class SessionManagerVmomiServiceRequestSpec(SessionManagerServiceRequestSpec):
    """
    ...
    """ # noqa: E501
    method: StrictStr = Field(description="Name of the method identified by this request spec  ***Since:*** vSphere API 5.1 ")
