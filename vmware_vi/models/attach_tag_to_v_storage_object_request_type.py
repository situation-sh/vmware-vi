...
class AttachTagToVStorageObjectRequestType(BaseModel):
    """
    ...
    tag: StrictStr = Field(description="The tag which has to be associated with the virtual storage object. ")
