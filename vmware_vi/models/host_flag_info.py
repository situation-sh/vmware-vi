...
class HostFlagInfo(DataObject):
    ...
    """ # noqa: E501
    background_snapshots_enabled: Optional[StrictBool] = Field(default=None, description="Flag to specify whether background snapshots are enabled.  ***Since:*** VI API 2.5 ", alias="backgroundSnapshotsEnabled")
