...
class HostInternetScsiHbaIscsiIpv6AddressAddressConfigurationType(Any):
    """
    A boxed *HostInternetScsiHbaIscsiIpv6AddressAddressConfigurationType_enum*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: HostInternetScsiHbaIscsiIpv6AddressAddressConfigurationTypeEnum = Field(alias="_value")
