...
class VmFaultToleranceConfigIssue(VmFaultToleranceIssue):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the failure.  ***Since:*** vSphere API 4.0 ")
    entity_name: Optional[StrictStr] = Field(default=None, description="The entity name.  Depending on the issue, it could be virtual machine or host.  ***Since:*** vSphere API 4.0 ", alias="entityName")
