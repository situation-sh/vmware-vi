...
class VmMigratedEvent(VmEvent):
    ...
    """ # noqa: E501
    source_host: HostEventArgument = Field(alias="sourceHost")
    source_datacenter: Optional[DatacenterEventArgument] = Field(default=None, alias="sourceDatacenter")
    source_datastore: Optional[DatastoreEventArgument] = Field(default=None, alias="sourceDatastore")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmMigratedEvent failed to lookup discriminator value from " +
...
VmMigratedEvent.model_rebuild(raise_errors=False)
