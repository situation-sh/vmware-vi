...
class ReplicationVmInProgressFault(ReplicationVmFault):
    ...
    """ # noqa: E501
    requested_activity: StrictStr = Field(description="The requsted activity for VM replication  ***Since:*** vSphere API 6.0 ", alias="requestedActivity")
    in_progress_activity: StrictStr = Field(description="The in-progress activity for VM replication  ***Since:*** vSphere API 6.0 ", alias="inProgressActivity")
