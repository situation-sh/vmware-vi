...
class DeleteHostSubSpecificationRequestType(BaseModel):
    """
    The parameters of *HostSpecificationManager.DeleteHostSubSpecification*. 
    """ # noqa: E501
    host: ManagedObjectReference
    sub_spec_name: StrictStr = Field(description="The name of the host sub specification to be deleted. ", alias="subSpecName")
    __properties: ClassVar[List[str]] = ["host", "subSpecName"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "subSpecName": obj.get("subSpecName")
        })
        return _obj
