...
class ThirdPartyLicenseAssignmentFailed(RuntimeFault):
    ...
    module: StrictStr = Field(description="The asset-id of 3rd party module  ***Since:*** vSphere API 5.0 ")
    reason: Optional[StrictStr] = Field(default=None, description="The reason why the assignment failed, if known.  ***Since:*** vSphere API 5.0 ")
