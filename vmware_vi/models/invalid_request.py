...
class InvalidRequest(RuntimeFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidRequest failed to lookup discriminator value from " +
...
InvalidRequest.model_rebuild(raise_errors=False)
