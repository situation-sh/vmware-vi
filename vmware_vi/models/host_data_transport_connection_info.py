...
class HostDataTransportConnectionInfo(DataObject):
    """
    ...
    """ # noqa: E501
    static_memory_consumed: StrictInt = Field(description="Static memory consumption by a connection in bytes like buffer sizes, heap sizes, etc.  ***Since:*** vSphere API 7.0.3.0 ", alias="staticMemoryConsumed")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostDataTransportConnectionInfo failed to lookup discriminator value from " +
...
HostDataTransportConnectionInfo.model_rebuild(raise_errors=False)
