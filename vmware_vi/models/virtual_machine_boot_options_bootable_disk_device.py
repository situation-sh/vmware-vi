...
class VirtualMachineBootOptionsBootableDiskDevice(VirtualMachineBootOptionsBootableDevice):
    """
    Bootable disk.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    device_key: StrictInt = Field(description="*Key* property of the bootable harddisk.  ***Since:*** vSphere API 5.0 ", alias="deviceKey")
