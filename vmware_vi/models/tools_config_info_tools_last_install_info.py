...
class ToolsConfigInfoToolsLastInstallInfo(DataObject):
    """
    Describes status of last tools upgrade attempt  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    counter: StrictInt = Field(description="Number of attempts that have been made to upgrade the version of tools installed on this virtual machine.  ***Since:*** vSphere API 5.0 ")
