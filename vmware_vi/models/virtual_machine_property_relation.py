...
class VirtualMachinePropertyRelation(DataObject):
    """
    ...
    """ # noqa: E501
    key: DynamicProperty
    relations: Optional[List[DynamicProperty]] = Field(default=None, description="The related properties and their values  ***Since:*** vSphere API 6.7 ")
