...
class DatastoreEvent(Event):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DatastoreEvent failed to lookup discriminator value from " +
...
DatastoreEvent.model_rebuild(raise_errors=False)
