...
class EntityPrivilege(DataObject):
    """
    This class defines whether a set of privileges are granted for a managed entity.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    entity: ManagedObjectReference
    priv_availability: List[PrivilegeAvailability] = Field(description="whether a set of privileges are granted for the managed entity.  ***Since:*** vSphere API 5.5 ", alias="privAvailability")
