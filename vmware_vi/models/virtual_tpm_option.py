...
class VirtualTPMOption(VirtualDeviceOption):
    ...
    """ # noqa: E501
    supported_firmware: Optional[List[StrictStr]] = Field(default=None, description="List of supported firmware selections, using *GuestOsDescriptorFirmwareType_enum* enumeration.  There is at least one value in this array.  ***Since:*** vSphere API 6.7 ", alias="supportedFirmware")
