...
class FirewallProfile(ApplyProfile):
    ...
    """ # noqa: E501
    ruleset: Optional[List[FirewallProfileRulesetProfile]] = Field(default=None, description="List of Rulesets that will be configured for the firewall subprofile.  The rulesets can be enabled or disabled from the profile.  ***Since:*** vSphere API 4.0 ")
