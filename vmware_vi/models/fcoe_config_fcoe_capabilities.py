...
class FcoeConfigFcoeCapabilities(DataObject):
    """
    Flags which indicate what parameters are settable for this FcoeConfig.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    priority_class: StrictBool = Field(alias="priorityClass")
    source_mac_address: StrictBool = Field(alias="sourceMacAddress")
    vlan_range: StrictBool = Field(alias="vlanRange")
