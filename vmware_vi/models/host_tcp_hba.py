...
class HostTcpHba(HostHostBusAdapter):
    """
    This data object describes the Transmission Control Protocol (TCP) host bus adapter interface.  ***Since:*** vSphere API 7.0.3.0 
    """ # noqa: E501
    associated_pnic: Optional[StrictStr] = Field(default=None, description="Device name of the associated physical NIC, if any.  Should match the *PhysicalNic.device* property of the corresponding physical NIC.  ***Since:*** vSphere API 7.0.3.0 ", alias="associatedPnic")
