...
class ListProcessesInGuestRequestType(BaseModel):
    """
    The parameters of *GuestProcessManager.ListProcessesInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    pids: Optional[List[StrictInt]] = Field(default=None, description="If set, only return information about the specified processes. Otherwise, information about all processes are returned. If a specified processes does not exist, nothing will be returned for that process. ")
    __properties: ClassVar[List[str]] = ["vm", "auth", "pids"]
