...
class HostHbaCreateSpec(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostHbaCreateSpec failed to lookup discriminator value from " +
...
HostHbaCreateSpec.model_rebuild(raise_errors=False)
