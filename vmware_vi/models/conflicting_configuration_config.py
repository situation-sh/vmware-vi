...
class ConflictingConfigurationConfig(DataObject):
    """
    ...
    property_path: StrictStr = Field(description="The property paths that are in conflict.  ***Since:*** vSphere API 5.5 ", alias="propertyPath")
