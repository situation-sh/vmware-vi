...
class VmRelocateSpecEvent(VmEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmRelocateSpecEvent failed to lookup discriminator value from " +
...
VmRelocateSpecEvent.model_rebuild(raise_errors=False)
