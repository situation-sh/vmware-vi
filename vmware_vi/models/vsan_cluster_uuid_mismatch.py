...
class VsanClusterUuidMismatch(CannotMoveVsanEnabledHost):
    ...
    """ # noqa: E501
    host_cluster_uuid: StrictStr = Field(description="The VSAN cluster UUID in use by the host at hand.  ***Since:*** vSphere API 5.5 ", alias="hostClusterUuid")
    destination_cluster_uuid: StrictStr = Field(description="The VSAN cluster UUID in use by the destination *ClusterComputeResource*.  ***Since:*** vSphere API 5.5 ", alias="destinationClusterUuid")
