...
class InvalidPowerState(InvalidState):
    ...
    """ # noqa: E501
    requested_state: Optional[VirtualMachinePowerStateEnum] = Field(default=None, alias="requestedState")
    existing_state: VirtualMachinePowerStateEnum = Field(alias="existingState")
