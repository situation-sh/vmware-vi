...
class PortGroupProfile(ApplyProfile):
    ...
    *PortGroupProfile* is the base class for the different port group subprofile objects.  ***Since:*** vSphere API 4.0 
    ...
    network_policy: NetworkPolicyProfile = Field(alias="networkPolicy")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PortGroupProfile failed to lookup discriminator value from " +
...
PortGroupProfile.model_rebuild(raise_errors=False)
