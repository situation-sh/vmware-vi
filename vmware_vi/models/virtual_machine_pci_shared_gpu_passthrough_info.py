...
class VirtualMachinePciSharedGpuPassthroughInfo(VirtualMachineTargetInfo):
    """
    Description of a gpu PCI device that can be shared with a virtual machine.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    vgpu: StrictStr = Field(description="The VGPU corresponding to this GPU passthrough device.  ***Since:*** vSphere API 6.0 ")
