...
class OptionValue(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("OptionValue failed to lookup discriminator value from " +
...
OptionValue.model_rebuild(raise_errors=False)
