...
class MismatchedVMotionNetworkNames(MigrationFault):
    ...
    """ # noqa: E501
    source_network: StrictStr = Field(description="The name of the network used by the source host VMotion interface. ", alias="sourceNetwork")
    dest_network: StrictStr = Field(description="The name of the network used by the destination host VMotion interface. ", alias="destNetwork")
