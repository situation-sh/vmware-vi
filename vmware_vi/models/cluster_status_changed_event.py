...
class ClusterStatusChangedEvent(ClusterEvent):
    ...
    """ # noqa: E501
    old_status: StrictStr = Field(description="The old (*status*). ", alias="oldStatus")
    new_status: StrictStr = Field(description="The new (*status*). ", alias="newStatus")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterStatusChangedEvent failed to lookup discriminator value from " +
...
ClusterStatusChangedEvent.model_rebuild(raise_errors=False)
