...
class HostPlugStoreTopologyDevice(DataObject):
    """
    ...
    lun: ScsiLun
    path: Optional[List[HostPlugStoreTopologyPath]] = Field(default=None, description="The array of paths available to access this LogicalUnit.  ***Since:*** vSphere API 4.0 ")
...
HostPlugStoreTopologyDevice.model_rebuild(raise_errors=False)
