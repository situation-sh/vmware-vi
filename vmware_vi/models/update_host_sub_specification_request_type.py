...
class UpdateHostSubSpecificationRequestType(BaseModel):
    """
    The parameters of *HostSpecificationManager.UpdateHostSubSpecification*. 
    """ # noqa: E501
    host: ManagedObjectReference
    host_sub_spec: HostSubSpecification = Field(alias="hostSubSpec")
    __properties: ClassVar[List[str]] = ["host", "hostSubSpec"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of host_sub_spec
        if self.host_sub_spec:
            _dict['hostSubSpec'] = self.host_sub_spec.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hostSubSpec": HostSubSpecification.from_dict(obj.get("hostSubSpec")) if obj.get("hostSubSpec") is not None else None
        })
        return _obj
