...
class ClusterInfraUpdateHaConfigInfoRemediationTypeEnum(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClusterInfraUpdateHaConfigInfoRemediationTypeEnum from a JSON string"""
