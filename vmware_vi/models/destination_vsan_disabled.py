...
class DestinationVsanDisabled(CannotMoveVsanEnabledHost):
    ...
    """ # noqa: E501
    destination_cluster: StrictStr = Field(description="Name of the disabled destination *ClusterComputeResource*.  See also *ManagedEntity.name*.  ***Since:*** vSphere API 5.5 ", alias="destinationCluster")
