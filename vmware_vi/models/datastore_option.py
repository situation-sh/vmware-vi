...
class DatastoreOption(DataObject):
    """
    The DatastoreOption data object describes datastore options for a virtual machine. 
    """ # noqa: E501
    unsupported_volumes: Optional[List[VirtualMachineDatastoreVolumeOption]] = Field(default=None, description="The type of file system volumes on which this virtual machine cannot have its disk and configuration files. ", alias="unsupportedVolumes")
