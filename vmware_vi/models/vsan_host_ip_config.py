...
class VsanHostIpConfig(DataObject):
    """
    ...
    """ # noqa: E501
    upstream_ip_address: StrictStr = Field(description="Agent-to-master multicast IP address.  ***Since:*** vSphere API 5.5 ", alias="upstreamIpAddress")
    downstream_ip_address: StrictStr = Field(description="Master-to-agent multicast IP address.  ***Since:*** vSphere API 5.5 ", alias="downstreamIpAddress")
