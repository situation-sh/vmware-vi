...
class DuplicateIpDetectedEvent(HostEvent):
    ...
    """ # noqa: E501
    duplicate_ip: StrictStr = Field(description="The Duplicate IP address detected.  ***Since:*** VI API 2.5 ", alias="duplicateIP")
    mac_address: StrictStr = Field(description="The MAC associated with duplicate IP.  ***Since:*** VI API 2.5 ", alias="macAddress")
