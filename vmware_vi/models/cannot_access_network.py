...
class CannotAccessNetwork(CannotAccessVmDevice):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CannotAccessNetwork failed to lookup discriminator value from " +
...
CannotAccessNetwork.model_rebuild(raise_errors=False)
