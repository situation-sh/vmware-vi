...
class ExpandVmfsExtentRequestType(BaseModel):
    """
    The parameters of *HostStorageSystem.ExpandVmfsExtent*. 
    """ # noqa: E501
    vmfs_path: StrictStr = Field(description="The path of the VMFS to expand. See *FileSystemMountInfo*. ", alias="vmfsPath")
