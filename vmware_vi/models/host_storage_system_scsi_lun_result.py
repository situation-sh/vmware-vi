...
class HostStorageSystemScsiLunResult(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="UUID of LUN on which the LUN operation was requested.  ***Since:*** vSphere API 6.0 ")
