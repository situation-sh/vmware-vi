...
class OpaqueNetworkTargetInfo(VirtualMachineTargetInfo):
    """
    ...
    network_reservation_supported: Optional[StrictBool] = Field(default=None, description="Indicates whether network bandwidth reservation is supported on the opaque network  ***Since:*** vSphere API 6.0 ", alias="networkReservationSupported")
