...
class DistributedVirtualSwitchHostMemberConfigSpec(DataObject):
    """
    ...
    operation: StrictStr = Field(description="Host member operation type.  See *ConfigSpecOperation_enum* for valid values.  ***Since:*** vSphere API 4.0 ")
    host: ManagedObjectReference
    backing: Optional[DistributedVirtualSwitchHostMemberBacking] = None
    max_proxy_switch_ports: Optional[StrictInt] = Field(default=None, description="Maximum number of ports allowed in the *HostProxySwitch*.  _ESXi 5.0 and earlier hosts_: If you are reconfiguring an existing host membership, that is, the proxy switch already exists, you must reboot the host for the new setting to take effect.  ***Since:*** vSphere API 4.0 ", alias="maxProxySwitchPorts")
