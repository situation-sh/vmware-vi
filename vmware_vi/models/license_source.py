...
class LicenseSource(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("LicenseSource failed to lookup discriminator value from " +
...
LicenseSource.model_rebuild(raise_errors=False)
