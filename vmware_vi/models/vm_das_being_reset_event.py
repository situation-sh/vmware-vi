...
class VmDasBeingResetEvent(VmEvent):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason why this vm is being reset  ***Since:*** vSphere API 4.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmDasBeingResetEvent failed to lookup discriminator value from " +
...
VmDasBeingResetEvent.model_rebuild(raise_errors=False)
