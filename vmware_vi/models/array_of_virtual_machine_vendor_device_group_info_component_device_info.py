...
class ArrayOfVirtualMachineVendorDeviceGroupInfoComponentDeviceInfo(Any):
    """
    A boxed array of *VirtualMachineVendorDeviceGroupInfoComponentDeviceInfo*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[VirtualMachineVendorDeviceGroupInfoComponentDeviceInfo] = Field(alias="_value")
