...
class VirtualMachineIdeDiskDevicePartitionInfo(DataObject):
    """
    Describes the partition sizes 
    """ # noqa: E501
    id: StrictInt = Field(description="Identification of the partition ")
    capacity: StrictInt = Field(description="Size of partition ")
