...
class ReconfigureServiceConsoleReservationRequestType(BaseModel):
    """
    The parameters of *HostMemorySystem.ReconfigureServiceConsoleReservation*. 
    """ # noqa: E501
    cfg_bytes: StrictInt = Field(alias="cfgBytes")
    __properties: ClassVar[List[str]] = ["cfgBytes"]
