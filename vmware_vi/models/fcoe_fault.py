...
class FcoeFault(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("FcoeFault failed to lookup discriminator value from " +
...
FcoeFault.model_rebuild(raise_errors=False)
