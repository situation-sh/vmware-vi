...
class VsanUpgradeSystemUpgradeHistoryDiskGroupOp(VsanUpgradeSystemUpgradeHistoryItem):
    """
    ...
    """ # noqa: E501
    operation: StrictStr = Field(description="Type of the operation, e.g.  add or remove.  See also *VsanUpgradeSystemUpgradeHistoryDiskGroupOpType_enum*.  ***Since:*** vSphere API 6.0 ")
    disk_mapping: VsanHostDiskMapping = Field(alias="diskMapping")
