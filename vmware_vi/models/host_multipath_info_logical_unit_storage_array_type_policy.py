...
class HostMultipathInfoLogicalUnitStorageArrayTypePolicy(DataObject):
    """
    ...
    """ # noqa: E501
    policy: StrictStr = Field(description="String indicating the storage array type policy.  ***Since:*** vSphere API 4.0 ")
