...
class HostExtendDiskRequestType(BaseModel):
    """
    The parameters of *HostVStorageObjectManager.HostExtendDisk_Task*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    new_capacity_in_mb: StrictInt = Field(description="The new capacity of the virtual disk in MB. ", alias="newCapacityInMB")
    __properties: ClassVar[List[str]] = ["id", "datastore", "newCapacityInMB"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "newCapacityInMB": obj.get("newCapacityInMB")
        })
        return _obj
