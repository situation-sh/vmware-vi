...
class VsanHostMembershipInfo(DataObject):
    """
    ...
    """ # noqa: E501
    node_uuid: StrictStr = Field(description="VSAN node UUID for the host of this MembershipInfo.  See also *VsanHostClusterStatus.nodeUuid*.  ***Since:*** vSphere API 5.5 ", alias="nodeUuid")
    hostname: StrictStr = Field(description="Hostname for the host of this MembershipInfo.  May be the empty string \"\" if the hostname is unavailable.  ***Since:*** vSphere API 5.5 ")
