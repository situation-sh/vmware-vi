...
class ClusterDependencyRuleInfo(ClusterRuleInfo):
    """
    ...
    """ # noqa: E501
    vm_group: StrictStr = Field(description="Virtual group name.  The virtual group may contain one or more virtual machines. *ClusterVmGroup*.*ClusterGroupInfo.name*  ***Since:*** vSphere API 6.5 ", alias="vmGroup")
    depends_on_vm_group: StrictStr = Field(description="Depdendency virtual group name (*ClusterVmGroup*.*ClusterGroupInfo.name*).  The virtual group may contain one or more virtual machines.  ***Since:*** vSphere API 6.5 ", alias="dependsOnVmGroup")
