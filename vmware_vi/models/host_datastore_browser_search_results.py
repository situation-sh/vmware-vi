...
class HostDatastoreBrowserSearchResults(DataObject):
    """
    ...
    folder_path: Optional[StrictStr] = Field(default=None, description="Relative path to the top-level folder. ", alias="folderPath")
    file: Optional[List[FileInfo]] = Field(default=None, description="Set of matching files, if any. ")
