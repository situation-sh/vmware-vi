...
class HostGraphicsConfigSharedPassthruAssignmentPolicyEnum(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of HostGraphicsConfigSharedPassthruAssignmentPolicyEnum from a JSON string"""
