...
class HostIncompatibleForFaultTolerance(VmFaultToleranceIssue):
    ...
    reason: Optional[StrictStr] = Field(default=None, description="The specific reason why the host does not support fault tolerance.  Values should come from *HostIncompatibleForFaultToleranceReason_enum*.  ***Since:*** vSphere API 4.0 ")
