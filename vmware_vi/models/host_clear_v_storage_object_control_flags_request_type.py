...
class HostClearVStorageObjectControlFlagsRequestType(BaseModel):
    """
    The parameters of *HostVStorageObjectManager.HostClearVStorageObjectControlFlags*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    control_flags: Optional[List[StrictStr]] = Field(default=None, description="control flags enum array to be cleared on the VStorageObject. All control flags not included in the array remain intact. ", alias="controlFlags")
    __properties: ClassVar[List[str]] = ["id", "datastore", "controlFlags"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "controlFlags": obj.get("controlFlags")
        })
        return _obj
