...
class PatchMetadataInvalid(VimFault):
    ...
    """ # noqa: E501
    patch_id: StrictStr = Field(description="The patch ID whose associated metadata is invalid. ", alias="patchID")
    meta_data: Optional[List[StrictStr]] = Field(default=None, description="The metadata file that is not available or corrupted. ", alias="metaData")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PatchMetadataInvalid failed to lookup discriminator value from " +
...
PatchMetadataInvalid.model_rebuild(raise_errors=False)
