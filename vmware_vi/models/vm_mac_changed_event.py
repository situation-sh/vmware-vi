...
class VmMacChangedEvent(VmEvent):
    ...
    """ # noqa: E501
    adapter: StrictStr = Field(description="The name of the virtual network adapter. ")
    old_mac: StrictStr = Field(description="The old MAC address. ", alias="oldMac")
    new_mac: StrictStr = Field(description="The new MAC address. ", alias="newMac")
