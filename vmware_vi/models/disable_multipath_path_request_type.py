...
class DisableMultipathPathRequestType(BaseModel):
    """
    The parameters of *HostStorageSystem.DisableMultipathPath*. 
    """ # noqa: E501
    path_name: StrictStr = Field(description="The name of the path to disable. ", alias="pathName")
    __properties: ClassVar[List[str]] = ["pathName"]
