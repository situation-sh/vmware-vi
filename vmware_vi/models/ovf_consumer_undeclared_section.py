...
class OvfConsumerUndeclaredSection(OvfConsumerCallbackFault):
    ...
    """ # noqa: E501
    qualified_section_type: StrictStr = Field(description="The undeclared qualified section type appended by the OVF consumer.  ***Since:*** vSphere API 5.0 ", alias="qualifiedSectionType")
