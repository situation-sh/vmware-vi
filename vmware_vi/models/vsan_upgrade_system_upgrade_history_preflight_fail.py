...
class VsanUpgradeSystemUpgradeHistoryPreflightFail(VsanUpgradeSystemUpgradeHistoryItem):
    """
    ...
    """ # noqa: E501
    preflight_result: VsanUpgradeSystemPreflightCheckResult = Field(alias="preflightResult")
