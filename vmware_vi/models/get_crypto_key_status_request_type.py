...
class GetCryptoKeyStatusRequestType(BaseModel):
    """
    The parameters of *CryptoManagerHost.GetCryptoKeyStatus*. 
    """ # noqa: E501
    keys: Optional[List[CryptoKeyId]] = Field(default=None, description="\\[in\\] Cryptographic keys to query status.  ***Since:*** vSphere API 6.5 ")
