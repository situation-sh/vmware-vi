...
class FloatOption(OptionType):
    ...
    """ # noqa: E501
    min: Union[StrictFloat, StrictInt] = Field(description="The minimum value. ")
    max: Union[StrictFloat, StrictInt] = Field(description="The maximum value. ")
    default_value: Union[StrictFloat, StrictInt] = Field(description="The default value. ", alias="defaultValue")
