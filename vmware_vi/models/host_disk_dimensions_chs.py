...
class HostDiskDimensionsChs(DataObject):
    """
    ...
    """ # noqa: E501
    cylinder: StrictInt = Field(description="The number of cylinders. ")
    head: StrictInt = Field(description="The number of heads per cylinders. ")
    sector: StrictInt = Field(description="The number of sectors per head. ")
