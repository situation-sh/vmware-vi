...
class HostGetVFlashModuleDefaultConfigRequestType(BaseModel):
    """
    The parameters of *HostVFlashManager.HostGetVFlashModuleDefaultConfig*. 
    """ # noqa: E501
    v_flash_module: StrictStr = Field(description="Name of the vFlash module ", alias="vFlashModule")
    __properties: ClassVar[List[str]] = ["vFlashModule"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "vFlashModule": obj.get("vFlashModule")
        })
        return _obj
