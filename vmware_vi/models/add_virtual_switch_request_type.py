...
class AddVirtualSwitchRequestType(BaseModel):
    """
    The parameters of *HostNetworkSystem.AddVirtualSwitch*. 
    """ # noqa: E501
    vswitch_name: StrictStr = Field(alias="vswitchName")
    spec: Optional[HostVirtualSwitchSpec] = None
    __properties: ClassVar[List[str]] = ["vswitchName", "spec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": HostVirtualSwitchSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
