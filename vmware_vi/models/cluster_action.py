...
class ClusterAction(DataObject):
    """
    Base class for all action recommendations in VirtualCenter.  ***Since:*** VI API 2.5 
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the action.  This is encoded to differentiate between different types of actions aimed at achieving different goals.  ***Since:*** VI API 2.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterAction failed to lookup discriminator value from " +
...
ClusterAction.model_rebuild(raise_errors=False)
