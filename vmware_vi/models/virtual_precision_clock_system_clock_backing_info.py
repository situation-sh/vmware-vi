...
class VirtualPrecisionClockSystemClockBackingInfo(VirtualDeviceBackingInfo):
    """
    ...
    """ # noqa: E501
    protocol: Optional[StrictStr] = Field(default=None, description="The time synchronization protocol used to discipline system clock.  See *HostDateTimeInfoProtocol_enum* for valid values.  ***Since:*** vSphere API 7.0 ")
