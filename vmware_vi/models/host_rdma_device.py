...
class HostRdmaDevice(DataObject):
    """
    ...
    device: StrictStr = Field(description="The device name of the RDMA device.  ***Since:*** vSphere API 7.0 ")
    driver: Optional[StrictStr] = Field(default=None, description="The short string name of the device driver, if available.  ***Since:*** vSphere API 7.0 ")
    description: Optional[StrictStr] = Field(default=None, description="Device description, if available.  ***Since:*** vSphere API 7.0 ")
    backing: Optional[HostRdmaDeviceBacking] = None
    connection_info: HostRdmaDeviceConnectionInfo = Field(alias="connectionInfo")
