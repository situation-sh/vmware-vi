...
class SessionManagerLocalTicket(DataObject):
    """
    ...
    """ # noqa: E501
    user_name: StrictStr = Field(description="User name to be used for logon. ", alias="userName")
    password_file_path: StrictStr = Field(description="Absolute local path to the file containing a one-time password. ", alias="passwordFilePath")
