...
class CustomFieldEvent(Event):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomFieldEvent failed to lookup discriminator value from " +
...
CustomFieldEvent.model_rebuild(raise_errors=False)
