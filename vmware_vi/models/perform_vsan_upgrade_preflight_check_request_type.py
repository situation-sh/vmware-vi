...
class PerformVsanUpgradePreflightCheckRequestType(BaseModel):
    """
    The parameters of *VsanUpgradeSystem.PerformVsanUpgradePreflightCheck*. 
    """ # noqa: E501
    cluster: ManagedObjectReference
    downgrade_format: Optional[StrictBool] = Field(default=None, description="Intend to perform a on-disk format downgrade instead of upgrade. Adds additional checks. ", alias="downgradeFormat")
    __properties: ClassVar[List[str]] = ["cluster", "downgradeFormat"]
