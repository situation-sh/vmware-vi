...
class HostTpmSoftwareComponentEventDetails(HostTpmEventDetails):
    """
    ...
    """ # noqa: E501
    component_name: StrictStr = Field(description="Name of the software component that caused this TPM event.  ***Since:*** vSphere API 5.1 ", alias="componentName")
    vib_name: StrictStr = Field(description="Name of the VIB containing the software component.  ***Since:*** vSphere API 5.1 ", alias="vibName")
    vib_version: StrictStr = Field(description="Version of the VIB containing the software component.  ***Since:*** vSphere API 5.1 ", alias="vibVersion")
    vib_vendor: StrictStr = Field(description="Vendor of the VIB containing the software component.  ***Since:*** vSphere API 5.1 ", alias="vibVendor")
