...
class OvfMissingElement(OvfElement):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfMissingElement failed to lookup discriminator value from " +
...
OvfMissingElement.model_rebuild(raise_errors=False)
