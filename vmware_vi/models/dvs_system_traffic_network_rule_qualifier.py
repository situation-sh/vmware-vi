...
class DvsSystemTrafficNetworkRuleQualifier(DvsNetworkRuleQualifier):
    """
    ...
    """ # noqa: E501
    type_of_system_traffic: Optional[StringExpression] = Field(default=None, alias="typeOfSystemTraffic")
