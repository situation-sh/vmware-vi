...
class VMwareUplinkPortOrderPolicy(InheritablePolicy):
    ...
    """ # noqa: E501
    active_uplink_port: Optional[List[StrictStr]] = Field(default=None, description="List of active uplink ports used for load balancing.  ***Since:*** vSphere API 4.0 ", alias="activeUplinkPort")
    standby_uplink_port: Optional[List[StrictStr]] = Field(default=None, description="Standby uplink ports used for failover.  ***Since:*** vSphere API 4.0 ", alias="standbyUplinkPort")
