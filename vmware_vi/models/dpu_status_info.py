...
class DpuStatusInfo(HostHardwareElementInfo):
    """
    Data object describing the operational status of various DPU elements. 
    """ # noqa: E501
    dpu_id: StrictStr = Field(description="Uniquely identify this DPU.  Should be the VMware identifier which can be composed from pci and other identifying elements. ", alias="dpuId")
    fru: Optional[HostFru] = None
    sensors: Optional[List[DpuStatusInfoOperationalInfo]] = None
