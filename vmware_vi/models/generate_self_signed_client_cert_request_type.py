...
class GenerateSelfSignedClientCertRequestType(BaseModel):
    """
    The parameters of *CryptoManagerKmip.GenerateSelfSignedClientCert*. 
    """ # noqa: E501
    cluster: KeyProviderId
    request: Optional[CryptoManagerKmipCertSignRequest] = None
    __properties: ClassVar[List[str]] = ["cluster", "request"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "cluster": KeyProviderId.from_dict(obj.get("cluster")) if obj.get("cluster") is not None else None,
            "request": CryptoManagerKmipCertSignRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None
        })
        return _obj
