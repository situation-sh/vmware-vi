...
class SetCollectorPageSizeRequestType(BaseModel):
    """
    The parameters of *HistoryCollector.SetCollectorPageSize*. 
    """ # noqa: E501
    max_count: StrictInt = Field(description="The maximum number of items in the page. ", alias="maxCount")
    __properties: ClassVar[List[str]] = ["maxCount"]
