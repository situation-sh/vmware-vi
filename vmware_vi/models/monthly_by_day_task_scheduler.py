...
class MonthlyByDayTaskScheduler(MonthlyTaskScheduler):
    ...
    """ # noqa: E501
    day: StrictInt = Field(description="The day in every month to run the scheduled task.  Valid values are 1 to 31.  In any month where the value of \"day\" exceeds the total number of days in the month, the scheduled task will run on the last day of the month. ")
