...
class GuestWindowsProgramSpec(GuestProgramSpec):
    """
    ...
    """ # noqa: E501
    start_minimized: StrictBool = Field(description="Makes any program window start minimized.  ***Since:*** vSphere API 5.0 ", alias="startMinimized")
