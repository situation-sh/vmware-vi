...
class VsanUpgradeSystemNotEnoughFreeCapacityIssue(VsanUpgradeSystemPreflightCheckIssue):
    """
    Pre-flight check encountered not enough free disk capacity to maintain policy compliance.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    reduced_redundancy_upgrade_possible: StrictBool = Field(description="Indicates that whether upgrade could be processed if option allowReducedRedundancy is taken.  ***Since:*** vSphere API 6.0 ", alias="reducedRedundancyUpgradePossible")
