...
class RetrieveKmipServersStatusRequestType(BaseModel):
    """
    The parameters of *CryptoManagerKmip.RetrieveKmipServersStatus_Task*. 
    """ # noqa: E501
    clusters: Optional[List[KmipClusterInfo]] = Field(default=None, description="\\[in\\] KMIP clusters and their servers.  ***Since:*** vSphere API 6.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "clusters": [KmipClusterInfo.from_dict(_item) for _item in obj.get("clusters")] if obj.get("clusters") is not None else None
        })
        return _obj
