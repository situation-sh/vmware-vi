...
class VirtualMachineSriovDevicePoolInfo(DataObject):
    """
    VirtualMachineSriovDevicePoolInfo
    """ # noqa: E501
    key: StrictStr = Field(description="To be used for extending to other device types  ***Since:*** vSphere API 6.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineSriovDevicePoolInfo failed to lookup discriminator value from " +
...
VirtualMachineSriovDevicePoolInfo.model_rebuild(raise_errors=False)
