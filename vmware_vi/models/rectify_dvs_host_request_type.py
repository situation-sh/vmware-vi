...
class RectifyDvsHostRequestType(BaseModel):
    """
    The parameters of *DistributedVirtualSwitch.RectifyDvsHost_Task*. 
    """ # noqa: E501
    hosts: Optional[List[ManagedObjectReference]] = Field(default=None, description="The hosts to be rectified.  Refers instances of *HostSystem*. ")
