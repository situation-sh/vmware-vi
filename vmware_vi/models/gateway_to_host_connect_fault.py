...
class GatewayToHostConnectFault(GatewayConnectFault):
    ...
    """ # noqa: E501
    hostname: StrictStr = Field(description="Hostname of the host that the gateway is communicating with.  ***Since:*** vSphere API 6.0 ")
    port: Optional[StrictInt] = Field(default=None, description="Port specified for the connection between the gateway and the host.  ***Since:*** vSphere API 6.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GatewayToHostConnectFault failed to lookup discriminator value from " +
...
GatewayToHostConnectFault.model_rebuild(raise_errors=False)
