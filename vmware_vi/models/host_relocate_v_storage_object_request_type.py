...
class HostRelocateVStorageObjectRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "datastore", "spec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": VslmRelocateSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
