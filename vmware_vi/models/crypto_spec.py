...
class CryptoSpec(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CryptoSpec failed to lookup discriminator value from " +
...
CryptoSpec.model_rebuild(raise_errors=False)
