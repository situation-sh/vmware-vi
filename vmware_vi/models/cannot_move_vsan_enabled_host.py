...
class CannotMoveVsanEnabledHost(VsanFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CannotMoveVsanEnabledHost failed to lookup discriminator value from " +
...
CannotMoveVsanEnabledHost.model_rebuild(raise_errors=False)
