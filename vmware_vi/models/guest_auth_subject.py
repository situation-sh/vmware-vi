...
class GuestAuthSubject(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestAuthSubject failed to lookup discriminator value from " +
...
GuestAuthSubject.model_rebuild(raise_errors=False)
