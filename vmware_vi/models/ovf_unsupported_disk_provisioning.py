...
class OvfUnsupportedDiskProvisioning(OvfImport):
    ...
    """ # noqa: E501
    disk_provisioning: StrictStr = Field(description="The disk provisioning that was not supported.  ***Since:*** vSphere API 4.1 ", alias="diskProvisioning")
    supported_disk_provisioning: StrictStr = Field(description="Disk modes supported by the host.  ***Since:*** vSphere API 4.1 ", alias="supportedDiskProvisioning")
