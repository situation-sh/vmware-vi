...
class VAppConfigFault(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VAppConfigFault failed to lookup discriminator value from " +
...
VAppConfigFault.model_rebuild(raise_errors=False)
