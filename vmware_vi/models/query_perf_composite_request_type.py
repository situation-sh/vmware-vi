...
class QueryPerfCompositeRequestType(BaseModel):
    """
    The parameters of *PerformanceManager.QueryPerfComposite*. 
    """ # noqa: E501
    query_spec: PerfQuerySpec = Field(alias="querySpec")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "querySpec": PerfQuerySpec.from_dict(obj.get("querySpec")) if obj.get("querySpec") is not None else None
        })
        return _obj
