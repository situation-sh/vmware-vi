...
class HostDiskDimensionsLba(DataObject):
    """
    ...
    """ # noqa: E501
    block_size: StrictInt = Field(description="The size of the blocks. ", alias="blockSize")
    block: StrictInt = Field(description="The number of blocks. ")
