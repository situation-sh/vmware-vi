...
class UpdateDvsCapabilityRequestType(BaseModel):
    """
    The parameters of *DistributedVirtualSwitch.UpdateDvsCapability*. 
    """ # noqa: E501
    capability: DVSCapability
    __properties: ClassVar[List[str]] = ["capability"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "capability": DVSCapability.from_dict(obj.get("capability")) if obj.get("capability") is not None else None
        })
        return _obj
