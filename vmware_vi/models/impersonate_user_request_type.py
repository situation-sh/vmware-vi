...
class ImpersonateUserRequestType(BaseModel):
    """
    The parameters of *SessionManager.ImpersonateUser*. 
    """ # noqa: E501
    user_name: StrictStr = Field(description="The user or extension key to impersonate. ", alias="userName")
    ...
    __properties: ClassVar[List[str]] = ["userName", "locale"]
