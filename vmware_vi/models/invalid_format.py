...
class InvalidFormat(VmConfigFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidFormat failed to lookup discriminator value from " +
...
InvalidFormat.model_rebuild(raise_errors=False)
