...
class OvfConnectedDevice(OvfHardwareExport):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfConnectedDevice failed to lookup discriminator value from " +
...
OvfConnectedDevice.model_rebuild(raise_errors=False)
