...
class OvfConsumerCallbackFault(OvfFault):
    ...
    """ # noqa: E501
    extension_key: StrictStr = Field(description="The OVF consumer's extension key.  ***Since:*** vSphere API 5.0 ", alias="extensionKey")
    extension_name: StrictStr = Field(description="The OVF consumer's extension name.  ***Since:*** vSphere API 5.0 ", alias="extensionName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfConsumerCallbackFault failed to lookup discriminator value from " +
...
OvfConsumerCallbackFault.model_rebuild(raise_errors=False)
