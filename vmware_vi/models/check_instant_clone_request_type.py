...
class CheckInstantCloneRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["vm", "spec", "testType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": VirtualMachineInstantCloneSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
