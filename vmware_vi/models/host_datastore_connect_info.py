...
class HostDatastoreConnectInfo(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostDatastoreConnectInfo failed to lookup discriminator value from " +
...
HostDatastoreConnectInfo.model_rebuild(raise_errors=False)
