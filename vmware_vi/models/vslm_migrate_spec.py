...
class VslmMigrateSpec(DataObject):
    """
    ...
    consolidate: Optional[StrictBool] = Field(default=None, description="Flag indicates any delta disk backings will be consolidated during migration.  If unset, delta disk backings will not be consolidated.  ***Since:*** vSphere API 6.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VslmMigrateSpec failed to lookup discriminator value from " +
...
VslmMigrateSpec.model_rebuild(raise_errors=False)
