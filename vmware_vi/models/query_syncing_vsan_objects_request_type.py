...
class QuerySyncingVsanObjectsRequestType(BaseModel):
    """
    The parameters of *HostVsanInternalSystem.QuerySyncingVsanObjects*. 
    """ # noqa: E501
    uuids: Optional[List[StrictStr]] = Field(default=None, description="List of VSAN/DOM object UUIDs to restrict search to. ")
