...
class TaskScheduler(DataObject):
    """
    ...
    """ # noqa: E501
    active_time: Optional[datetime] = Field(default=None, description="The time that the schedule for the task takes effect.  Task activation is distinct from task execution. When you activate a task, its schedule starts, and when the next execution time occurs, the task will run. If you do not set activeTime, the activation time defaults to the time that you create the scheduled task. ", alias="activeTime")
    expire_time: Optional[datetime] = Field(default=None, description="The time the schedule for the task expires.  If you do not set expireTime, the schedule does not expire. ", alias="expireTime")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("TaskScheduler failed to lookup discriminator value from " +
...
TaskScheduler.model_rebuild(raise_errors=False)
