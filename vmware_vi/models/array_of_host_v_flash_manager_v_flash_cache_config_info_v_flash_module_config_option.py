...
class ArrayOfHostVFlashManagerVFlashCacheConfigInfoVFlashModuleConfigOption(Any):
    """
    A boxed array of *HostVFlashManagerVFlashCacheConfigInfoVFlashModuleConfigOption*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[HostVFlashManagerVFlashCacheConfigInfoVFlashModuleConfigOption] = Field(alias="_value")
