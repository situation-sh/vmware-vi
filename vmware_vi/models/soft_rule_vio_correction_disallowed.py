...
class SoftRuleVioCorrectionDisallowed(VmConfigFault):
    ...
    """ # noqa: E501
    vm_name: StrictStr = Field(description="The vm for which the VM/Host soft affinity rules constraint violation is not being corrected by DRS.  ***Since:*** vSphere API 4.1 ", alias="vmName")
