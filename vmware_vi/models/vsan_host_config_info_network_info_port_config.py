...
class VsanHostConfigInfoNetworkInfoPortConfig(DataObject):
    """
    ...
    """ # noqa: E501
    ip_config: Optional[VsanHostIpConfig] = Field(default=None, alias="ipConfig")
    device: StrictStr = Field(description="Device name which identifies the network adapter for this PortConfig.  See also *HostVirtualNic.device*.  ***Since:*** vSphere API 5.5 ")
