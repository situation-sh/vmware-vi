...
class VirtualMachineGuestMonitoringModeInfo(DataObject):
    """
    This data object describes the GMM (Guest Mode Monitoring) configuration of this virtual machine.  ***Since:*** vSphere API 7.0 
    """ # noqa: E501
    gmm_file: Optional[StrictStr] = Field(default=None, alias="gmmFile")
    gmm_appliance: Optional[StrictStr] = Field(default=None, alias="gmmAppliance")
