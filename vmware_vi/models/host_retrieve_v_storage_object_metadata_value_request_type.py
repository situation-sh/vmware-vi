...
class HostRetrieveVStorageObjectMetadataValueRequestType(BaseModel):
    """
    ...
    key: StrictStr = Field(description="The key for the the virtual storage object ")
    __properties: ClassVar[List[str]] = ["id", "datastore", "snapshotId", "key"]
