...
class RecurrentTaskScheduler(TaskScheduler):
    ...
    """ # noqa: E501
    interval: StrictInt = Field(description="How often to run the scheduled task.  The value must be greater than or equal to 1 and less than 1000. The default value is 1. The interval acts as a multiplier for the unit of time associated with a particular scheduler (hours, days, weeks, or months). For example, setting the *HourlyTaskScheduler* interval to 4 causes the task to run every 4 hours. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("RecurrentTaskScheduler failed to lookup discriminator value from " +
...
RecurrentTaskScheduler.model_rebuild(raise_errors=False)
