...
class PropertySpec(DataObject):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Name of the managed object type being collected. ")
    all: Optional[StrictBool] = Field(default=None, description="Specifies whether or not all properties of the object are read.  If this property is set to true, the *PropertySpec.pathSet* property is ignored. ")
    path_set: Optional[List[StrictStr]] = Field(default=None, description="Specifies which managed object properties are retrieved.  If the *PropertySpec.pathSet* is empty, then the *PropertyCollector* retrieves references to the managed objects and no managed object properties are collected. ", alias="pathSet")
