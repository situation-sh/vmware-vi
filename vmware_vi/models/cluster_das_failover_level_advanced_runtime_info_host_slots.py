...
class ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots(DataObject):
    """
    ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots
    """ # noqa: E501
    host: ManagedObjectReference
    slots: StrictInt = Field(description="The number of slots in this host.  ***Since:*** vSphere API 4.0 ")
