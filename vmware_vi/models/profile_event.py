...
class ProfileEvent(Event):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ProfileEvent failed to lookup discriminator value from " +
...
ProfileEvent.model_rebuild(raise_errors=False)
