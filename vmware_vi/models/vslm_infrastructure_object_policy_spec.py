...
class VslmInfrastructureObjectPolicySpec(DataObject):
    """
    ...
    profile: Optional[List[VirtualMachineProfileSpec]] = Field(default=None, description="SPBM Profile to associate.  ***Since:*** vSphere API 6.7 ")
