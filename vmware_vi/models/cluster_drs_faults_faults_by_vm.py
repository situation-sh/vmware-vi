...
class ClusterDrsFaultsFaultsByVm(DataObject):
    """
    ...
    fault: List[MethodFault] = Field(description="The faults generated by DRS when it was trying to move the given VM.  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterDrsFaultsFaultsByVm failed to lookup discriminator value from " +
...
ClusterDrsFaultsFaultsByVm.model_rebuild(raise_errors=False)
