...
class HostNvmeSpec(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostNvmeSpec failed to lookup discriminator value from " +
...
HostNvmeSpec.model_rebuild(raise_errors=False)
