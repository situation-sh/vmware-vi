...
class IpRange(IpAddress):
    ...
    """ # noqa: E501
    address_prefix: StrictStr = Field(description="IP address prefix.  ***Since:*** vSphere API 5.5 ", alias="addressPrefix")
    prefix_length: Optional[StrictInt] = Field(default=None, description="Prefix length with max value of 32 for IPv4 and 128 for IPv6.  ***Since:*** vSphere API 5.5 ", alias="prefixLength")
