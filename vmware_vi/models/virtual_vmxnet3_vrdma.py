...
class VirtualVmxnet3Vrdma(VirtualVmxnet3):
    ...
    """ # noqa: E501
    device_protocol: Optional[StrictStr] = Field(default=None, description="VRDMA Device protocol.  See *VirtualVmxnet3VrdmaOptionDeviceProtocols_enum* for more information.  ***Since:*** vSphere API 6.7 ", alias="deviceProtocol")
