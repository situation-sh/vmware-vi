...
class DeleteRegistryKeyInGuestRequestType(BaseModel):
    """
    ...
    recursive: StrictBool = Field(description="If true, the key is deleted along with any subkeys (if present). Otherwise, it shall only delete the key if it has no subkeys. ")
    __properties: ClassVar[List[str]] = ["vm", "auth", "keyName", "recursive"]
