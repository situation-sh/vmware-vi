...
class HostInternetScsiHbaTargetSet(DataObject):
    """
    ...
    """ # noqa: E501
    static_targets: Optional[List[HostInternetScsiHbaStaticTarget]] = Field(default=None, alias="staticTargets")
    send_targets: Optional[List[HostInternetScsiHbaSendTarget]] = Field(default=None, alias="sendTargets")
