...
class InvalidFolder(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidFolder failed to lookup discriminator value from " +
...
InvalidFolder.model_rebuild(raise_errors=False)
