...
class FileInfo(DataObject):
    ...
    """ # noqa: E501
    path: StrictStr = Field(description="The path relative to the folder path in the search results. ")
    friendly_name: Optional[StrictStr] = Field(default=None, description="User friendly name.  ***Since:*** vSphere API 6.5 ", alias="friendlyName")
    file_size: Optional[StrictInt] = Field(default=None, description="The size of the file in bytes. ", alias="fileSize")
    modification: Optional[datetime] = Field(default=None, description="The last date and time the file was modified. ")
    owner: Optional[StrictStr] = Field(default=None, description="The user name of the owner of the file.  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("FileInfo failed to lookup discriminator value from " +
...
FileInfo.model_rebuild(raise_errors=False)
