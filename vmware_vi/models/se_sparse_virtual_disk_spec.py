...
class SeSparseVirtualDiskSpec(FileBackedVirtualDiskSpec):
    ...
    """ # noqa: E501
    grain_size_kb: Optional[StrictInt] = Field(default=None, description="The grain size in kB for Flex-SE disk types.  Default value will be used if unset.  ***Since:*** vSphere API 5.1 ", alias="grainSizeKb")
