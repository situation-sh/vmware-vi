...
class PowerSystemCapability(DataObject):
    """
    Power System Capability data object.  Exposes policies available in power management system.  ***Since:*** vSphere API 4.1 
    """ # noqa: E501
    available_policy: List[HostPowerPolicy] = Field(description="List of available host power policies.  ***Since:*** vSphere API 4.1 ", alias="availablePolicy")
