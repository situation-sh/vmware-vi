...
class UploadClientCertRequestType(BaseModel):
    """
    The parameters of *CryptoManagerKmip.UploadClientCert*. 
    """ # noqa: E501
    cluster: KeyProviderId
    certificate: StrictStr = Field(description="\\[in\\] Client certificate. ")
    private_key: SecretStr = Field(description="\\[in\\] Private key. ", alias="privateKey")
    __properties: ClassVar[List[str]] = ["cluster", "certificate", "privateKey"]
