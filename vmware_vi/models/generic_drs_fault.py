...
class GenericDrsFault(VimFault):
    ...
    """ # noqa: E501
    host_faults: Optional[List[MethodFault]] = Field(default=None, description="This is an optional field to return the detailed information back to the client.  This optional array may consist of the exact fault for some hosts in the cluster.  ***Since:*** VI API 2.5 ", alias="hostFaults")
