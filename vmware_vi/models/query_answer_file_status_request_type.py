...
class QueryAnswerFileStatusRequestType(BaseModel):
    """
    The parameters of *HostProfileManager.QueryAnswerFileStatus*. 
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="The hosts the answer file is associated with.  Refers instances of *HostSystem*. ")
