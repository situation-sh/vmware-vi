...
class VStorageObjectAssociations(DataObject):
    """
    ...
    """ # noqa: E501
    id: ID
    vm_disk_associations: Optional[List[VStorageObjectAssociationsVmDiskAssociations]] = Field(default=None, description="Array of vm associations related to the virtual storage object.  ***Since:*** vSphere API 6.7 ", alias="vmDiskAssociations")
