...
class AuthorizationPrivilege(DataObject):
    """
    ...
    """ # noqa: E501
    priv_id: StrictStr = Field(description="Unique identifier. ", alias="privId")
    on_parent: StrictBool = Field(description="Determines whether or not the privilege is applied on the parent entity. ", alias="onParent")
    name: StrictStr = Field(description="Privilege name. ")
    priv_group_name: StrictStr = Field(description="Group name. ", alias="privGroupName")
