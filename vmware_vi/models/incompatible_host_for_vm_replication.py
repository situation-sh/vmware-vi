...
class IncompatibleHostForVmReplication(ReplicationFault):
    ...
    """ # noqa: E501
    vm_name: StrictStr = Field(description="The VM which has replication configured  ***Since:*** vSphere API 6.0 ", alias="vmName")
    host_name: StrictStr = Field(description="The host which is incompatible for VM replication  ***Since:*** vSphere API 6.0 ", alias="hostName")
    reason: StrictStr = Field(description="The reason why the host is incompatible  ***Since:*** vSphere API 6.0 ")
