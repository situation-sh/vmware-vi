...
class VVolHostPE(DataObject):
    """
    VVolHostPE
    """ # noqa: E501
    key: ManagedObjectReference
    protocol_endpoint: List[HostProtocolEndpoint] = Field(description="Host-specific information about the ProtocolEndpoint.  ***Since:*** vSphere API 6.0 ", alias="protocolEndpoint")
