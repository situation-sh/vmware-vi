...
class NumVirtualCpusIncompatible(VmConfigFault):
    ...
    """ # noqa: E501
    reason: StrictStr = Field(description="The reason for the incompatibility.  See *NumVirtualCpusIncompatibleReason_enum* for valid values.  ***Since:*** vSphere API 4.0 ")
    num_cpu: StrictInt = Field(description="The number of virtual CPUs in the virtual machine.  ***Since:*** vSphere API 4.0 ", alias="numCpu")
