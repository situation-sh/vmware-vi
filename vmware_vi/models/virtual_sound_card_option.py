...
class VirtualSoundCardOption(VirtualDeviceOption):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualSoundCardOption failed to lookup discriminator value from " +
...
VirtualSoundCardOption.model_rebuild(raise_errors=False)
