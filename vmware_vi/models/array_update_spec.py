...
class ArrayUpdateSpec(DataObject):
    """
    ...
    """ # noqa: E501
    operation: ArrayUpdateOperationEnum
    remove_key: Optional[Any] = Field(default=None, alias="removeKey")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','ClusterDasVmConfigSpec': 'ClusterDasVmConfigSpec','ClusterDatastoreUpdateSpec': 'ClusterDatastoreUpdateSpec','ClusterDpmHostConfigSpec': 'ClusterDpmHostConfigSpec','ClusterDrsVmConfigSpec': 'ClusterDrsVmConfigSpec','ClusterGroupSpec': 'ClusterGroupSpec','ClusterPreemptibleVmPairSpec': 'ClusterPreemptibleVmPairSpec','ClusterRuleSpec': 'ClusterRuleSpec','ClusterTagCategoryUpdateSpec': 'ClusterTagCategoryUpdateSpec','ClusterVmOrchestrationSpec': 'ClusterVmOrchestrationSpec','StorageDrsOptionSpec': 'StorageDrsOptionSpec','StorageDrsVmConfigSpec': 'StorageDrsVmConfigSpec','VAppOvfSectionSpec': 'VAppOvfSectionSpec','VAppProductSpec': 'VAppProductSpec','VAppPropertySpec': 'VAppPropertySpec','VirtualMachineCpuIdInfoSpec': 'VirtualMachineCpuIdInfoSpec'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ArrayUpdateSpec failed to lookup discriminator value from " +
...
ArrayUpdateSpec.model_rebuild(raise_errors=False)
