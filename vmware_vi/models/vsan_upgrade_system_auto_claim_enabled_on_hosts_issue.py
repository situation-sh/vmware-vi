...
class VsanUpgradeSystemAutoClaimEnabledOnHostsIssue(VsanUpgradeSystemPreflightCheckIssue):
    """
    Pre-flight check encountered at least one host with auto-claim enabled.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    hosts: List[ManagedObjectReference] = Field(description="Hosts this issue applies to.  ***Since:*** vSphere API 6.0  Refers instances of *HostSystem*. ")
