...
class RollbackEvent(DvsEvent):
    ...
    """ # noqa: E501
    host_name: StrictStr = Field(description="The host on which rollback happened  ***Since:*** vSphere API 5.1 ", alias="hostName")
    method_name: Optional[StrictStr] = Field(default=None, description="The API method that was rolled back  ***Since:*** vSphere API 5.1 ", alias="methodName")
