...
class HostTpmBootSecurityOptionEventDetails(HostTpmEventDetails):
    """
    ...
    """ # noqa: E501
    boot_security_option: StrictStr = Field(description="Security-related options string, reflecting the state of an option set in the kernel.  This string is in the form of a KEY=VALUE pair.  ***Since:*** vSphere API 5.1 ", alias="bootSecurityOption")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostTpmBootSecurityOptionEventDetails failed to lookup discriminator value from " +
...
HostTpmBootSecurityOptionEventDetails.model_rebuild(raise_errors=False)
