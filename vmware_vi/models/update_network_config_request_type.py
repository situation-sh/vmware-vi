...
class UpdateNetworkConfigRequestType(BaseModel):
    """
    The parameters of *HostNetworkSystem.UpdateNetworkConfig*. 
    """ # noqa: E501
    config: HostNetworkConfig
    change_mode: StrictStr = Field(alias="changeMode")
    __properties: ClassVar[List[str]] = ["config", "changeMode"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "config": HostNetworkConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None,
            "changeMode": obj.get("changeMode")
        })
        return _obj
