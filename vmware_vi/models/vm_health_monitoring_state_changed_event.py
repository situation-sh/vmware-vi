...
class VmHealthMonitoringStateChangedEvent(ClusterEvent):
    ...
    """ # noqa: E501
    state: StrictStr = Field(description="The service state in *ClusterDasConfigInfoVmMonitoringState_enum*  ***Since:*** vSphere API 4.0 ")
    prev_state: Optional[StrictStr] = Field(default=None, description="The previous service state in *ClusterDasConfigInfoVmMonitoringState_enum*  ***Since:*** vSphere API 6.5 ", alias="prevState")
