...
class HostFibreChannelTargetTransport(HostTargetTransport):
    ...
    """ # noqa: E501
    port_world_wide_name: StrictInt = Field(description="The world wide port name of the target. ", alias="portWorldWideName")
    node_world_wide_name: StrictInt = Field(description="The world wide node name of the target. ", alias="nodeWorldWideName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostFibreChannelTargetTransport failed to lookup discriminator value from " +
...
HostFibreChannelTargetTransport.model_rebuild(raise_errors=False)
