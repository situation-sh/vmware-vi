...
class CannotPowerOffVmInCluster(InvalidState):
    ...
    """ # noqa: E501
    operation: StrictStr = Field(description="The operation being performed.  Values come from *CannotPowerOffVmInClusterOperation_enum*.  ***Since:*** vSphere API 5.0 ")
    vm: ManagedObjectReference
    vm_name: StrictStr = Field(description="Name of the Virtual Machine  ***Since:*** vSphere API 5.0 ", alias="vmName")
