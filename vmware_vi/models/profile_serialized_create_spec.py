...
class ProfileSerializedCreateSpec(ProfileCreateSpec):
    ...
    """ # noqa: E501
    profile_config_string: StrictStr = Field(description="Representation of the profile in the string form.  ***Since:*** vSphere API 4.0 ", alias="profileConfigString")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ProfileSerializedCreateSpec failed to lookup discriminator value from " +
...
ProfileSerializedCreateSpec.model_rebuild(raise_errors=False)
