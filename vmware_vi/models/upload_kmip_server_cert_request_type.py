...
class UploadKmipServerCertRequestType(BaseModel):
    """
    The parameters of *CryptoManagerKmip.UploadKmipServerCert*. 
    """ # noqa: E501
    cluster: KeyProviderId
    certificate: StrictStr = Field(description="\\[in\\] Server certificate in PEM encoding. ")
    __properties: ClassVar[List[str]] = ["cluster", "certificate"]
