...
class LimitExceeded(VimFault):
    ...
    """ # noqa: E501
    var_property: Optional[StrictStr] = Field(default=None, description="The name of the property that exceeds the limit.  ***Since:*** vSphere API 4.0 ", alias="property")
    limit: Optional[StrictInt] = Field(default=None, description="The limit value.  ***Since:*** vSphere API 4.0 ")
