...
class PhysicalNicLinkInfo(DataObject):
    """
    ...
    """ # noqa: E501
    speed_mb: StrictInt = Field(description="Bit rate on the link. ", alias="speedMb")
    duplex: StrictBool = Field(description="Flag to indicate whether or not the link is capable of full-duplex (\"true\") or only half-duplex (\"false\"). ")
