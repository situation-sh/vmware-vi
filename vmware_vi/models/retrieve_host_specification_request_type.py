...
class RetrieveHostSpecificationRequestType(BaseModel):
    """
    The parameters of *HostSpecificationManager.RetrieveHostSpecification*. 
    """ # noqa: E501
    host: ManagedObjectReference
    from_host: StrictBool = Field(description="Whether retrieve from the host. ", alias="fromHost")
    __properties: ClassVar[List[str]] = ["host", "fromHost"]
