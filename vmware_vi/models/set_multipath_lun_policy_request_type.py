...
class SetMultipathLunPolicyRequestType(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "lunId": obj.get("lunId"),
            "policy": HostMultipathInfoLogicalUnitPolicy.from_dict(obj.get("policy")) if obj.get("policy") is not None else None
        })
        return _obj
