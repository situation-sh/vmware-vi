...
class HostFileSystemVolume(DataObject):
    """
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="FileSystemType of this particular file system See *HostFileSystemVolumeFileSystemType_enum* ")
    name: StrictStr = Field(description="Name of the file system volume. ")
    capacity: StrictInt = Field(description="The capacity of the file system volume, in bytes. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostFileSystemVolume failed to lookup discriminator value from " +
...
HostFileSystemVolume.model_rebuild(raise_errors=False)
