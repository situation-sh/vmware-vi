...
class HostTcpHbaCreateSpec(HostHbaCreateSpec):
    """
    ...
    """ # noqa: E501
    pnic: StrictStr = Field(description="Device name of the associated physical NIC.  Should match the *PhysicalNic.device* property of the corresponding physical NIC.  ***Since:*** vSphere API 7.0.3.0 ")
