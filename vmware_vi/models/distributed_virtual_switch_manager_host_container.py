...
class DistributedVirtualSwitchManagerHostContainer(DataObject):
    """
    ...
    recursive: StrictBool = Field(description="If true, include hosts of all levels in the hierarchy with container as root of the tree.  In case of container being a *Datacenter*, the recursive flag is applied to its HostFolder.  ***Since:*** vSphere API 4.1 ")
