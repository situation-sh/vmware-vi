...
class StartProgramInGuestRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["vm", "auth", "spec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": GuestProgramSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
