...
class VirtualMachineVirtualDeviceSwapDeviceSwapStatusEnum(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VirtualMachineVirtualDeviceSwapDeviceSwapStatusEnum from a JSON string"""
