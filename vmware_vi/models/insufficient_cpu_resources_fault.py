...
class InsufficientCpuResourcesFault(InsufficientResourcesFault):
    ...
    """ # noqa: E501
    unreserved: StrictInt = Field(description="The CPU available in the resource pool requested in MHz. ")
    requested: StrictInt = Field(description="The CPU resource amount requested in the failed operation in MHz. ")
