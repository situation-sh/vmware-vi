...
class AlarmExpression(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("AlarmExpression failed to lookup discriminator value from " +
...
AlarmExpression.model_rebuild(raise_errors=False)
