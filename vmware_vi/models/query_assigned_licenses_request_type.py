...
class QueryAssignedLicensesRequestType(BaseModel):
    """
    The parameters of *LicenseAssignmentManager.QueryAssignedLicenses*. 
    """ # noqa: E501
    entity_id: Optional[StrictStr] = Field(default=None, description="ID of the entity. E.g. HostSystem. ", alias="entityId")
