...
class StorageRequirement(DataObject):
    """
    Describes the storage requirement to perform a consolidation operation.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    datastore: ManagedObjectReference
    free_space_required_in_kb: StrictInt = Field(description="Space required.  ***Since:*** vSphere API 5.0 ", alias="freeSpaceRequiredInKb")
