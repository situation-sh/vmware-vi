...
class VirtualPCIPassthroughVmiopBackingOption(VirtualPCIPassthroughPluginBackingOption):
    """
    ...
    """ # noqa: E501
    vgpu: StringOption
    max_instances: StrictInt = Field(description="Maximum number of instances of this backing type allowed per virtual machine.  This is a parameter of the plugin itself, which may support only a limited number of instances per virtual machine.  ***Since:*** vSphere API 6.0 ", alias="maxInstances")
