...
class DesiredSoftwareSpecVendorAddOnSpec(DataObject):
    """
    Vendor specific add-on info for ESX host.  ***Since:*** vSphere API 7.0 
    """ # noqa: E501
    name: StrictStr = Field(description="Vendor add-on name.  ***Since:*** vSphere API 7.0 ")
    version: StrictStr = Field(description="Vendor add-on version.  ***Since:*** vSphere API 7.0 ")
