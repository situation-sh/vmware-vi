...
class FaultToleranceCpuIncompatible(CpuIncompatible):
    ...
    """ # noqa: E501
    model: StrictBool = Field(description="Flag to indicate CPU model is incompatible.  ***Since:*** vSphere API 4.0 ")
    family: StrictBool = Field(description="Flag to indicate CPU family is incompatible.  ***Since:*** vSphere API 4.0 ")
    stepping: StrictBool = Field(description="Flag to indicate CPU stepping is incompatible.  ***Since:*** vSphere API 4.0 ")
