...
class VsanHostVsanDiskInfo(DataObject):
    """
    ...
    """ # noqa: E501
    vsan_uuid: StrictStr = Field(description="Disk UUID in VSAN  ***Since:*** vSphere API 6.0 ", alias="vsanUuid")
    format_version: StrictInt = Field(description="VSAN file system version number  ***Since:*** vSphere API 6.0 ", alias="formatVersion")
