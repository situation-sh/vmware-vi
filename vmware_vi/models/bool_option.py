...
class BoolOption(OptionType):
    ...
    """ # noqa: E501
    supported: StrictBool = Field(description="The flag to indicate whether or not the option is supported. ")
    default_value: StrictBool = Field(description="The default value for the option. ", alias="defaultValue")
