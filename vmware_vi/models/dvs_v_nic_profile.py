...
class DvsVNicProfile(ApplyProfile):
    ...
    ip_config: IpAddressProfile = Field(alias="ipConfig")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsVNicProfile failed to lookup discriminator value from " +
...
DvsVNicProfile.model_rebuild(raise_errors=False)
