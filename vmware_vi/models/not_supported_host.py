...
class NotSupportedHost(HostConnectFault):
    ...
    """ # noqa: E501
    product_name: Optional[StrictStr] = Field(default=None, description="The name of the unsupported product if available; for example, \"VMware ESX Server\". ", alias="productName")
    product_version: Optional[StrictStr] = Field(default=None, description="The version of the unsupported product; for example, \"1.5.2\" ", alias="productVersion")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("NotSupportedHost failed to lookup discriminator value from " +
...
NotSupportedHost.model_rebuild(raise_errors=False)
