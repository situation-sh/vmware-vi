...
class CustomFieldValueChangedEvent(CustomFieldEvent):
    ...
    field_key: StrictInt = Field(description="The custom field whose value was changed for the entity. ", alias="fieldKey")
    name: StrictStr = Field(description="The name of the custom field at the time the value was changed. ")
    value: StrictStr = Field(description="The new value that was set. ")
    prev_state: Optional[StrictStr] = Field(default=None, description="The previous service state.  ***Since:*** vSphere API 6.5 ", alias="prevState")
