...
class RemoveKeyRequestType(BaseModel):
    """
    The parameters of *CryptoManager.RemoveKey*. 
    """ # noqa: E501
    key: CryptoKeyId
    force: StrictBool = Field(description="\\[in\\] Remove the key even if in use or not existent. ")
    __properties: ClassVar[List[str]] = ["key", "force"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "key": CryptoKeyId.from_dict(obj.get("key")) if obj.get("key") is not None else None,
            "force": obj.get("force")
        })
        return _obj
