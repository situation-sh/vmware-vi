...
class DvsNetworkRuleAction(DataObject):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','DvsAcceptNetworkRuleAction': 'DvsAcceptNetworkRuleAction','DvsCopyNetworkRuleAction': 'DvsCopyNetworkRuleAction','DvsDropNetworkRuleAction': 'DvsDropNetworkRuleAction','DvsGreEncapNetworkRuleAction': 'DvsGreEncapNetworkRuleAction','DvsLogNetworkRuleAction': 'DvsLogNetworkRuleAction','DvsMacRewriteNetworkRuleAction': 'DvsMacRewriteNetworkRuleAction','DvsPuntNetworkRuleAction': 'DvsPuntNetworkRuleAction','DvsRateLimitNetworkRuleAction': 'DvsRateLimitNetworkRuleAction','DvsUpdateTagNetworkRuleAction': 'DvsUpdateTagNetworkRuleAction'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsNetworkRuleAction failed to lookup discriminator value from " +
...
DvsNetworkRuleAction.model_rebuild(raise_errors=False)
