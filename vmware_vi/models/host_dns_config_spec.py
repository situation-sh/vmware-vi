...
class HostDnsConfigSpec(HostDnsConfig):
    ...
    """ # noqa: E501
    virtual_nic_connection: Optional[HostVirtualNicConnection] = Field(default=None, alias="virtualNicConnection")
    virtual_nic_connection_v6: Optional[HostVirtualNicConnection] = Field(default=None, alias="virtualNicConnectionV6")
