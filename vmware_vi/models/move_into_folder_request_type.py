...
class MoveIntoFolderRequestType(BaseModel):
    """
    The parameters of *Folder.MoveIntoFolder_Task*. 
    """ # noqa: E501
    list: List[ManagedObjectReference] = Field(description="The list of objects to be moved into the folder.  Refers instances of *ManagedEntity*. ")
