...
class EVCAdmissionFailedCPUVendor(EVCAdmissionFailed):
    ...
    """ # noqa: E501
    cluster_cpu_vendor: StrictStr = Field(description="The CPU vendor required for entering the cluster.  ***Since:*** vSphere API 4.0 ", alias="clusterCPUVendor")
    host_cpu_vendor: StrictStr = Field(description="The CPU vendor of the host.  ***Since:*** vSphere API 4.0 ", alias="hostCPUVendor")
