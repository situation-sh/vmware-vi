...
class VirtualMachineBootOptionsBootableEthernetDevice(VirtualMachineBootOptionsBootableDevice):
    """
    Bootable ethernet adapter.  PXE boot is attempted from the device.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    device_key: StrictInt = Field(description="*Key* property of the bootable ethernet adapter.  ***Since:*** vSphere API 5.0 ", alias="deviceKey")
