...
class HostStorageSystemDiskLocatorLedResult(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="UUID of LUN that has failed to turn on/off disk locator LED.  ***Since:*** vSphere API 6.0 ")
    fault: MethodFault
