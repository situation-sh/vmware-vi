...
class VirtualDiskRawDiskVer2BackingInfo(VirtualDeviceDeviceBackingInfo):
    ...
    """ # noqa: E501
    descriptor_file_name: StrictStr = Field(description="The name of the raw disk descriptor file. ", alias="descriptorFileName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDiskRawDiskVer2BackingInfo failed to lookup discriminator value from " +
...
VirtualDiskRawDiskVer2BackingInfo.model_rebuild(raise_errors=False)
