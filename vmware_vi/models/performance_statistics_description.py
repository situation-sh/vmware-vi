...
class PerformanceStatisticsDescription(DataObject):
    """
    Data object to capture all information needed to describe a sample inventory.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    intervals: Optional[List[PerfInterval]] = Field(default=None, description="Historic interval setting.  Default value is the same as the historic interval settings of the current instance of running VC.  ***Since:*** vSphere API 4.0 ")
