...
class MemorySizeNotSupported(VirtualHardwareCompatibilityIssue):
    ...
    min_memory_size_mb: StrictInt = Field(description="The minimum acceptable memory size.  ***Since:*** VI API 2.5 ", alias="minMemorySizeMB")
    max_memory_size_mb: StrictInt = Field(description="The maximum acceptable memory size.  ***Since:*** VI API 2.5 ", alias="maxMemorySizeMB")
