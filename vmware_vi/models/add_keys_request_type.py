...
class AddKeysRequestType(BaseModel):
    """
    The parameters of *CryptoManager.AddKeys*. 
    """ # noqa: E501
    keys: Optional[List[CryptoKeyPlain]] = Field(default=None, description="\\[in\\] List of cryptographic keys to add.  ***Since:*** vSphere API 6.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "keys": [CryptoKeyPlain.from_dict(_item) for _item in obj.get("keys")] if obj.get("keys") is not None else None
        })
        return _obj
