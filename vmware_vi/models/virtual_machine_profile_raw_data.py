...
class VirtualMachineProfileRawData(DataObject):
    """
    ...
    """ # noqa: E501
    extension_key: StrictStr = Field(description="vSphere Extension Identifier  ***Since:*** vSphere API 5.5 ", alias="extensionKey")
    object_data: Optional[StrictStr] = Field(default=None, description="Extension-specific additional data to be associated with Virtual machine and its devices.  ***Since:*** vSphere API 5.5 ", alias="objectData")
