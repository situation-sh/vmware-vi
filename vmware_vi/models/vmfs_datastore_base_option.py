...
class VmfsDatastoreBaseOption(DataObject):
    """
    Base class that describes a VMFS datastore provisioning option. 
    """ # noqa: E501
    layout: HostDiskPartitionLayout
    partition_format_change: Optional[StrictBool] = Field(default=None, description="Indicates whether selecting this option will change the partition format type on the disk.  See also *HostDiskPartitionInfoPartitionFormat_enum*.  ***Since:*** vSphere API 5.0 ", alias="partitionFormatChange")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmfsDatastoreBaseOption failed to lookup discriminator value from " +
...
VmfsDatastoreBaseOption.model_rebuild(raise_errors=False)
