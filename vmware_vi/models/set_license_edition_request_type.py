...
class SetLicenseEditionRequestType(BaseModel):
    """
    The parameters of *LicenseManager.SetLicenseEdition*. 
    """ # noqa: E501
    host: Optional[ManagedObjectReference] = None
    feature_key: Optional[StrictStr] = Field(default=None, description="Name of edition feature to select. If featureKey is not set or set to empty string, the product becomes unlicensed. ", alias="featureKey")
    __properties: ClassVar[List[str]] = ["host", "featureKey"]
