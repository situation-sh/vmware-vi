...
class ExitStandbyModeFailedEvent(HostEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ExitStandbyModeFailedEvent failed to lookup discriminator value from " +
...
ExitStandbyModeFailedEvent.model_rebuild(raise_errors=False)
