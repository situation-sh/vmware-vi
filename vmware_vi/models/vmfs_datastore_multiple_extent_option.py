...
class VmfsDatastoreMultipleExtentOption(VmfsDatastoreBaseOption):
    ...
    """ # noqa: E501
    vmfs_extent: List[HostDiskPartitionBlockRange] = Field(description="The block ranges to be used as extents in a VMFS datastore.  The first block range will be the head partition. ", alias="vmfsExtent")
