...
class VirtualMachineVirtualDeviceSwap(DataObject):
    """
    Device Swap: Report current status of device swap feature. 
    """ # noqa: E501
    lsi_to_pvscsi: Optional[VirtualMachineVirtualDeviceSwapDeviceSwapInfo] = Field(default=None, alias="lsiToPvscsi")
