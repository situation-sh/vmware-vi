...
class ProfileCreateSpec(DataObject):
    """
    Specification describing the parameters during Profile creation  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the profile  ***Since:*** vSphere API 4.0 ")
    annotation: Optional[StrictStr] = Field(default=None, description="User Provided description of the profile  ***Since:*** vSphere API 4.0 ")
    enabled: Optional[StrictBool] = Field(default=None, description="Flag indicating if the Profile is enabled  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ProfileCreateSpec failed to lookup discriminator value from " +
...
ProfileCreateSpec.model_rebuild(raise_errors=False)
