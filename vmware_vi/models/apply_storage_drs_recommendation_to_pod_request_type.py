...
class ApplyStorageDrsRecommendationToPodRequestType(BaseModel):
    """
    The parameters of *StorageResourceManager.ApplyStorageDrsRecommendationToPod_Task*. 
    """ # noqa: E501
    pod: ManagedObjectReference
    key: StrictStr = Field(description="The key field of the Recommendation. ")
    __properties: ClassVar[List[str]] = ["pod", "key"]
