...
class VmVnicPoolReservationViolationClearEvent(DvsEvent):
    ...
    """ # noqa: E501
    vm_vnic_resource_pool_key: StrictStr = Field(description="The key of the Virtual NIC network resource pool  ***Since:*** vSphere API 6.0 ", alias="vmVnicResourcePoolKey")
    vm_vnic_resource_pool_name: Optional[StrictStr] = Field(default=None, description="The name of the Virtual NIC network resource pool  ***Since:*** vSphere API 6.0 ", alias="vmVnicResourcePoolName")
