...
class ArrayOfHostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult(Any):
    """
    A boxed array of *HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult] = Field(alias="_value")
