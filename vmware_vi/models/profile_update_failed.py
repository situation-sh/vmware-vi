...
class ProfileUpdateFailed(VimFault):
    ...
    """ # noqa: E501
    failure: List[ProfileUpdateFailedUpdateFailure] = Field(description="Failures encountered during update/validation  ***Since:*** vSphere API 4.0 ")
    warnings: Optional[List[ProfileUpdateFailedUpdateFailure]] = Field(default=None, description="Warnings encountered during update/validation  ***Since:*** vSphere API 6.7 ")
