...
class VmToolsUpgradeFault(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmToolsUpgradeFault failed to lookup discriminator value from " +
...
VmToolsUpgradeFault.model_rebuild(raise_errors=False)
