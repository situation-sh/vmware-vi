...
class ReplicationVmFault(ReplicationFault):
    ...
    """ # noqa: E501
    reason: StrictStr = Field(description="The reason for the failure.  One of the above.  ***Since:*** vSphere API 5.0 ")
    state: Optional[StrictStr] = Field(default=None, description="The current *ReplicationVmState_enum* of the *VirtualMachine*  ***Since:*** vSphere API 5.0 ")
    instance_id: Optional[StrictStr] = Field(default=None, description="The name of the instance currently being created.  ***Since:*** vSphere API 5.0 ", alias="instanceId")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ReplicationVmFault failed to lookup discriminator value from " +
...
ReplicationVmFault.model_rebuild(raise_errors=False)
