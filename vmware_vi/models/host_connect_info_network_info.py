...
class HostConnectInfoNetworkInfo(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostConnectInfoNetworkInfo failed to lookup discriminator value from " +
...
HostConnectInfoNetworkInfo.model_rebuild(raise_errors=False)
