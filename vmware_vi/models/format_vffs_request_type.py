...
class FormatVffsRequestType(BaseModel):
    """
    The parameters of *HostStorageSystem.FormatVffs*. 
    """ # noqa: E501
    create_spec: HostVffsSpec = Field(alias="createSpec")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "createSpec": HostVffsSpec.from_dict(obj.get("createSpec")) if obj.get("createSpec") is not None else None
        })
        return _obj
