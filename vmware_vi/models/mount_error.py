...
class MountError(CustomizationFault):
    ...
    disk_index: StrictInt = Field(description="Index into the virtual machine's device list, representing the key value that identifies the virtual device that is the presumed boot disk. ", alias="diskIndex")
