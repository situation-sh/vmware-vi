...
class ServiceLocatorNamePassword(ServiceLocatorCredential):
    """
    ...
    """ # noqa: E501
    username: StrictStr = Field(description="The username for Username-Password authentication  ***Since:*** vSphere API 6.0 ")
    password: SecretStr = Field(description="The password for Username-Password authentication  ***Since:*** vSphere API 6.0 ")
