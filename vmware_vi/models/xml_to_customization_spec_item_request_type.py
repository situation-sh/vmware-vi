...
class XmlToCustomizationSpecItemRequestType(BaseModel):
    """
    The parameters of *CustomizationSpecManager.XmlToCustomizationSpecItem*. 
    """ # noqa: E501
    spec_item_xml: StrictStr = Field(alias="specItemXml")
    __properties: ClassVar[List[str]] = ["specItemXml"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "specItemXml": obj.get("specItemXml")
        })
        return _obj
