...
class VirtualDeviceURIBackingOption(VirtualDeviceBackingOption):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceURIBackingOption failed to lookup discriminator value from " +
...
VirtualDeviceURIBackingOption.model_rebuild(raise_errors=False)
