...
class StorageDrsHbrDiskNotMovable(VimFault):
    ...
    """ # noqa: E501
    non_movable_disk_ids: StrictStr = Field(description="Comma-separated list of disk IDs that are not movable and failed Storage DRS recommendation action.  ***Since:*** vSphere API 6.0 ", alias="nonMovableDiskIds")
