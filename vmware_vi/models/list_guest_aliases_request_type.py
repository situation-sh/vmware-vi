...
class ListGuestAliasesRequestType(BaseModel):
    """
    The parameters of *GuestAliasManager.ListGuestAliases*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    username: StrictStr = Field(description="The guest user whose Alias store is being queried. ")
    __properties: ClassVar[List[str]] = ["vm", "auth", "username"]
