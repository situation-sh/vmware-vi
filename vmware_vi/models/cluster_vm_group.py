...
class ClusterVmGroup(ClusterGroupInfo):
    ...
    """ # noqa: E501
    vm: Optional[List[ManagedObjectReference]] = Field(default=None, description="List of virtual machines that are part of this group.  A virtual machine group can contain zero or more virtual machines.  ***Since:*** vSphere API 4.1  Refers instances of *VirtualMachine*. ")
