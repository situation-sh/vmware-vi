...
class VirtualDeviceDeviceBackingInfo(VirtualDeviceBackingInfo):
    ...
    """ # noqa: E501
    device_name: StrictStr = Field(description="The name of the device on the host system. ", alias="deviceName")
    use_auto_detect: Optional[StrictBool] = Field(default=None, description="Indicates whether the device should be auto detected instead of directly specified.  If this value is set to TRUE, deviceName is ignored.  ***Since:*** VI API 2.5 ", alias="useAutoDetect")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','VirtualCdromAtapiBackingInfo': 'VirtualCdromAtapiBackingInfo','VirtualCdromPassthroughBackingInfo': 'VirtualCdromPassthroughBackingInfo','VirtualDiskPartitionedRawDiskVer2BackingInfo': 'VirtualDiskPartitionedRawDiskVer2BackingInfo','VirtualDiskRawDiskVer2BackingInfo': 'VirtualDiskRawDiskVer2BackingInfo','VirtualEthernetCardLegacyNetworkBackingInfo': 'VirtualEthernetCardLegacyNetworkBackingInfo','VirtualEthernetCardNetworkBackingInfo': 'VirtualEthernetCardNetworkBackingInfo','VirtualFloppyDeviceBackingInfo': 'VirtualFloppyDeviceBackingInfo','VirtualPCIPassthroughDeviceBackingInfo': 'VirtualPCIPassthroughDeviceBackingInfo','VirtualPCIPassthroughDynamicBackingInfo': 'VirtualPCIPassthroughDynamicBackingInfo','VirtualParallelPortDeviceBackingInfo': 'VirtualParallelPortDeviceBackingInfo','VirtualPointingDeviceDeviceBackingInfo': 'VirtualPointingDeviceDeviceBackingInfo','VirtualSCSIPassthroughDeviceBackingInfo': 'VirtualSCSIPassthroughDeviceBackingInfo','VirtualSerialPortDeviceBackingInfo': 'VirtualSerialPortDeviceBackingInfo','VirtualSoundCardDeviceBackingInfo': 'VirtualSoundCardDeviceBackingInfo','VirtualUSBRemoteHostBackingInfo': 'VirtualUSBRemoteHostBackingInfo','VirtualUSBUSBBackingInfo': 'VirtualUSBUSBBackingInfo'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceDeviceBackingInfo failed to lookup discriminator value from " +
...
VirtualDeviceDeviceBackingInfo.model_rebuild(raise_errors=False)
