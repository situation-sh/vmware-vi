...
class ChangePasswordRequestType(BaseModel):
    ...
    """ # noqa: E501
    user: StrictStr = Field(description="the user whose password will be changed. ")
    old_password: SecretStr = Field(description="the user's current (old) password. ", alias="oldPassword")
    new_password: SecretStr = Field(description="the user's new password. ", alias="newPassword")
    __properties: ClassVar[List[str]] = ["user", "oldPassword", "newPassword"]
