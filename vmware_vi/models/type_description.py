...
class TypeDescription(Description):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Type being described ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("TypeDescription failed to lookup discriminator value from " +
...
TypeDescription.model_rebuild(raise_errors=False)
