...
class VirtualDevicePciBusSlotInfo(VirtualDeviceBusSlotInfo):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDevicePciBusSlotInfo failed to lookup discriminator value from " +
...
VirtualDevicePciBusSlotInfo.model_rebuild(raise_errors=False)
