...
class DVSHealthCheckCapability(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DVSHealthCheckCapability failed to lookup discriminator value from " +
...
DVSHealthCheckCapability.model_rebuild(raise_errors=False)
