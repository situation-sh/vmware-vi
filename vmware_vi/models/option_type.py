...
class OptionType(DataObject):
    """
    The base data object type for all options. 
    """ # noqa: E501
    value_is_readonly: Optional[StrictBool] = Field(default=None, description="The flag to indicate whether or not a user can modify a value belonging to this option type.  If the flag is not set, the value can be modified. ", alias="valueIsReadonly")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OptionType failed to lookup discriminator value from " +
...
OptionType.model_rebuild(raise_errors=False)
