...
class HostCacheConfigurationInfo(DataObject):
    """
    Host solid state drive cache configuration information.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    key: ManagedObjectReference
    swap_size: StrictInt = Field(description="Space allocated on this datastore to implement swap performance enhancements, in MB.  ***Since:*** vSphere API 5.0 ", alias="swapSize")
