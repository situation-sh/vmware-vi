...
class FaultToleranceVMConfigSpec(DataObject):
    """
    FaultToleranceVMConfigSpec contains information about placement of fault tolerant VM.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    vm_config: Optional[ManagedObjectReference] = Field(default=None, alias="vmConfig")
    disks: Optional[List[FaultToleranceDiskSpec]] = Field(default=None, description="Array of disks associated with the VM  ***Since:*** vSphere API 6.0 ")
