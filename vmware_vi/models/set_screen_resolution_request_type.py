...
class SetScreenResolutionRequestType(BaseModel):
    """
    The parameters of *VirtualMachine.SetScreenResolution*. 
    """ # noqa: E501
    width: StrictInt = Field(description="The screen width that should be set. ")
    height: StrictInt = Field(description="The screen height that should be set. ")
