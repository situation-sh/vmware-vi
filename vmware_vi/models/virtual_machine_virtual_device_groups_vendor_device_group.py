...
class VirtualMachineVirtualDeviceGroupsVendorDeviceGroup(VirtualMachineVirtualDeviceGroupsDeviceGroup):
    """
    ...
    """ # noqa: E501
    device_group_name: StrictStr = Field(description="The name of the vendor device group from <code>*VirtualMachineVendorDeviceGroupInfo*</code>. ", alias="deviceGroupName")
