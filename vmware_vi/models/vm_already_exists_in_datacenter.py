...
class VmAlreadyExistsInDatacenter(InvalidFolder):
    ...
    hostname: StrictStr = Field(description="Name of the target host.  ***Since:*** vSphere API 4.0 ")
    vm: List[ManagedObjectReference] = Field(description="Virtual machines in the target datacenter which have the same registration information as those belonging to the target host.  ***Since:*** vSphere API 4.0  Refers instances of *VirtualMachine*. ")
