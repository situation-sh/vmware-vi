...
class SnapshotFault(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("SnapshotFault failed to lookup discriminator value from " +
...
SnapshotFault.model_rebuild(raise_errors=False)
