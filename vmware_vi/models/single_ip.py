...
class SingleIp(IpAddress):
    ...
    """ # noqa: E501
    address: StrictStr = Field(description="The IP address.  The value of this property should either be an IPv4 address such as \"192.168.0.1\" or an IPv6 address such as \"fc00:192:168:0:6cd9:a132:e889:b612\"  ***Since:*** vSphere API 5.5 ")
