...
class AlarmAction(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("AlarmAction failed to lookup discriminator value from " +
...
AlarmAction.model_rebuild(raise_errors=False)
