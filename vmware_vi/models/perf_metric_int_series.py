...
class PerfMetricIntSeries(PerfMetricSeries):
    ...
    """ # noqa: E501
    value: Optional[List[StrictInt]] = Field(default=None, description="An array of 64-bit integer values.  The size of the array matches the size as the *PerfSampleInfo*, because the values can only be interpreted in the context of the sample that generated the value. ")
