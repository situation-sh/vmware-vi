...
class NumVirtualCpusNotSupported(VirtualHardwareCompatibilityIssue):
    ...
    """ # noqa: E501
    max_supported_vcpus_dest: StrictInt = Field(description="The maximum number of virtual CPUs supported on the host. ", alias="maxSupportedVcpusDest")
    num_cpu_vm: StrictInt = Field(description="The number of virtual CPUs in the virtual machine. ", alias="numCpuVm")
