...
class MigrationFeatureNotSupported(MigrationFault):
    ...
    """ # noqa: E501
    at_source_host: StrictBool = Field(description="Whether this error is for the source host.  ***Since:*** VI API 2.5 ", alias="atSourceHost")
    failed_host_name: StrictStr = Field(description="The name of the host.  ***Since:*** VI API 2.5 ", alias="failedHostName")
    failed_host: ManagedObjectReference = Field(alias="failedHost")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("MigrationFeatureNotSupported failed to lookup discriminator value from " +
...
MigrationFeatureNotSupported.model_rebuild(raise_errors=False)
