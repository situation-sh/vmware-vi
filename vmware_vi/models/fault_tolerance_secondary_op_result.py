...
class FaultToleranceSecondaryOpResult(DataObject):
    """
    ...
    power_on_attempted: StrictBool = Field(description="Whether an attempt was made to power on the secondary.  If an attempt was made, *FaultToleranceSecondaryOpResult.powerOnResult* will report the status of this attempt.  ***Since:*** vSphere API 4.0 ", alias="powerOnAttempted")
    power_on_result: Optional[ClusterPowerOnVmResult] = Field(default=None, alias="powerOnResult")
