...
class GenerateCertificateSigningRequestByDnRequestType(BaseModel):
    """
    The parameters of *HostCertificateManager.GenerateCertificateSigningRequestByDn*. 
    """ # noqa: E501
    distinguished_name: StrictStr = Field(description="DN to be used as subject in CSR. ", alias="distinguishedName")
    spec: Optional[HostCertificateManagerCertificateSpec] = None
    __properties: ClassVar[List[str]] = ["distinguishedName", "spec"]
