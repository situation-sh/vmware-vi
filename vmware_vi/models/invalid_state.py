...
class InvalidState(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidState failed to lookup discriminator value from " +
...
InvalidState.model_rebuild(raise_errors=False)
