...
class VmfsMountFault(HostConfigFault):
    ...
    """ # noqa: E501
    uuid: StrictStr = Field(description="Vmfs volume uuid  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmfsMountFault failed to lookup discriminator value from " +
...
VmfsMountFault.model_rebuild(raise_errors=False)
