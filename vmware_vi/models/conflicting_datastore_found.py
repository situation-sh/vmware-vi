...
class ConflictingDatastoreFound(RuntimeFault):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the datastore.  ***Since:*** vSphere API 5.1 ")
    url: StrictStr = Field(description="The unique locator for the datastore.  ***Since:*** vSphere API 5.1 ")
