...
class GuestInfoNamespaceGenerationInfo(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="The namespace name as the unique key.  ***Since:*** vSphere API 5.1 ")
    generation_no: StrictInt = Field(description="Namespace generation number.  Generation number is changed whenever there is new unread event pending from the guest to the VMODL.  ***Since:*** vSphere API 5.1 ", alias="generationNo")
