...
class OvfElement(OvfInvalidPackage):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the element  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfElement failed to lookup discriminator value from " +
...
OvfElement.model_rebuild(raise_errors=False)
