...
class PrepareVchaRequestType(BaseModel):
    """
    The parameters of *FailoverClusterConfigurator.prepareVcha_Task*. 
    """ # noqa: E501
    network_spec: VchaClusterNetworkSpec = Field(alias="networkSpec")
    __properties: ClassVar[List[str]] = ["networkSpec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "networkSpec": VchaClusterNetworkSpec.from_dict(obj.get("networkSpec")) if obj.get("networkSpec") is not None else None
        })
        return _obj
