...
class VmFaultToleranceIssue(VimFault):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','CannotChangeDrsBehaviorForFtSecondary': 'CannotChangeDrsBehaviorForFtSecondary','CannotChangeHaSettingsForFtSecondary': 'CannotChangeHaSettingsForFtSecondary','CannotComputeFTCompatibleHosts': 'CannotComputeFTCompatibleHosts','FaultToleranceNotLicensed': 'FaultToleranceNotLicensed','FaultTolerancePrimaryPowerOnNotAttempted': 'FaultTolerancePrimaryPowerOnNotAttempted','FtIssuesOnHost': 'FtIssuesOnHost','HostIncompatibleForFaultTolerance': 'HostIncompatibleForFaultTolerance','IncompatibleHostForFtSecondary': 'IncompatibleHostForFtSecondary','InvalidOperationOnSecondaryVm': 'InvalidOperationOnSecondaryVm','NoHostSuitableForFtSecondary': 'NoHostSuitableForFtSecondary','NotSupportedDeviceForFT': 'NotSupportedDeviceForFT','PowerOnFtSecondaryFailed': 'PowerOnFtSecondaryFailed','SecondaryVmAlreadyDisabled': 'SecondaryVmAlreadyDisabled','SecondaryVmAlreadyEnabled': 'SecondaryVmAlreadyEnabled','SecondaryVmAlreadyRegistered': 'SecondaryVmAlreadyRegistered','SecondaryVmNotRegistered': 'SecondaryVmNotRegistered','VmFaultToleranceConfigIssue': 'VmFaultToleranceConfigIssue','VmFaultToleranceConfigIssueWrapper': 'VmFaultToleranceConfigIssueWrapper','VmFaultToleranceInvalidFileBacking': 'VmFaultToleranceInvalidFileBacking','VmFaultToleranceOpIssuesList': 'VmFaultToleranceOpIssuesList'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmFaultToleranceIssue failed to lookup discriminator value from " +
...
VmFaultToleranceIssue.model_rebuild(raise_errors=False)
