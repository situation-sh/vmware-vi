...
class HostFileAccess(DataObject):
    """
    This data object type contains a single access control entry for a file permissions list. 
    """ # noqa: E501
    who: StrictStr = Field(description="User or group to which the access applies. ")
    what: StrictStr = Field(description="Rights given to the user or group. ")
