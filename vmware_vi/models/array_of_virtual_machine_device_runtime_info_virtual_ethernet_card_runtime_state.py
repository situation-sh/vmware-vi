...
class ArrayOfVirtualMachineDeviceRuntimeInfoVirtualEthernetCardRuntimeState(Any):
    """
    A boxed array of *VirtualMachineDeviceRuntimeInfoVirtualEthernetCardRuntimeState*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[VirtualMachineDeviceRuntimeInfoVirtualEthernetCardRuntimeState] = Field(alias="_value")
