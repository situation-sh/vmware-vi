...
class HostLowLevelProvisioningManagerFileReserveSpec(DataObject):
    """
    HostLowLevelProvisioningManagerFileReserveSpec
    """ # noqa: E501
    base_name: StrictStr = Field(alias="baseName")
    parent_dir: StrictStr = Field(alias="parentDir")
    file_type: StrictStr = Field(alias="fileType")
    storage_profile: StrictStr = Field(alias="storageProfile")
