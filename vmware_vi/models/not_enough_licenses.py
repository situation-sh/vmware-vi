...
class NotEnoughLicenses(RuntimeFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("NotEnoughLicenses failed to lookup discriminator value from " +
...
NotEnoughLicenses.model_rebuild(raise_errors=False)
