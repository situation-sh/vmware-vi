...
class ClusterHostInfraUpdateHaModeAction(ClusterAction):
    """
    Describes a HostSystem's quarantine or maintenance mode change action.  ***Since:*** vSphere API 6.5 
    """ # noqa: E501
    operation_type: StrictStr = Field(description="Specify the action type.  Values are of type *OperationType*.  ***Since:*** vSphere API 6.5 ", alias="operationType")
