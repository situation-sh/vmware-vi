...
class PermissionEvent(AuthorizationEvent):
    ...
    principal: StrictStr = Field(description="The user name or group to which the permission was granted. ")
    group: StrictBool = Field(description="Whether or not the principal was a group. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PermissionEvent failed to lookup discriminator value from " +
...
PermissionEvent.model_rebuild(raise_errors=False)
