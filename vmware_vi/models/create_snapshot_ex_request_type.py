...
class CreateSnapshotExRequestType(BaseModel):
    """
    ...
    quiesce_spec: Optional[VirtualMachineGuestQuiesceSpec] = Field(default=None, alias="quiesceSpec")
    __properties: ClassVar[List[str]] = ["name", "description", "memory", "quiesceSpec"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of quiesce_spec
        if self.quiesce_spec:
            _dict['quiesceSpec'] = self.quiesce_spec.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "quiesceSpec": VirtualMachineGuestQuiesceSpec.from_dict(obj.get("quiesceSpec")) if obj.get("quiesceSpec") is not None else None
        })
        return _obj
