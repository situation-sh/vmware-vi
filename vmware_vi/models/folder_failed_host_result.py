...
class FolderFailedHostResult(DataObject):
    """
    FolderFailedHostResult
    """ # noqa: E501
    host_name: Optional[StrictStr] = Field(default=None, description="Host name for which fault belongs to.  ***Since:*** vSphere API 6.7.1 ", alias="hostName")
