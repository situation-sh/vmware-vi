...
class QueryConfigOptionExRequestType(BaseModel):
    """
    The parameters of *EnvironmentBrowser.QueryConfigOptionEx*. 
    """ # noqa: E501
    spec: Optional[EnvironmentBrowserConfigOptionQuerySpec] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "spec": EnvironmentBrowserConfigOptionQuerySpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
