...
class ArrayOfDistributedVirtualSwitchManagerHostDvsMembershipFilter(Any):
    """
    A boxed array of *DistributedVirtualSwitchManagerHostDvsMembershipFilter*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[DistributedVirtualSwitchManagerHostDvsMembershipFilter] = Field(alias="_value")
