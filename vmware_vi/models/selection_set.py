...
class SelectionSet(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("SelectionSet failed to lookup discriminator value from " +
...
SelectionSet.model_rebuild(raise_errors=False)
