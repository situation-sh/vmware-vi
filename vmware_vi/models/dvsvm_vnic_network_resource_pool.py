...
class DVSVmVnicNetworkResourcePool(DataObject):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="The description of the virtual NIC network resource pool.  ***Since:*** vSphere API 6.0 ")
    config_version: StrictStr = Field(description="The config version for the virtual NIC network resource pool.  ***Since:*** vSphere API 6.0 ", alias="configVersion")
