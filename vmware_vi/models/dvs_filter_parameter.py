...
class DvsFilterParameter(DataObject):
    """
    This class defines Network Filter parameter.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    parameters: Optional[List[StrictStr]] = Field(default=None, description="List of parameters for a Network Filter.  ***Since:*** vSphere API 5.5 ")
