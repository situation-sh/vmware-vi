...
class ClusterComputeResourceValidationResultBase(DataObject):
    """
    Describes the validation results.  ***Since:*** vSphere API 6.7.1 
    """ # noqa: E501
    info: Optional[List[LocalizableMessage]] = Field(default=None, description="Describes the messages relevant to the validation result  ***Since:*** vSphere API 6.7.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterComputeResourceValidationResultBase failed to lookup discriminator value from " +
...
ClusterComputeResourceValidationResultBase.model_rebuild(raise_errors=False)
