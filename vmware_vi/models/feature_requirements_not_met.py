...
class FeatureRequirementsNotMet(VirtualHardwareCompatibilityIssue):
    ...
    """ # noqa: E501
    feature_requirement: Optional[List[VirtualMachineFeatureRequirement]] = Field(default=None, description="The feature requirements that were not met.  ***Since:*** vSphere API 5.1 ", alias="featureRequirement")
