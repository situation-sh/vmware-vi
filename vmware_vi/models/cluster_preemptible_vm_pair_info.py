...
class ClusterPreemptibleVmPairInfo(DataObject):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Server-assigned unique ID for pairs.  When adding a new pair, do not specify this property. The server will assign the key and any assigned value will be ignored. ")
    monitored_vm: ManagedObjectReference = Field(alias="monitoredVm")
    preemptible_vm: ManagedObjectReference = Field(alias="preemptibleVm")
