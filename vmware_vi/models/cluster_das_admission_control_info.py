...
class ClusterDasAdmissionControlInfo(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterDasAdmissionControlInfo failed to lookup discriminator value from " +
...
ClusterDasAdmissionControlInfo.model_rebuild(raise_errors=False)
