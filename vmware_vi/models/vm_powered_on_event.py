...
class VmPoweredOnEvent(VmEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmPoweredOnEvent failed to lookup discriminator value from " +
...
VmPoweredOnEvent.model_rebuild(raise_errors=False)
