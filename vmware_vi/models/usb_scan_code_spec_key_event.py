...
class UsbScanCodeSpecKeyEvent(DataObject):
    """
    UsbScanCodeSpecKeyEvent
    """ # noqa: E501
    usb_hid_code: StrictInt = Field(description="USB HID code of the event  ***Since:*** vSphere API 6.5 ", alias="usbHidCode")
    modifiers: Optional[UsbScanCodeSpecModifierType] = None
