...
class HostNfcConnectionInfo(HostDataTransportConnectionInfo):
    """
    NfcConnectionInfo contains information about an NFC connection on the host.  ***Since:*** vSphere API 7.0.3.0 
    """ # noqa: E501
    streaming_memory_consumed: Optional[StrictInt] = Field(default=None, description="NFC streaming memory used by the connection in bytes.  ***Since:*** vSphere API 7.0.3.0 ", alias="streamingMemoryConsumed")
