...
class HostVFlashManagerVFlashConfigInfo(DataObject):
    """
    vFlash configuration Information.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    v_flash_resource_config_info: Optional[HostVFlashManagerVFlashResourceConfigInfo] = Field(default=None, alias="vFlashResourceConfigInfo")
    v_flash_cache_config_info: Optional[HostVFlashManagerVFlashCacheConfigInfo] = Field(default=None, alias="vFlashCacheConfigInfo")
