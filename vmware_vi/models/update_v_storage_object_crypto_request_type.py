...
class UpdateVStorageObjectCryptoRequestType(BaseModel):
    """
    The parameters of *VcenterVStorageObjectManager.UpdateVStorageObjectCrypto_Task*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    profile: Optional[List[VirtualMachineProfileSpec]] = Field(default=None, description="New profile requirement on the virtual storage object.  ***Since:*** vSphere API 5.5 ")
    disks_crypto: Optional[DiskCryptoSpec] = Field(default=None, alias="disksCrypto")
    __properties: ClassVar[List[str]] = ["id", "datastore", "profile", "disksCrypto"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of disks_crypto
        if self.disks_crypto:
            _dict['disksCrypto'] = self.disks_crypto.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "disksCrypto": DiskCryptoSpec.from_dict(obj.get("disksCrypto")) if obj.get("disksCrypto") is not None else None
        })
        return _obj
