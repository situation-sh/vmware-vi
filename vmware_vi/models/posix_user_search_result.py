...
class PosixUserSearchResult(UserSearchResult):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="If the search result is for a user, then id refers to User ID.  For a group, the value of Group ID is assigned to id. ")
    shell_access: Optional[StrictBool] = Field(default=None, description="If the search result is for a user, shellAccess indicates whether shell access has been granted or not. ", alias="shellAccess")
