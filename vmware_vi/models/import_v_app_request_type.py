...
class ImportVAppRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["spec", "folder", "host"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "spec": ImportSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
