...
class PropertyFilterUpdate(DataObject):
    """
    ...
    object_set: Optional[List[ObjectUpdate]] = Field(default=None, description="Set of changes to object properties in the filter. ", alias="objectSet")
    missing_set: Optional[List[MissingObject]] = Field(default=None, description="Objects that could not be found on the server, but were specified in a *PropertyFilterSpec.objectSet*.  This field will only be populated for objects that were determined to be missing since the data version passed to *PropertyCollector.CheckForUpdates*, *PropertyCollector.WaitForUpdates*, or *PropertyCollector.WaitForUpdatesEx* and will not contain objects that were missing prior to that data version. ", alias="missingSet")
