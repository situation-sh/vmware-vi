...
class ClusterDasHostInfo(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterDasHostInfo failed to lookup discriminator value from " +
...
ClusterDasHostInfo.model_rebuild(raise_errors=False)
