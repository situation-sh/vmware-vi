...
class PatchMissingDependencies(PatchNotApplicable):
    ...
    """ # noqa: E501
    prerequisite_patch: Optional[List[StrictStr]] = Field(default=None, description="The ID of required patches. ", alias="prerequisitePatch")
    prerequisite_lib: Optional[List[StrictStr]] = Field(default=None, description="The names of required libraries or RPMs. ", alias="prerequisiteLib")
