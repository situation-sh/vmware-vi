...
class ScheduledTaskSpec(DataObject):
    """
    Parameters for scheduled task creation. 
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the scheduled task. ")
    description: StrictStr = Field(description="Description of the scheduled task. ")
    enabled: StrictBool = Field(description="Flag to indicate whether the scheduled task is enabled or disabled. ")
    scheduler: TaskScheduler
    action: Action
    notification: Optional[StrictStr] = Field(default=None, description="The email notification.  If not set, this property is set to empty string, indicating no notification. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ScheduledTaskSpec failed to lookup discriminator value from " +
...
ScheduledTaskSpec.model_rebuild(raise_errors=False)
