...
class CreateNvdimmNamespaceRequestType(BaseModel):
    """
    The parameters of *HostNvdimmSystem.CreateNvdimmNamespace_Task*. 
    """ # noqa: E501
    create_spec: NvdimmNamespaceCreateSpec = Field(alias="createSpec")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "createSpec": NvdimmNamespaceCreateSpec.from_dict(obj.get("createSpec")) if obj.get("createSpec") is not None else None
        })
        return _obj
