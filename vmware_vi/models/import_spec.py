...
class ImportSpec(DataObject):
    ...
    """ # noqa: E501
    entity_config: Optional[VAppEntityConfigInfo] = Field(default=None, alias="entityConfig")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ImportSpec failed to lookup discriminator value from " +
...
ImportSpec.model_rebuild(raise_errors=False)
