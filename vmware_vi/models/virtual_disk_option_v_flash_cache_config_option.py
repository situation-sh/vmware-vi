...
class VirtualDiskOptionVFlashCacheConfigOption(DataObject):
    """
    ...
    reservation_in_mb: LongOption = Field(alias="reservationInMB")
    block_size_in_kb: LongOption = Field(alias="blockSizeInKB")
