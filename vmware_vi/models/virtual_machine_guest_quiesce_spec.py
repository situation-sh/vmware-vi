...
class VirtualMachineGuestQuiesceSpec(DataObject):
    """
    ...
    """ # noqa: E501
    timeout: Optional[StrictInt] = Field(default=None, description="The property to indicate maximum time in minutes for snapshot operation to be performed on the virtual machine.  The timeout can not be less than 5 minutes or more than 240 minutes.  ***Since:*** vSphere API 6.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineGuestQuiesceSpec failed to lookup discriminator value from " +
...
VirtualMachineGuestQuiesceSpec.model_rebuild(raise_errors=False)
