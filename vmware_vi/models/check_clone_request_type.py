...
class CheckCloneRequestType(BaseModel):
    """
    The parameters of *VirtualMachineProvisioningChecker.CheckClone_Task*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    folder: ManagedObjectReference
    name: StrictStr = Field(description="The name of the new virtual machine. ")
    spec: VirtualMachineCloneSpec
    test_type: Optional[List[StrictStr]] = Field(default=None, description="The set of tests to run. If this argument is not set, all tests will be run. See *CheckTestType_enum* for possible values. ", alias="testType")
    __properties: ClassVar[List[str]] = ["vm", "folder", "name", "spec", "testType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "folder": ManagedObjectReference.from_dict(obj.get("folder")) if obj.get("folder") is not None else None,
            "name": obj.get("name"),
            "spec": VirtualMachineCloneSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
