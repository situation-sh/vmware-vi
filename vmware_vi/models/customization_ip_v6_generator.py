...
class CustomizationIpV6Generator(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationIpV6Generator failed to lookup discriminator value from " +
...
CustomizationIpV6Generator.model_rebuild(raise_errors=False)
