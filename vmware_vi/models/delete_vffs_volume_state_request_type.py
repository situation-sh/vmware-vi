...
class DeleteVffsVolumeStateRequestType(BaseModel):
    """
    The parameters of *HostStorageSystem.DeleteVffsVolumeState*. 
    """ # noqa: E501
    vffs_uuid: StrictStr = Field(description="The VFFS UUID. ", alias="vffsUuid")
    __properties: ClassVar[List[str]] = ["vffsUuid"]
