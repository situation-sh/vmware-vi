...
class UpdateChildResourceConfigurationRequestType(BaseModel):
    """
    The parameters of *ResourcePool.UpdateChildResourceConfiguration*. 
    """ # noqa: E501
    spec: List[ResourceConfigSpec]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "spec": [ResourceConfigSpec.from_dict(_item) for _item in obj.get("spec")] if obj.get("spec") is not None else None
        })
        return _obj
