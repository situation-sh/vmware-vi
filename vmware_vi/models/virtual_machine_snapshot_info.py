...
class VirtualMachineSnapshotInfo(DataObject):
    """
    The SnapshotInfo data object type provides all the information about the hierarchy of snapshots in a virtual machine. 
    """ # noqa: E501
    current_snapshot: Optional[ManagedObjectReference] = Field(default=None, alias="currentSnapshot")
    root_snapshot_list: List[VirtualMachineSnapshotTree] = Field(description="Data for the entire set of snapshots for one virtual machine. ", alias="rootSnapshotList")
