...
class ProfileMetadataProfileOperationMessage(DataObject):
    """
    ...
    """ # noqa: E501
    operation_name: StrictStr = Field(description="The operation name.  ***Since:*** vSphere API 6.7 ", alias="operationName")
