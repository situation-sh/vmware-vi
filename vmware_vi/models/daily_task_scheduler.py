...
class DailyTaskScheduler(HourlyTaskScheduler):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DailyTaskScheduler failed to lookup discriminator value from " +
...
DailyTaskScheduler.model_rebuild(raise_errors=False)
