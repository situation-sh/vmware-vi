...
class InaccessibleDatastore(InvalidDatastore):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("InaccessibleDatastore failed to lookup discriminator value from " +
...
InaccessibleDatastore.model_rebuild(raise_errors=False)
