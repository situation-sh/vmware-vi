...
class HostVirtualNicManagerInfo(DataObject):
    """
    This data object type describes VirtualNic host configuration data objects.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    net_config: Optional[List[VirtualNicManagerNetConfig]] = Field(default=None, description="List of VirtualNicManager network configuration.  See also *VirtualNicManagerNetConfig*This contains the network configuration for each NicType..  ***Since:*** vSphere API 4.0 ", alias="netConfig")
