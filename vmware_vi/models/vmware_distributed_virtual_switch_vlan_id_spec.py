...
class VmwareDistributedVirtualSwitchVlanIdSpec(VmwareDistributedVirtualSwitchVlanSpec):
    ...
    """ # noqa: E501
    vlan_id: StrictInt = Field(description="The VLAN ID for ports.  Possible values: - A value of 0 specifies that you do not want the port associated   with a VLAN. - A value from 1 to 4094 specifies a VLAN ID for the port.      ***Since:*** vSphere API 4.0 ", alias="vlanId")
