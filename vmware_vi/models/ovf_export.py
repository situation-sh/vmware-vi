...
class OvfExport(OvfFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfExport failed to lookup discriminator value from " +
...
OvfExport.model_rebuild(raise_errors=False)
