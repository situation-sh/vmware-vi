...
class VmRenamedEvent(VmEvent):
    ...
    """ # noqa: E501
    old_name: StrictStr = Field(description="The old name of the virtual machine. ", alias="oldName")
    new_name: StrictStr = Field(description="The new name of the virtual machine. ", alias="newName")
