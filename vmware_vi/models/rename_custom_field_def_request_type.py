...
class RenameCustomFieldDefRequestType(BaseModel):
    """
    The parameters of *CustomFieldsManager.RenameCustomFieldDef*. 
    """ # noqa: E501
    key: StrictInt = Field(description="The unique key for the field definition. ")
    name: StrictStr = Field(description="The new name for the field. ")
