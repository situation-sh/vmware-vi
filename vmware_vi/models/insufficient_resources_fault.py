...
class InsufficientResourcesFault(VimFault):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','InsufficientAgentVmsDeployed': 'InsufficientAgentVmsDeployed','InsufficientCpuResourcesFault': 'InsufficientCpuResourcesFault','InsufficientFailoverResourcesFault': 'InsufficientFailoverResourcesFault','InsufficientGraphicsResourcesFault': 'InsufficientGraphicsResourcesFault','InsufficientHostCapacityFault': 'InsufficientHostCapacityFault','InsufficientHostCpuCapacityFault': 'InsufficientHostCpuCapacityFault','InsufficientHostMemoryCapacityFault': 'InsufficientHostMemoryCapacityFault','InsufficientMemoryResourcesFault': 'InsufficientMemoryResourcesFault','InsufficientNetworkCapacity': 'InsufficientNetworkCapacity','InsufficientNetworkResourcePoolCapacity': 'InsufficientNetworkResourcePoolCapacity','InsufficientPerCpuCapacity': 'InsufficientPerCpuCapacity','InsufficientStandbyCpuResource': 'InsufficientStandbyCpuResource','InsufficientStandbyMemoryResource': 'InsufficientStandbyMemoryResource','InsufficientStandbyResource': 'InsufficientStandbyResource','InsufficientStorageSpace': 'InsufficientStorageSpace','InsufficientVFlashResourcesFault': 'InsufficientVFlashResourcesFault','InvalidResourcePoolStructureFault': 'InvalidResourcePoolStructureFault','NumVirtualCpusExceedsLimit': 'NumVirtualCpusExceedsLimit','VmFaultToleranceTooManyFtVcpusOnHost': 'VmFaultToleranceTooManyFtVcpusOnHost','VmFaultToleranceTooManyVMsOnHost': 'VmFaultToleranceTooManyVMsOnHost','VmSmpFaultToleranceTooManyVMsOnHost': 'VmSmpFaultToleranceTooManyVMsOnHost'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InsufficientResourcesFault failed to lookup discriminator value from " +
...
InsufficientResourcesFault.model_rebuild(raise_errors=False)
