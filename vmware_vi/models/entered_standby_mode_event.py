...
class EnteredStandbyModeEvent(HostEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("EnteredStandbyModeEvent failed to lookup discriminator value from " +
...
EnteredStandbyModeEvent.model_rebuild(raise_errors=False)
