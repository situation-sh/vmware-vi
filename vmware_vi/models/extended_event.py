...
class ExtendedEvent(GeneralEvent):
    ...
    """ # noqa: E501
    event_type_id: StrictStr = Field(description="The id of the type of extended event.  ***Since:*** VI API 2.5 ", alias="eventTypeId")
    managed_object: ManagedObjectReference = Field(alias="managedObject")
    data: Optional[List[ExtendedEventPair]] = Field(default=None, description="Key/value pairs associated with event.  ***Since:*** VI API 2.5 ")
