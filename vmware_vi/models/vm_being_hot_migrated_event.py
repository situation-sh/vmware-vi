...
class VmBeingHotMigratedEvent(VmEvent):
    ...
    """ # noqa: E501
    dest_host: HostEventArgument = Field(alias="destHost")
    dest_datacenter: Optional[DatacenterEventArgument] = Field(default=None, alias="destDatacenter")
    dest_datastore: Optional[DatastoreEventArgument] = Field(default=None, alias="destDatastore")
