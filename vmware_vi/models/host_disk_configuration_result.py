...
class HostDiskConfigurationResult(DataObject):
    """
    Disk configuration result returns success or fault of the operation on the disk.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    device_path: Optional[StrictStr] = Field(default=None, description="The device path.  See *ScsiDisk*  ***Since:*** vSphere API 5.5 ", alias="devicePath")
    success: Optional[StrictBool] = Field(default=None, description="Flag to indicate if the operation is successful  ***Since:*** vSphere API 5.5 ")
