...
class CheckCustomizationResourcesRequestType(BaseModel):
    """
    The parameters of *CustomizationSpecManager.CheckCustomizationResources*. 
    """ # noqa: E501
    guest_os: StrictStr = Field(description="Short name from the guest OS descriptor list describing the OS we intend to customize. ", alias="guestOs")
    __properties: ClassVar[List[str]] = ["guestOs"]
