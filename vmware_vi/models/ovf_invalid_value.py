...
class OvfInvalidValue(OvfAttribute):
    ...
    """ # noqa: E501
    value: StrictStr = Field(description="Attribute value  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfInvalidValue failed to lookup discriminator value from " +
...
OvfInvalidValue.model_rebuild(raise_errors=False)
