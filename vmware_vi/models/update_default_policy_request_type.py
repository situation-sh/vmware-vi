...
class UpdateDefaultPolicyRequestType(BaseModel):
    """
    The parameters of *HostFirewallSystem.UpdateDefaultPolicy*. 
    """ # noqa: E501
    default_policy: HostFirewallDefaultPolicy = Field(alias="defaultPolicy")
    __properties: ClassVar[List[str]] = ["defaultPolicy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.default_policy:
            _dict['defaultPolicy'] = self.default_policy.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "defaultPolicy": HostFirewallDefaultPolicy.from_dict(obj.get("defaultPolicy")) if obj.get("defaultPolicy") is not None else None
        })
        return _obj
