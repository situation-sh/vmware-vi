...
class UpdateHppMultipathLunPolicyRequestType(BaseModel):
    """
    The parameters of *HostStorageSystem.UpdateHppMultipathLunPolicy*. 
    """ # noqa: E501
    lun_id: StrictStr = Field(description="The logical unit ID ", alias="lunId")
    policy: HostMultipathInfoHppLogicalUnitPolicy
    __properties: ClassVar[List[str]] = ["lunId", "policy"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "lunId": obj.get("lunId"),
            "policy": HostMultipathInfoHppLogicalUnitPolicy.from_dict(obj.get("policy")) if obj.get("policy") is not None else None
        })
        return _obj
