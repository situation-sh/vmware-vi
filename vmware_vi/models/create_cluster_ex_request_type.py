...
class CreateClusterExRequestType(BaseModel):
    """
    The parameters of *Folder.CreateClusterEx*. 
    """ # noqa: E501
    name: StrictStr = Field(description="Name for the new cluster. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "spec": ClusterConfigSpecEx.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
