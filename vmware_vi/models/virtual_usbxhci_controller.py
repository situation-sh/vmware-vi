...
class VirtualUSBXHCIController(VirtualController):
    ...
    """ # noqa: E501
    auto_connect_devices: Optional[StrictBool] = Field(default=None, description="Flag to indicate whether or not the ability to hot plug devices is enabled on this controller.  ***Since:*** vSphere API 5.0 ", alias="autoConnectDevices")
