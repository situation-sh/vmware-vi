...
class InvalidDasConfigArgumentEntryForInvalidArgumentEnum(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of InvalidDasConfigArgumentEntryForInvalidArgumentEnum from a JSON string"""
