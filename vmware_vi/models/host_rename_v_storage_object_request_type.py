...
class HostRenameVStorageObjectRequestType(BaseModel):
    """
    The parameters of *HostVStorageObjectManager.HostRenameVStorageObject*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    name: StrictStr = Field(description="The new name for the virtual storage object. ")
    __properties: ClassVar[List[str]] = ["id", "datastore", "name"]
