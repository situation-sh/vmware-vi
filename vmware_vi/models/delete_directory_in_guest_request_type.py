...
class DeleteDirectoryInGuestRequestType(BaseModel):
    """
    The parameters of *GuestFileManager.DeleteDirectoryInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    directory_path: StrictStr = Field(description="The complete path to the directory to be deleted. ", alias="directoryPath")
    recursive: StrictBool = Field(description="If true, all subdirectories are also deleted. If false, the directory must be empty for the operation to succeed. ")
    __properties: ClassVar[List[str]] = ["vm", "auth", "directoryPath", "recursive"]
