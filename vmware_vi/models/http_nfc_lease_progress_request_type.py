...
class HttpNfcLeaseProgressRequestType(BaseModel):
    """
    The parameters of *HttpNfcLease.HttpNfcLeaseProgress*. 
    """ # noqa: E501
    percent: StrictInt = Field(description="\\[in\\] Completion status represented as an integer in the 0-100 range. ")
    __properties: ClassVar[List[str]] = ["percent"]
