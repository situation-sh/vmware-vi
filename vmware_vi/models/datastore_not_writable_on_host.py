...
class DatastoreNotWritableOnHost(InvalidDatastore):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DatastoreNotWritableOnHost failed to lookup discriminator value from " +
...
DatastoreNotWritableOnHost.model_rebuild(raise_errors=False)
