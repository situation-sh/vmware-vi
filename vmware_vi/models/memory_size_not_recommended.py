...
class MemorySizeNotRecommended(VirtualHardwareCompatibilityIssue):
    ...
    """ # noqa: E501
    memory_size_mb: StrictInt = Field(description="The configured memory size of the virtual machine.  ***Since:*** VI API 2.5 ", alias="memorySizeMB")
    min_memory_size_mb: StrictInt = Field(description="The minimum recommended memory size.  ***Since:*** VI API 2.5 ", alias="minMemorySizeMB")
    max_memory_size_mb: StrictInt = Field(description="The maximum recommended memory size.  ***Since:*** VI API 2.5 ", alias="maxMemorySizeMB")
