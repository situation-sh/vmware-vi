...
class HealthSystemRuntime(DataObject):
    """
    The system health runtime information  ***Since:*** VI API 2.5 
    """ # noqa: E501
    system_health_info: Optional[HostSystemHealthInfo] = Field(default=None, alias="systemHealthInfo")
    hardware_status_info: Optional[HostHardwareStatusInfo] = Field(default=None, alias="hardwareStatusInfo")
