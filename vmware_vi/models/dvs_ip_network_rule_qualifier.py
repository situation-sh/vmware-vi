...
class DvsIpNetworkRuleQualifier(DvsNetworkRuleQualifier):
    """
    ...
    """ # noqa: E501
    source_address: Optional[IpAddress] = Field(default=None, alias="sourceAddress")
    destination_address: Optional[IpAddress] = Field(default=None, alias="destinationAddress")
    protocol: Optional[IntExpression] = None
    source_ip_port: Optional[DvsIpPort] = Field(default=None, alias="sourceIpPort")
    destination_ip_port: Optional[DvsIpPort] = Field(default=None, alias="destinationIpPort")
    tcp_flags: Optional[IntExpression] = Field(default=None, alias="tcpFlags")
