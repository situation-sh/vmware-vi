...
class NodeNetworkSpec(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("NodeNetworkSpec failed to lookup discriminator value from " +
...
NodeNetworkSpec.model_rebuild(raise_errors=False)
