...
class SystemError(RuntimeFault):
    ...
    """ # noqa: E501
    reason: StrictStr = Field(description="A message to indicate detailed information about the error.  This property is not internationalization friendly and normally reported by the underlying operating system. ")
