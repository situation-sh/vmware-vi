...
class IscsiStatus(DataObject):
    """
    The *IscsiStatus* data object describes the status of an operation.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    reason: Optional[List[MethodFault]] = Field(default=None, description="List of failure reason and associated remedy.  An array of fault codes associated with the failure. The fault itself will provide an indication of the actual failure code and *MethodFault.faultMessage* will indicate the remedy that needs to be taken to correct the failure.  ***Since:*** vSphere API 5.0 ")
