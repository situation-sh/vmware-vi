...
class HostTargetTransport(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostTargetTransport failed to lookup discriminator value from " +
...
HostTargetTransport.model_rebuild(raise_errors=False)
