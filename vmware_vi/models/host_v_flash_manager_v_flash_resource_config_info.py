...
class HostVFlashManagerVFlashResourceConfigInfo(DataObject):
    """
    vFlash resource configuration Information.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    vffs: Optional[HostVffsVolume] = None
    capacity: StrictInt = Field(description="Capacity of the vFlash resource.  It is the capacity of the contained VFFS volume.  ***Since:*** vSphere API 5.5 ")
