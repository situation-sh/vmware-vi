...
class OvfInvalidPackage(OvfFault):
    ...
    """ # noqa: E501
    line_number: StrictInt = Field(description="XML OVF descriptor line numbers  ***Since:*** vSphere API 4.0 ", alias="lineNumber")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','OvfAttribute': 'OvfAttribute','OvfConstraint': 'OvfConstraint','OvfDiskOrderConstraint': 'OvfDiskOrderConstraint','OvfDuplicateElement': 'OvfDuplicateElement','OvfDuplicatedElementBoundary': 'OvfDuplicatedElementBoundary','OvfElement': 'OvfElement','OvfElementInvalidValue': 'OvfElementInvalidValue','OvfHostResourceConstraint': 'OvfHostResourceConstraint','OvfInvalidValue': 'OvfInvalidValue','OvfInvalidValueConfiguration': 'OvfInvalidValueConfiguration','OvfInvalidValueEmpty': 'OvfInvalidValueEmpty','OvfInvalidValueFormatMalformed': 'OvfInvalidValueFormatMalformed','OvfInvalidValueReference': 'OvfInvalidValueReference','OvfMissingAttribute': 'OvfMissingAttribute','OvfMissingElement': 'OvfMissingElement','OvfMissingElementNormalBoundary': 'OvfMissingElementNormalBoundary','OvfProperty': 'OvfProperty','OvfPropertyNetwork': 'OvfPropertyNetwork','OvfPropertyQualifier': 'OvfPropertyQualifier','OvfPropertyQualifierDuplicate': 'OvfPropertyQualifierDuplicate','OvfPropertyQualifierIgnored': 'OvfPropertyQualifierIgnored','OvfPropertyType': 'OvfPropertyType','OvfPropertyValue': 'OvfPropertyValue','OvfUnexpectedElement': 'OvfUnexpectedElement','OvfWrongElement': 'OvfWrongElement','OvfWrongNamespace': 'OvfWrongNamespace','OvfXmlFormat': 'OvfXmlFormat'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfInvalidPackage failed to lookup discriminator value from " +
...
OvfInvalidPackage.model_rebuild(raise_errors=False)
