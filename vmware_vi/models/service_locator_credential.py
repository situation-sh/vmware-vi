...
class ServiceLocatorCredential(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ServiceLocatorCredential failed to lookup discriminator value from " +
...
ServiceLocatorCredential.model_rebuild(raise_errors=False)
