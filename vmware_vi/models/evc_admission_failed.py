...
class EVCAdmissionFailed(NotSupportedHostInCluster):
    ...
    """ # noqa: E501
    faults: Optional[List[MethodFault]] = Field(default=None, description="The faults that caused this EVC test to fail (e.g.  FeatureRequirementsNotMet faults).  ***Since:*** vSphere API 5.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("EVCAdmissionFailed failed to lookup discriminator value from " +
...
EVCAdmissionFailed.model_rebuild(raise_errors=False)
