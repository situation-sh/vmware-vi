...
class DistributedVirtualSwitchHostMemberPnicSpec(DataObject):
    """
    Specification for an individual physical NIC.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    pnic_device: StrictStr = Field(description="Name of the physical NIC to be added to the proxy switch.  See *PhysicalNic*.*PhysicalNic.device*.  ***Since:*** vSphere API 4.0 ", alias="pnicDevice")
    uplink_port_key: Optional[StrictStr] = Field(default=None, description="Key of the port to be connected to the physical NIC.  ***Since:*** vSphere API 4.0 ", alias="uplinkPortKey")
    uplink_portgroup_key: Optional[StrictStr] = Field(default=None, description="Key of the portgroup to be connected to the physical NIC.  ***Since:*** vSphere API 4.0 ", alias="uplinkPortgroupKey")
