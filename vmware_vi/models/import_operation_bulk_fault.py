...
class ImportOperationBulkFault(DvsFault):
    ...
    """ # noqa: E501
    import_faults: List[ImportOperationBulkFaultFaultOnImport] = Field(description="Faults occurred during the import operation  ***Since:*** vSphere API 5.1 ", alias="importFaults")
