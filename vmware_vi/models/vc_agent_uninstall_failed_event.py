...
class VcAgentUninstallFailedEvent(HostEvent):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason why the uninstall failed, if known.  See *AgentInstallFailedReason_enum*  ***Since:*** vSphere API 4.0 ")
