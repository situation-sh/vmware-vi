...
class ConflictingConfiguration(DvsFault):
    ...
    """ # noqa: E501
    config_in_conflict: List[ConflictingConfigurationConfig] = Field(description="The configurations that are in conflict.  ***Since:*** vSphere API 5.5 ", alias="configInConflict")
