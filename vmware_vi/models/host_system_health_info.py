...
class HostSystemHealthInfo(DataObject):
    """
    ...
    """ # noqa: E501
    numeric_sensor_info: Optional[List[HostNumericSensorInfo]] = Field(default=None, description="Health information provided by the power probes.  ***Since:*** VI API 2.5 ", alias="numericSensorInfo")
