...
class HostFirewallConfig(DataObject):
    """
    DataObject used for firewall configuration  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    rule: Optional[List[HostFirewallConfigRuleSetConfig]] = Field(default=None, description="Rules determining firewall settings.  ***Since:*** vSphere API 4.0 ")
    default_blocking_policy: HostFirewallDefaultPolicy = Field(alias="defaultBlockingPolicy")
