...
class NotSupportedHostInHACluster(NotSupportedHost):
    ...
    """ # noqa: E501
    host_name: StrictStr = Field(description="The name of the host.  ***Since:*** vSphere API 5.0 ", alias="hostName")
    build: StrictStr = Field(description="The product build number of the host.  ***Since:*** vSphere API 5.0 ")
