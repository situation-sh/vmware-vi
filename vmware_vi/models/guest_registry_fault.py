...
class GuestRegistryFault(GuestOperationsFault):
    ...
    """ # noqa: E501
    windows_system_error_code: StrictInt = Field(description="The windows system error number from GetLastError().  ***Since:*** vSphere API 6.0 ", alias="windowsSystemErrorCode")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestRegistryFault failed to lookup discriminator value from " +
...
GuestRegistryFault.model_rebuild(raise_errors=False)
