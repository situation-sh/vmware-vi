...
class HostTpmCommandEventDetails(HostTpmEventDetails):
    """
    ...
    """ # noqa: E501
    command_line: StrictStr = Field(description="Boot options as entered on the command line prompt at boot time.  ***Since:*** vSphere API 5.1 ", alias="commandLine")
