...
class InvalidDatastore(VimFault):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the datastore that is invalid. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidDatastore failed to lookup discriminator value from " +
...
InvalidDatastore.model_rebuild(raise_errors=False)
