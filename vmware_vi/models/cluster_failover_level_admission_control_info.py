...
class ClusterFailoverLevelAdmissionControlInfo(ClusterDasAdmissionControlInfo):
    ...
    """ # noqa: E501
    current_failover_level: StrictInt = Field(description="Current failover level.  This is the number of physical host failures that can be tolerated without impacting the ability to satisfy the minimums for all running virtual machines. This represents the current value, as opposed to desired value configured by the user.  ***Since:*** vSphere API 4.0 ", alias="currentFailoverLevel")
