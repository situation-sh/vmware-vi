...
class UserPrivilegeResult(DataObject):
    """
    ...
    privileges: Optional[List[StrictStr]] = Field(default=None, description="A list of privileges set on the entity.  ***Since:*** vSphere API 6.5 ")
