...
class ArrayOfHostProfileManagerCompositionValidationResultResultElement(Any):
    """
    A boxed array of *HostProfileManagerCompositionValidationResultResultElement*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[HostProfileManagerCompositionValidationResultResultElement] = Field(alias="_value")
