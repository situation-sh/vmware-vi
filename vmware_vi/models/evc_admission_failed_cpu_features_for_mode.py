...
class EVCAdmissionFailedCPUFeaturesForMode(EVCAdmissionFailed):
    ...
    """ # noqa: E501
    current_evc_mode_key: StrictStr = Field(description="The Enhanced VMotion Compatibility mode that is currently in effect for the cluster.  ***Since:*** vSphere API 4.0 ", alias="currentEVCModeKey")
