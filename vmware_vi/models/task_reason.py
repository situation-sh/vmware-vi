...
class TaskReason(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("TaskReason failed to lookup discriminator value from " +
...
TaskReason.model_rebuild(raise_errors=False)
