...
class VirtualDiskOption(VirtualDeviceOption):
    ...
    """ # noqa: E501
    capacity_in_kb: LongOption = Field(alias="capacityInKB")
    io_allocation_option: StorageIOAllocationOption = Field(alias="ioAllocationOption")
    v_flash_cache_config_option: Optional[VirtualDiskOptionVFlashCacheConfigOption] = Field(default=None, alias="vFlashCacheConfigOption")
