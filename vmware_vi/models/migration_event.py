...
class MigrationEvent(VmEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("MigrationEvent failed to lookup discriminator value from " +
...
MigrationEvent.model_rebuild(raise_errors=False)
