...
class VirtualMachineProfileDetails(DataObject):
    """
    ...
    """ # noqa: E501
    profile: Optional[List[VirtualMachineProfileSpec]] = Field(default=None, description="Storage profile associated with Virtual Machine's home directory.  ***Since:*** vSphere API 6.7 ")
    disk_profile_details: Optional[List[VirtualMachineProfileDetailsDiskProfileDetails]] = Field(default=None, description="An optional list that allows specifying details of the policy associated with virutual disks.  ***Since:*** vSphere API 6.7 ", alias="diskProfileDetails")
