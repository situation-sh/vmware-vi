...
class GuestOperationsFault(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestOperationsFault failed to lookup discriminator value from " +
...
GuestOperationsFault.model_rebuild(raise_errors=False)
