...
class DeleteFileInGuestRequestType(BaseModel):
    """
    The parameters of *GuestFileManager.DeleteFileInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    file_path: StrictStr = Field(description="The complete path to the file or symbolic link to be deleted. ", alias="filePath")
    __properties: ClassVar[List[str]] = ["vm", "auth", "filePath"]
