...
class HostNetworkResourceRuntime(DataObject):
    """
    This data type describes the network resource runtime information  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    pnic_resource_info: List[HostPnicNetworkResourceInfo] = Field(description="The network resource related information on each physical NIC  ***Since:*** vSphere API 6.0 ", alias="pnicResourceInfo")
