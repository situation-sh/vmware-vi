...
class NodeDeploymentSpec(DataObject):
    """
    ...
    """ # noqa: E501
    esx_host: Optional[ManagedObjectReference] = Field(default=None, alias="esxHost")
    datastore: Optional[ManagedObjectReference] = None
    public_network_port_group: Optional[ManagedObjectReference] = Field(default=None, alias="publicNetworkPortGroup")
    cluster_network_port_group: Optional[ManagedObjectReference] = Field(default=None, alias="clusterNetworkPortGroup")
    folder: ManagedObjectReference
    resource_pool: Optional[ManagedObjectReference] = Field(default=None, alias="resourcePool")
    management_vc: Optional[ServiceLocator] = Field(default=None, alias="managementVc")
    node_name: StrictStr = Field(description="nodeName here refers to a name that will be assigned to the VM to which this node will be deployed to.  ***Since:*** vSphere API 6.5 ", alias="nodeName")
    ip_settings: CustomizationIPSettings = Field(alias="ipSettings")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("NodeDeploymentSpec failed to lookup discriminator value from " +
...
NodeDeploymentSpec.model_rebuild(raise_errors=False)
