...
class VsanDiskFault(VsanFault):
    ...
    """ # noqa: E501
    device: Optional[StrictStr] = Field(default=None, description="The canonical name for the disk at hand, if applicable.  See also *ScsiLun.canonicalName*.  ***Since:*** vSphere API 5.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VsanDiskFault failed to lookup discriminator value from " +
...
VsanDiskFault.model_rebuild(raise_errors=False)
