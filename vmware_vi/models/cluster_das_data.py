...
class ClusterDasData(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterDasData failed to lookup discriminator value from " +
...
ClusterDasData.model_rebuild(raise_errors=False)
