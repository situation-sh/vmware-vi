...
class ClusterProfileConfigServiceCreateSpec(ClusterProfileConfigSpec):
    ...
    """ # noqa: E501
    service_type: Optional[List[StrictStr]] = Field(default=None, description="Type of the service for which the ClusterProfile is being requested.  If more than one service is specified, the created ClusterProfile will cater for all the services. Possible values are specified by *ClusterProfileServiceType_enum*. If unset, clear the compliance expressions on the profile.  ***Since:*** vSphere API 4.0 ", alias="serviceType")
