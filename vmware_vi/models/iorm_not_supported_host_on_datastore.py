...
class IORMNotSupportedHostOnDatastore(VimFault):
    ...
    datastore_name: StrictStr = Field(description="The name of the datastore.  ***Since:*** vSphere API 4.1 ", alias="datastoreName")
    host: Optional[List[ManagedObjectReference]] = Field(default=None, description="The list of hosts that do not support storage I/O resource management.  ***Since:*** vSphere API 4.1  Refers instances of *HostSystem*. ")
