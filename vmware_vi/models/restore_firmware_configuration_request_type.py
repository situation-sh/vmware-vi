...
class RestoreFirmwareConfigurationRequestType(BaseModel):
    """
    The parameters of *HostFirmwareSystem.RestoreFirmwareConfiguration*. 
    """ # noqa: E501
    force: StrictBool = Field(description="Forces application of the configuration even if the bundle is mismatched. ")
