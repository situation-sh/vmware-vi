...
class QuiesceDatastoreIOForHAFailed(ResourceInUse):
    ...
    host_name: StrictStr = Field(description="Name of the host.  ***Since:*** vSphere API 5.0 ", alias="hostName")
    ds: ManagedObjectReference
    ds_name: StrictStr = Field(description="Name of the datastore.  ***Since:*** vSphere API 5.0 ", alias="dsName")
