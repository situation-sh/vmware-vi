...
class HostAssignableHardwareConfigAttributeOverride(DataObject):
    """
    ...
    """ # noqa: E501
    instance_id: StrictStr = Field(description="Instance ID of the Assignable Hardware instance node where the attribute specified by name is overridden.  ***Since:*** vSphere API 7.0 ", alias="instanceId")
    name: StrictStr = Field(description="Name of attribute to override.  ***Since:*** vSphere API 7.0 ")
