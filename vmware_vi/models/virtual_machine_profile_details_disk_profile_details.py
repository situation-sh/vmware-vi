...
class VirtualMachineProfileDetailsDiskProfileDetails(DataObject):
    """
    Details of the policies associated with Virtual Disks.  ***Since:*** vSphere API 6.7 
    """ # noqa: E501
    disk_id: StrictInt = Field(description="Virtual disk ID.  ***Since:*** vSphere API 6.7 ", alias="diskId")
    profile: Optional[List[VirtualMachineProfileSpec]] = Field(default=None, description="Storage profile associated with the Virtual Disk.  ***Since:*** vSphere API 6.7 ")
