...
class ClusterComputeResourceHostVmkNicInfo(DataObject):
    """
    This data object describes how a vmknic on a host must be configured.  ***Since:*** vSphere API 6.7.1 
    """ # noqa: E501
    nic_spec: HostVirtualNicSpec = Field(alias="nicSpec")
    service: StrictStr = Field(description="Service type for this adapter.  See *HostVirtualNicManagerNicType_enum* for supported values.  ***Since:*** vSphere API 6.7.1 ")
