...
class DatacenterRenamedEvent(DatacenterEvent):
    ...
    """ # noqa: E501
    old_name: StrictStr = Field(description="The old datacenter name.  ***Since:*** VI API 2.5 ", alias="oldName")
    new_name: StrictStr = Field(description="The new datacenter name.  ***Since:*** VI API 2.5 ", alias="newName")
