...
class InstallSmartCardTrustAnchorRequestType(BaseModel):
    """
    The parameters of *HostActiveDirectoryAuthentication.InstallSmartCardTrustAnchor*. 
    """ # noqa: E501
    cert: StrictStr = Field(description="SSL certificate in PEM format ")
    __properties: ClassVar[List[str]] = ["cert"]
