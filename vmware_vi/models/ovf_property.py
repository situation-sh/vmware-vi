...
class OvfProperty(OvfInvalidPackage):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of the property  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfProperty failed to lookup discriminator value from " +
...
OvfProperty.model_rebuild(raise_errors=False)
