...
class VMwareDVSHealthCheckConfig(DVSHealthCheckConfig):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VMwareDVSHealthCheckConfig failed to lookup discriminator value from " +
...
VMwareDVSHealthCheckConfig.model_rebuild(raise_errors=False)
