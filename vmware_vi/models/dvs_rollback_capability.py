...
class DVSRollbackCapability(DataObject):
    """
    ...
    """ # noqa: E501
    rollback_supported: StrictBool = Field(description="Indicates whether rollback is supported on the distributed switch.  ***Since:*** vSphere API 5.1 ", alias="rollbackSupported")
