...
class DvsRenamedEvent(DvsEvent):
    ...
    """ # noqa: E501
    old_name: StrictStr = Field(description="The old DistributedVirtualSwitch name.  ***Since:*** vSphere API 4.0 ", alias="oldName")
    new_name: StrictStr = Field(description="The new DistributedVirtualSwitch name.  ***Since:*** vSphere API 4.0 ", alias="newName")
