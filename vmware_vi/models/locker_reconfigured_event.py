...
class LockerReconfiguredEvent(Event):
    ...
    """ # noqa: E501
    old_datastore: Optional[DatastoreEventArgument] = Field(default=None, alias="oldDatastore")
    new_datastore: Optional[DatastoreEventArgument] = Field(default=None, alias="newDatastore")
