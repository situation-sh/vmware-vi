...
class ExtensionResourceInfo(DataObject):
    """
    This data object encapsulates the message resources for all locales.  ***Since:*** VI API 2.5 
    """ # noqa: E501
    locale: StrictStr
    module: StrictStr = Field(description="Module for a resource type and other message or fault resources.  Examples: \"task\" for task, \"event\" for event and \"auth\" for \"privilege\".  ***Since:*** VI API 2.5 ")
    data: List[KeyValue]
