    ...
    *HostProfileConfigSpec* is the base data object for all *HostProfile* configuration specifications.  ***Since:*** vSphere API 4.0 
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostProfileConfigSpec failed to lookup discriminator value from " +
...
HostProfileConfigSpec.model_rebuild(raise_errors=False)
