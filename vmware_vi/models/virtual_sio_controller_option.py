...
class VirtualSIOControllerOption(VirtualControllerOption):
    ...
    """ # noqa: E501
    num_floppy_drives: IntOption = Field(alias="numFloppyDrives")
    num_serial_ports: IntOption = Field(alias="numSerialPorts")
    num_parallel_ports: IntOption = Field(alias="numParallelPorts")
