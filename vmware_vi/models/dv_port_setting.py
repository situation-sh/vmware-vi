...
class DVPortSetting(DataObject):
    """
    ...
    vm_direct_path_gen2_allowed: Optional[BoolPolicy] = Field(default=None, alias="vmDirectPathGen2Allowed")
    in_shaping_policy: Optional[DVSTrafficShapingPolicy] = Field(default=None, alias="inShapingPolicy")
    out_shaping_policy: Optional[DVSTrafficShapingPolicy] = Field(default=None, alias="outShapingPolicy")
    vendor_specific_config: Optional[DVSVendorSpecificConfig] = Field(default=None, alias="vendorSpecificConfig")
    network_resource_pool_key: Optional[StringPolicy] = Field(default=None, alias="networkResourcePoolKey")
    filter_policy: Optional[DvsFilterPolicy] = Field(default=None, alias="filterPolicy")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DVPortSetting failed to lookup discriminator value from " +
...
DVPortSetting.model_rebuild(raise_errors=False)
