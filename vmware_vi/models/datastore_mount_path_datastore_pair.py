...
class DatastoreMountPathDatastorePair(DataObject):
    """
    Contains a mapping of an old mount path and its corresponding resignatured or remounted datastore  ***Since:*** vSphere API 4.1 
    """ # noqa: E501
    old_mount_path: StrictStr = Field(description="Old file path where file system volume is mounted, which should be *path* value in *HostMountInfo*  ***Since:*** vSphere API 4.1 ", alias="oldMountPath")
