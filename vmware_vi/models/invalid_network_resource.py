...
class InvalidNetworkResource(NasConfigFault):
    ...
    """ # noqa: E501
    remote_host: StrictStr = Field(description="The host that runs the CIFS or NFS server.  ***Since:*** vSphere API 4.0 ", alias="remoteHost")
    remote_path: StrictStr = Field(description="The remote share.  ***Since:*** vSphere API 4.0 ", alias="remotePath")
