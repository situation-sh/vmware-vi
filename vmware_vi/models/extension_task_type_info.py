...
class ExtensionTaskTypeInfo(DataObject):
    """
    This data object type describes task types defined by the extension.  ***Since:*** VI API 2.5 
    """ # noqa: E501
    task_id: StrictStr = Field(description="The ID of the task type.  Should follow java package naming conventions for uniqueness.  ***Since:*** VI API 2.5 ", alias="taskID")
