...
class RDMNotSupportedOnDatastore(VmConfigFault):
    ...
    """ # noqa: E501
    device: StrictStr = Field(description="The label of the RDM device that would have its backing placed on the datastore.  This is not guaranteed to be the only such device.  ***Since:*** VI API 2.5 ")
    datastore: ManagedObjectReference
    datastore_name: StrictStr = Field(description="The name of the datastore.  ***Since:*** VI API 2.5 ", alias="datastoreName")
