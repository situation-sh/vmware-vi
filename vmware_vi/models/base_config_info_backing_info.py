...
class BaseConfigInfoBackingInfo(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("BaseConfigInfoBackingInfo failed to lookup discriminator value from " +
...
BaseConfigInfoBackingInfo.model_rebuild(raise_errors=False)
