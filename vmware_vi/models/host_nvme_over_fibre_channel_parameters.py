...
class HostNvmeOverFibreChannelParameters(HostNvmeTransportParameters):
    """
    ...
    """ # noqa: E501
    node_world_wide_name: StrictInt = Field(description="The world wide node name for the connection target.  ***Since:*** vSphere API 7.0 ", alias="nodeWorldWideName")
    port_world_wide_name: StrictInt = Field(description="The world wide port name for the connection target.  ***Since:*** vSphere API 7.0 ", alias="portWorldWideName")
