...
class MakeDirectoryInGuestRequestType(BaseModel):
    """
    The parameters of *GuestFileManager.MakeDirectoryInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    directory_path: StrictStr = Field(description="The complete path to the directory to be created. ", alias="directoryPath")
    create_parent_directories: StrictBool = Field(description="Whether any parent directories are to be created. ", alias="createParentDirectories")
    __properties: ClassVar[List[str]] = ["vm", "auth", "directoryPath", "createParentDirectories"]
