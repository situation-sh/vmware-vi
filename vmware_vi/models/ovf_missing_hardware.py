...
class OvfMissingHardware(OvfImport):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the missing hardware.  ***Since:*** vSphere API 4.0 ")
    resource_type: StrictInt = Field(description="OVF rasd resource type of the missing hardware.  ***Since:*** vSphere API 4.0 ", alias="resourceType")
