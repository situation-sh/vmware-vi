...
class VmInstanceUuidConflictEvent(VmEvent):
    ...
    """ # noqa: E501
    conflicted_vm: VmEventArgument = Field(alias="conflictedVm")
    instance_uuid: StrictStr = Field(description="The instance UUID in conflict.  ***Since:*** vSphere API 4.0 ", alias="instanceUuid")
