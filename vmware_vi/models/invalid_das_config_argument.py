...
class InvalidDasConfigArgument(InvalidArgument):
    ...
    """ # noqa: E501
    entry: Optional[StrictStr] = Field(default=None, description="The entry for the invalid argument  ***Since:*** vSphere API 5.1 ")
    cluster_name: Optional[StrictStr] = Field(default=None, description="Name of the cluster to be configured  ***Since:*** vSphere API 5.1 ", alias="clusterName")
