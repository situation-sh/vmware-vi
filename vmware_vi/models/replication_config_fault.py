...
class ReplicationConfigFault(ReplicationFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ReplicationConfigFault failed to lookup discriminator value from " +
...
ReplicationConfigFault.model_rebuild(raise_errors=False)
