...
class InsufficientHostCpuCapacityFault(InsufficientHostCapacityFault):
    ...
    """ # noqa: E501
    unreserved: StrictInt = Field(description="The CPU available on the host in MHz.  ***Since:*** vSphere API 4.0 ")
    requested: StrictInt = Field(description="The CPU resource amount requested in the failed operation in MHz.  ***Since:*** vSphere API 4.0 ")
