...
class UserSearchResult(DataObject):
    """
    ...
    """ # noqa: E501
    principal: StrictStr = Field(description="Login name of a user or the name of a group.  This key is the user within the searched domain. ")
    full_name: Optional[StrictStr] = Field(default=None, description="Full name of the user found by the search, or the description of a group, if available. ", alias="fullName")
    group: StrictBool = Field(description="If this is true, then the result is a group.  If this is false, then the result is a user. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("UserSearchResult failed to lookup discriminator value from " +
...
UserSearchResult.model_rebuild(raise_errors=False)
