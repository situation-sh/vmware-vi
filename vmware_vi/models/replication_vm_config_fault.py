...
class ReplicationVmConfigFault(ReplicationConfigFault):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the failure.  One of the above *ReplicationVmConfigFaultReasonForFault_enum*.  ***Since:*** vSphere API 5.0 ")
