...
class RemoveDiskRequestType(BaseModel):
    """
    The parameters of *HostVsanSystem.RemoveDisk_Task*. 
    """ # noqa: E501
    disk: List[HostScsiDisk] = Field(description="list of disks to be removed from use by the VSAN service. ")
    ...
    __properties: ClassVar[List[str]] = ["disk", "maintenanceSpec", "timeout"]
