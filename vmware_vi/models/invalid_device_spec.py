...
class InvalidDeviceSpec(InvalidVmConfig):
    ...
    """ # noqa: E501
    device_index: StrictInt = Field(description="Index of the device in the configuration specification that has the invalid value. ", alias="deviceIndex")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidDeviceSpec failed to lookup discriminator value from " +
...
InvalidDeviceSpec.model_rebuild(raise_errors=False)
