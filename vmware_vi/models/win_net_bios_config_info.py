...
class WinNetBIOSConfigInfo(NetBIOSConfigInfo):
    ...
    """ # noqa: E501
    primary_wins: StrictStr = Field(description="The IP address of the primary WINS server.  ***Since:*** vSphere API 4.1 ", alias="primaryWINS")
    secondary_wins: Optional[StrictStr] = Field(default=None, description="The IP address of the secondary WINS server.  ***Since:*** vSphere API 4.1 ", alias="secondaryWINS")
