...
class HostForceMountedInfo(DataObject):
    """
    ...
    """ # noqa: E501
    persist: StrictBool = Field(description="Indicates if the vmfsExtent information persistent across host reboots.  ***Since:*** vSphere API 4.0 ")
    mounted: StrictBool = Field(description="Indicates if the volume is currently mounted on the host  ***Since:*** vSphere API 4.0 ")
