...
class NumVirtualCpusExceedsLimit(InsufficientResourcesFault):
    ...
    """ # noqa: E501
    max_supported_vcpus: StrictInt = Field(description="The maximum number of virtual CPUs supported on the host.  ***Since:*** vSphere API 4.1 ", alias="maxSupportedVcpus")
