...
class HostVFlashManagerVFlashResourceConfigSpec(DataObject):
    """
    vFlash resource configuration specification.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    vffs_uuid: StrictStr = Field(description="The contained VFFS volume uuid.  ***Since:*** vSphere API 5.5 ", alias="vffsUuid")
