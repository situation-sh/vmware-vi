...
class OutOfBounds(VimFault):
    ...
    """ # noqa: E501
    argument_name: StrictStr = Field(description="This should be the name of the field that holds the allowed maximum (for example, Host.capability.maxSupportedVMs). ", alias="argumentName")
