...
class VirtualMachineVFlashModuleInfo(VirtualMachineTargetInfo):
    """
    VFlashModuleInfo class contains information about a vFlash module on the host.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    v_flash_module: HostVFlashManagerVFlashCacheConfigInfoVFlashModuleConfigOption = Field(alias="vFlashModule")
