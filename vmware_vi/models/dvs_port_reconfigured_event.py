...
class DvsPortReconfiguredEvent(DvsEvent):
    ...
    """ # noqa: E501
    port_key: List[StrictStr] = Field(description="The key of the ports that are reconfigured.  ***Since:*** vSphere API 4.0 ", alias="portKey")
    config_changes: Optional[List[ChangesInfoEventArgument]] = Field(default=None, description="The configuration values changed during the reconfiguration.  ***Since:*** vSphere API 6.5 ", alias="configChanges")
