...
class VsanHostClusterStatusState(DataObject):
    """
    Data object representing the VSAN node state for a host.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    state: StrictStr = Field(description="VSAN node state for this host.  See also *VsanHostNodeState_enum*.  ***Since:*** vSphere API 5.5 ")
    completion: Optional[VsanHostClusterStatusStateCompletionEstimate] = None
