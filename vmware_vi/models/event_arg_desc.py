...
class EventArgDesc(DataObject):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the argument  ***Since:*** vSphere API 4.0 ")
    type: StrictStr = Field(description="The type of the argument.  ***Since:*** vSphere API 4.0 ")
