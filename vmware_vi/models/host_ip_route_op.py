...
class HostIpRouteOp(DataObject):
    """
    ...
    """ # noqa: E501
    change_operation: StrictStr = Field(description="This property indicates the change operation to apply on this configuration specification.  See also *HostConfigChangeOperation_enum*.  ***Since:*** vSphere API 4.0 ", alias="changeOperation")
