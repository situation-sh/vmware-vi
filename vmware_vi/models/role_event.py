...
class RoleEvent(AuthorizationEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("RoleEvent failed to lookup discriminator value from " +
...
RoleEvent.model_rebuild(raise_errors=False)
