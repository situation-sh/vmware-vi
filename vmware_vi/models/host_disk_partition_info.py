...
class HostDiskPartitionInfo(DataObject):
    """
    ...
    """ # noqa: E501
    device_name: StrictStr = Field(description="The device name of the disk to which this partition information corresponds. ", alias="deviceName")
