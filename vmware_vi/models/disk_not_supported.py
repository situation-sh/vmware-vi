...
class DiskNotSupported(VirtualHardwareCompatibilityIssue):
    ...
    """ # noqa: E501
    disk: StrictInt = Field(description="The ID of disk that is not supported. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DiskNotSupported failed to lookup discriminator value from " +
...
DiskNotSupported.model_rebuild(raise_errors=False)
