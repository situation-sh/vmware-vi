...
class HostPlacedVirtualNicIdentifier(DataObject):
    """
    ...
    reservation: Optional[StrictInt] = Field(default=None, description="The virtual NIC reservation  ***Since:*** vSphere API 6.0 ")
