...
class EvaluationLicenseSource(LicenseSource):
    ...
    """ # noqa: E501
    remaining_hours: Optional[StrictInt] = Field(default=None, description="The number of remaining hours before product evaluation expires  ***Since:*** VI API 2.5 ", alias="remainingHours")
