...
class UserInputRequiredParameterMetadata(ProfilePolicyOptionMetadata):
    ...
    """ # noqa: E501
    user_input_parameter: Optional[List[ProfileParameterMetadata]] = Field(default=None, description="Metadata for user input options.  ***Since:*** vSphere API 4.0 ", alias="userInputParameter")
