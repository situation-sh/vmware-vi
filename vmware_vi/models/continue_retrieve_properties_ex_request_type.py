...
class ContinueRetrievePropertiesExRequestType(BaseModel):
    """
    The parameters of *PropertyCollector.ContinueRetrievePropertiesEx*. 
    """ # noqa: E501
    token: StrictStr = Field(description="the token returned in the previous *RetrieveResult* returned on the same session by the same *PropertyCollector*. ")
