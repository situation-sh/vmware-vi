...
class QueryConfigOptionRequestType(BaseModel):
    """
    The parameters of *EnvironmentBrowser.QueryConfigOption*. 
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key found in the VirtualMachineConfigOptionDescriptor, obtained by invoking the *EnvironmentBrowser.QueryConfigOptionDescriptor* operation. ")
    host: Optional[ManagedObjectReference] = None
    __properties: ClassVar[List[str]] = ["key", "host"]
