...
class InsufficientHostCapacityFault(InsufficientResourcesFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InsufficientHostCapacityFault failed to lookup discriminator value from " +
...
InsufficientHostCapacityFault.model_rebuild(raise_errors=False)
