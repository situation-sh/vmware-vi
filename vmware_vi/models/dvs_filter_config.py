...
class DvsFilterConfig(InheritablePolicy):
    """
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key of Network Filter Config.  ***Since:*** vSphere API 5.5 ")
    agent_name: Optional[StrictStr] = Field(default=None, description="The name of the network traffic filter agent.  ***Since:*** vSphere API 5.5 ", alias="agentName")
    slot_number: Optional[StrictStr] = Field(default=None, description="The slot number of the network filter agent.  ***Since:*** vSphere API 5.5 ", alias="slotNumber")
    parameters: Optional[DvsFilterParameter] = None
    on_failure: Optional[StrictStr] = Field(default=None, description="This property specifies whether to allow all traffic or to deny all traffic when a Network Filter fails to configure.  Please see *DvsFilterOnFailure_enum* for more details.  ***Since:*** vSphere API 5.5 ", alias="onFailure")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsFilterConfig failed to lookup discriminator value from " +
...
DvsFilterConfig.model_rebuild(raise_errors=False)
