...
class EVCUnsupportedByHostSoftware(EVCConfigFault):
    ...
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="The set of hosts which are blocking EVC because their virtualization software does not support CPUID override.  ***Since:*** vSphere API 4.1  Refers instances of *HostSystem*. ")
    host_name: List[StrictStr] = Field(description="The names of the hosts in the host array.  ***Since:*** vSphere API 4.1 ", alias="hostName")
