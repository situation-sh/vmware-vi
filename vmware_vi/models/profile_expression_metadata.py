...
class ProfileExpressionMetadata(DataObject):
    """
    DataObject to represent the metadata associated with a SimpleExpression.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    expression_id: ExtendedElementDescription = Field(alias="expressionId")
    parameter: Optional[List[ProfileParameterMetadata]] = Field(default=None, description="Parameters that can be specified for this SimpleExpression  ***Since:*** vSphere API 4.0 ")
