...
class VirtualMachineRelocateSpecDiskLocatorBackingSpec(DataObject):
    """
    ...
    """ # noqa: E501
    parent: Optional[VirtualMachineRelocateSpecDiskLocatorBackingSpec] = None
...
VirtualMachineRelocateSpecDiskLocatorBackingSpec.model_rebuild(raise_errors=False)
