...
class CustomizationIPSettingsIpV6AddressSpec(DataObject):
    """
    IPv6 settings  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    ip: List[CustomizationIpV6Generator] = Field(description="ipv6 address generators  ***Since:*** vSphere API 4.0 ")
    gateway: Optional[List[StrictStr]] = Field(default=None, description="gateways  ***Since:*** vSphere API 4.0 ")
