...
class VmMessageEvent(VmEvent):
    ...
    """ # noqa: E501
    message: StrictStr = Field(description="A raw message returned by the virtualization platform. ")
    message_info: Optional[List[VirtualMachineMessage]] = Field(default=None, description="A set of localizable message data that comprise this event.  Only available on servers that support localization.  ***Since:*** VI API 2.5 ", alias="messageInfo")
