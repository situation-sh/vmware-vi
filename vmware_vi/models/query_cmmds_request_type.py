...
class QueryCmmdsRequestType(BaseModel):
    """
    The parameters of *HostVsanInternalSystem.QueryCmmds*. 
    """ # noqa: E501
    queries: List[HostVsanInternalSystemCmmdsQuery] = Field(description="List of CMMDS query specs.  ***Since:*** vSphere API 5.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "queries": [HostVsanInternalSystemCmmdsQuery.from_dict(_item) for _item in obj.get("queries")] if obj.get("queries") is not None else None
        })
        return _obj
