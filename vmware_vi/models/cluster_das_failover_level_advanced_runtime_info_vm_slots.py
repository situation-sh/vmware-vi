...
class ClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots(DataObject):
    """
    ClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots
    """ # noqa: E501
    vm: ManagedObjectReference
    slots: StrictInt = Field(description="The number of slots required by this virtual machine  ***Since:*** vSphere API 5.1 ")
