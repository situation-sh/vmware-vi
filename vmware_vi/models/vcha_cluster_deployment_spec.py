...
class VchaClusterDeploymentSpec(DataObject):
    """
    ...
    active_vc_spec: SourceNodeSpec = Field(alias="activeVcSpec")
    active_vc_network_config: Optional[ClusterNetworkConfigSpec] = Field(default=None, alias="activeVcNetworkConfig")
