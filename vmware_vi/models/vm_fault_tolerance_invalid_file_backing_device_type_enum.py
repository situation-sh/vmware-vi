...
class VmFaultToleranceInvalidFileBackingDeviceTypeEnum(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VmFaultToleranceInvalidFileBackingDeviceTypeEnum from a JSON string"""
