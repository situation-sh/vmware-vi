...
class BaseConfigInfoDiskFileBackingInfo(BaseConfigInfoFileBackingInfo):
    """
    ...
    """ # noqa: E501
    provisioning_type: StrictStr = Field(description="Provisioning type.  See *BaseConfigInfoDiskFileBackingInfoProvisioningType_enum* for the supported types.  ***Since:*** vSphere API 6.5 ", alias="provisioningType")
