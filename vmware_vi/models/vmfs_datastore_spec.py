...
class VmfsDatastoreSpec(DataObject):
    """
    ...
    """ # noqa: E501
    disk_uuid: StrictStr = Field(description="The UUID of the SCSI disk on which the VMFS datastore is located.  See also *HostScsiDisk*, *ScsiLun.uuid*. ", alias="diskUuid")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmfsDatastoreSpec failed to lookup discriminator value from " +
...
VmfsDatastoreSpec.model_rebuild(raise_errors=False)
