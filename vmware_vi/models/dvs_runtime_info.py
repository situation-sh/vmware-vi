...
class DVSRuntimeInfo(DataObject):
    """
    The *DVSRuntimeInfo* data object defines runtime information for a vSphere Distributed Switch.  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    host_member_runtime: Optional[List[HostMemberRuntimeInfo]] = Field(default=None, description="Runtime information of the hosts that joined the switch.  ***Since:*** vSphere API 5.1 ", alias="hostMemberRuntime")
    resource_runtime_info: Optional[DvsResourceRuntimeInfo] = Field(default=None, alias="resourceRuntimeInfo")
