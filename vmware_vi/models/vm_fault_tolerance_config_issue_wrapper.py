...
class VmFaultToleranceConfigIssueWrapper(VmFaultToleranceIssue):
    ...
    """ # noqa: E501
    entity_name: Optional[StrictStr] = Field(default=None, description="The entity name.  Depending on the issue, it could be virtual machine or host.  ***Since:*** vSphere API 4.1 ", alias="entityName")
