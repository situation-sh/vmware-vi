...
class ClusterOvercommittedEvent(ClusterEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterOvercommittedEvent failed to lookup discriminator value from " +
...
ClusterOvercommittedEvent.model_rebuild(raise_errors=False)
