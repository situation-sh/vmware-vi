...
class VirtualHardwareCompatibilityIssue(VmConfigFault):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','CpuCompatibilityUnknown': 'CpuCompatibilityUnknown','CpuIncompatible': 'CpuIncompatible','CpuIncompatible1ECX': 'CpuIncompatible1ECX','CpuIncompatible81EDX': 'CpuIncompatible81EDX','DVPortNotSupported': 'DVPortNotSupported','DeviceBackingNotSupported': 'DeviceBackingNotSupported','DeviceControllerNotSupported': 'DeviceControllerNotSupported','DeviceNotSupported': 'DeviceNotSupported','DigestNotSupported': 'DigestNotSupported','DiskNotSupported': 'DiskNotSupported','DrsVmotionIncompatibleFault': 'DrsVmotionIncompatibleFault','FaultToleranceCpuIncompatible': 'FaultToleranceCpuIncompatible','FeatureRequirementsNotMet': 'FeatureRequirementsNotMet','FileBackedPortNotSupported': 'FileBackedPortNotSupported','IDEDiskNotSupported': 'IDEDiskNotSupported','MemorySizeNotRecommended': 'MemorySizeNotRecommended','MemorySizeNotSupported': 'MemorySizeNotSupported','MemorySizeNotSupportedByDatastore': 'MemorySizeNotSupportedByDatastore','MultiWriterNotSupported': 'MultiWriterNotSupported','NonPersistentDisksNotSupported': 'NonPersistentDisksNotSupported','NotEnoughCpus': 'NotEnoughCpus','NotEnoughLogicalCpus': 'NotEnoughLogicalCpus','NumVirtualCoresPerSocketNotSupported': 'NumVirtualCoresPerSocketNotSupported','NumVirtualCpusNotSupported': 'NumVirtualCpusNotSupported','PhysCompatRDMNotSupported': 'PhysCompatRDMNotSupported','RDMNotSupported': 'RDMNotSupported','RawDiskNotSupported': 'RawDiskNotSupported','RemoteDeviceNotSupported': 'RemoteDeviceNotSupported','SharedBusControllerNotSupported': 'SharedBusControllerNotSupported','StorageVmotionIncompatible': 'StorageVmotionIncompatible','UnusedVirtualDiskBlocksNotScrubbed': 'UnusedVirtualDiskBlocksNotScrubbed','VMINotSupported': 'VMINotSupported','VirtualDiskBlocksNotFullyProvisioned': 'VirtualDiskBlocksNotFullyProvisioned','VirtualDiskModeNotSupported': 'VirtualDiskModeNotSupported','VirtualEthernetCardNotSupported': 'VirtualEthernetCardNotSupported','VirtualHardwareVersionNotSupported': 'VirtualHardwareVersionNotSupported','WakeOnLanNotSupported': 'WakeOnLanNotSupported'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualHardwareCompatibilityIssue failed to lookup discriminator value from " +
...
VirtualHardwareCompatibilityIssue.model_rebuild(raise_errors=False)
