...
class GuestRegistryValueFault(GuestRegistryFault):
    ...
    """ # noqa: E501
    key_name: StrictStr = Field(description="The full path to the windows registry key containing the value.  ***Since:*** vSphere API 6.0 ", alias="keyName")
    value_name: StrictStr = Field(description="The name of the value.  ***Since:*** vSphere API 6.0 ", alias="valueName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestRegistryValueFault failed to lookup discriminator value from " +
...
GuestRegistryValueFault.model_rebuild(raise_errors=False)
