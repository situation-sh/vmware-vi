...
class VmwareDistributedVirtualSwitchTrunkVlanSpec(VmwareDistributedVirtualSwitchVlanSpec):
    ...
    """ # noqa: E501
    vlan_id: Optional[List[NumericRange]] = Field(default=None, description="The VlanId range for the trunk port.  The valid VlanId range is from 0 to 4094. Overlapping ranges are allowed.  ***Since:*** vSphere API 4.0 ", alias="vlanId")
