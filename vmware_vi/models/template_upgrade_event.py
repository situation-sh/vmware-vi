...
class TemplateUpgradeEvent(Event):
    ...
    """ # noqa: E501
    legacy_template: StrictStr = Field(alias="legacyTemplate")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("TemplateUpgradeEvent failed to lookup discriminator value from " +
...
TemplateUpgradeEvent.model_rebuild(raise_errors=False)
