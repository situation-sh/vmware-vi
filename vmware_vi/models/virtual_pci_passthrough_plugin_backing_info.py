...
class VirtualPCIPassthroughPluginBackingInfo(VirtualDeviceBackingInfo):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualPCIPassthroughPluginBackingInfo failed to lookup discriminator value from " +
...
VirtualPCIPassthroughPluginBackingInfo.model_rebuild(raise_errors=False)
