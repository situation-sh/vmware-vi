...
class HostIpRouteConfigSpec(HostIpRouteConfig):
    ...
    """ # noqa: E501
    gateway_device_connection: Optional[HostVirtualNicConnection] = Field(default=None, alias="gatewayDeviceConnection")
    ip_v6_gateway_device_connection: Optional[HostVirtualNicConnection] = Field(default=None, alias="ipV6GatewayDeviceConnection")
