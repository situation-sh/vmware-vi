...
class OvfAttribute(OvfInvalidPackage):
    ...
    """ # noqa: E501
    element_name: StrictStr = Field(description="Element name where the attribute is defined  ***Since:*** vSphere API 4.0 ", alias="elementName")
    attribute_name: StrictStr = Field(description="Attribute name  ***Since:*** vSphere API 4.0 ", alias="attributeName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfAttribute failed to lookup discriminator value from " +
...
OvfAttribute.model_rebuild(raise_errors=False)
