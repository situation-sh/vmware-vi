...
class ClusterEvent(Event):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','ClusterComplianceCheckedEvent': 'ClusterComplianceCheckedEvent','ClusterCreatedEvent': 'ClusterCreatedEvent','ClusterDestroyedEvent': 'ClusterDestroyedEvent','ClusterOvercommittedEvent': 'ClusterOvercommittedEvent','ClusterReconfiguredEvent': 'ClusterReconfiguredEvent','ClusterStatusChangedEvent': 'ClusterStatusChangedEvent','DasAdmissionControlDisabledEvent': 'DasAdmissionControlDisabledEvent','DasAdmissionControlEnabledEvent': 'DasAdmissionControlEnabledEvent','DasAgentFoundEvent': 'DasAgentFoundEvent','DasAgentUnavailableEvent': 'DasAgentUnavailableEvent','DasClusterIsolatedEvent': 'DasClusterIsolatedEvent','DasDisabledEvent': 'DasDisabledEvent','DasEnabledEvent': 'DasEnabledEvent','DasHostFailedEvent': 'DasHostFailedEvent','DasHostIsolatedEvent': 'DasHostIsolatedEvent','DrsDisabledEvent': 'DrsDisabledEvent','DrsEnabledEvent': 'DrsEnabledEvent','DrsInvocationFailedEvent': 'DrsInvocationFailedEvent','DrsRecoveredFromFailureEvent': 'DrsRecoveredFromFailureEvent','FailoverLevelRestored': 'FailoverLevelRestored','HostMonitoringStateChangedEvent': 'HostMonitoringStateChangedEvent','HostOvercommittedEvent': 'HostOvercommittedEvent','HostStatusChangedEvent': 'HostStatusChangedEvent','InsufficientFailoverResourcesEvent': 'InsufficientFailoverResourcesEvent','VmHealthMonitoringStateChangedEvent': 'VmHealthMonitoringStateChangedEvent'
    }
...
ClusterEvent.model_rebuild(raise_errors=False)
