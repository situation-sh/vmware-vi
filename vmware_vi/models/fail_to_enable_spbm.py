...
class FailToEnableSPBM(NotEnoughLicenses):
    ...
    cs_name: StrictStr = Field(description="The computer resource name  ***Since:*** vSphere API 5.0 ", alias="csName")
    host_license_states: List[ComputeResourceHostSPBMLicenseInfo] = Field(description="Array of *ComputeResourceHostSPBMLicenseInfo* that contains SPBM license information for all hosts in the compute resource  ***Since:*** vSphere API 5.0 ", alias="hostLicenseStates")
