...
class CustomFieldValue(DataObject):
    """
    Base type for storing values. 
    """ # noqa: E501
    key: StrictInt = Field(description="The ID of the field to which this value belongs. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomFieldValue failed to lookup discriminator value from " +
