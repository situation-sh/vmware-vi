...
class DetachTagFromVStorageObjectRequestType(BaseModel):
    """
    The parameters of *VcenterVStorageObjectManager.DetachTagFromVStorageObject*. 
    """ # noqa: E501
    id: ID
    category: StrictStr = Field(description="The category to which the tag belongs. ")
    tag: StrictStr = Field(description="The tag which has to be disassociated with the virtual storage object. ")
    __properties: ClassVar[List[str]] = ["id", "category", "tag"]
