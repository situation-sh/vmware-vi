...
class IpRouteProfile(ApplyProfile):
    ...
    """ # noqa: E501
    static_route: Optional[List[StaticRouteProfile]] = Field(default=None, description="List of static routes to be configured.  ***Since:*** vSphere API 4.0 ", alias="staticRoute")
