...
class ArrayOfClusterComputeResourceDVSSettingDVPortgroupToServiceMapping(Any):
    """
    A boxed array of *ClusterComputeResourceDVSSettingDVPortgroupToServiceMapping*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[ClusterComputeResourceDVSSettingDVPortgroupToServiceMapping] = Field(alias="_value")
