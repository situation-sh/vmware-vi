...
class CreateDiskFromSnapshotRequestType(BaseModel):
    """
    ...
    path: Optional[StrictStr] = Field(default=None, description="Relative location in the specified datastore where disk needs to be created. If not specified disk gets created at the defualt VStorageObject location on the specified datastore. ")
    __properties: ClassVar[List[str]] = ["id", "datastore", "snapshotId", "name", "profile", "crypto", "path"]
