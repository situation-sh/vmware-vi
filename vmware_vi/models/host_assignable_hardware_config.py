...
class HostAssignableHardwareConfig(DataObject):
    """
    ...
    """ # noqa: E501
    attribute_override: Optional[List[HostAssignableHardwareConfigAttributeOverride]] = Field(default=None, description="List of attribute overrides.  ***Since:*** vSphere API 7.0 ", alias="attributeOverride")
