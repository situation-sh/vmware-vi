...
class UpdateLockdownExceptionsRequestType(BaseModel):
    """
    The parameters of *HostAccessManager.UpdateLockdownExceptions*. 
    """ # noqa: E501
    users: Optional[List[StrictStr]] = Field(default=None, description="the new list of lockdown mode exceptions. ")
