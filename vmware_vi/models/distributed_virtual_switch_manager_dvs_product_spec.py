...
class DistributedVirtualSwitchManagerDvsProductSpec(DataObject):
    """
    ...
    """ # noqa: E501
    new_switch_product_spec: Optional[DistributedVirtualSwitchProductSpec] = Field(default=None, alias="newSwitchProductSpec")
