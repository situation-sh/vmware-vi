...
class VirtualMachineSriovNetworkDevicePoolInfo(VirtualMachineSriovDevicePoolInfo):
    """
    ...
    switch_uuid: Optional[StrictStr] = Field(default=None, description="DVSwitch Uuid  ***Since:*** vSphere API 6.5 ", alias="switchUuid")
