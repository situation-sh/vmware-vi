...
class ComplianceLocator(DataObject):
    """
    ...
    """ # noqa: E501
    expression_name: StrictStr = Field(description="Exression for which the Locator corresponds to  ***Since:*** vSphere API 4.0 ", alias="expressionName")
    apply_path: ProfilePropertyPath = Field(alias="applyPath")
