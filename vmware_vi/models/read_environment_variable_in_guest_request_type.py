...
class ReadEnvironmentVariableInGuestRequestType(BaseModel):
    """
    The parameters of *GuestProcessManager.ReadEnvironmentVariableInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    names: Optional[List[StrictStr]] = Field(default=None, description="The names of the variables to be read. If not set, then all the environment variables are returned. ")
    __properties: ClassVar[List[str]] = ["vm", "auth", "names"]
