...
class VirtualMachineWipeResult(DataObject):
    """
    ...
    """ # noqa: E501
    disk_id: StrictInt = Field(description="The disk id for the disk that was wiped.  ***Since:*** vSphere API 5.1 ", alias="diskId")
    shrinkable_disk_space: StrictInt = Field(description="The amount of shrinkable disk space in kB.  ***Since:*** vSphere API 5.1 ", alias="shrinkableDiskSpace")
