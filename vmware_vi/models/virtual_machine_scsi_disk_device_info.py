...
class VirtualMachineScsiDiskDeviceInfo(VirtualMachineDiskDeviceInfo):
    ...
    """ # noqa: E501
    disk: Optional[HostScsiDisk] = None
    transport_hint: Optional[StrictStr] = Field(default=None, description="Transport identifier hint used to identify the device.  To definitively correlate this device with a host physical disk, use the disk property. This identifier is intended as a hint to end users to identify the disk device.  ***Since:*** vSphere API 4.0 ", alias="transportHint")
    lun_number: Optional[StrictInt] = Field(default=None, description="LUN number hint used to identify the SCSI device.  To definitively correlate this device with a host physical disk, use the disk property. This identifier is intended as a hint to end users to identify the disk device.  ***Since:*** vSphere API 4.0 ", alias="lunNumber")
