...
class VirtualPCIPassthroughPluginBackingOption(VirtualDeviceBackingOption):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualPCIPassthroughPluginBackingOption failed to lookup discriminator value from " +
...
VirtualPCIPassthroughPluginBackingOption.model_rebuild(raise_errors=False)
