...
class SetDisplayTopologyRequestType(BaseModel):
    """
    The parameters of *VirtualMachine.SetDisplayTopology*. 
    """ # noqa: E501
    displays: List[VirtualMachineDisplayTopology] = Field(description="The topology for each monitor that the virtual machine's display must span.  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "displays": [VirtualMachineDisplayTopology.from_dict(_item) for _item in obj.get("displays")] if obj.get("displays") is not None else None
        })
        return _obj
