...
class HostTpmEventDetails(DataObject):
    """
    ...
    """ # noqa: E501
    data_hash: List[Annotated[int, Field(le=127, strict=True, ge=-128)]] = Field(description="Value of the Platform Configuration Register (PCR) for this event.  ***Since:*** vSphere API 5.1 ", alias="dataHash")
    data_hash_method: Optional[StrictStr] = Field(default=None, description="Method in which the digest hash is calculated.  The set of possible values is described in *HostDigestInfoDigestMethodType_enum*.  ***Since:*** vSphere API 6.7 ", alias="dataHashMethod")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostTpmEventDetails failed to lookup discriminator value from " +
...
HostTpmEventDetails.model_rebuild(raise_errors=False)
