...
class HostRdmaDeviceBacking(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostRdmaDeviceBacking failed to lookup discriminator value from " +
...
HostRdmaDeviceBacking.model_rebuild(raise_errors=False)
