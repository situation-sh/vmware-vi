...
class VmAutoRenameEvent(VmEvent):
    ...
    """ # noqa: E501
    old_name: StrictStr = Field(description="The name of the virtual machine before renaming. ", alias="oldName")
    new_name: StrictStr = Field(description="The name of the virtual machine after renaming. ", alias="newName")
