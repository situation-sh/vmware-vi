...
class RetrieveVStorageObjectAssociationsRequestType(BaseModel):
    """
    The parameters of *VcenterVStorageObjectManager.RetrieveVStorageObjectAssociations*. 
    """ # noqa: E501
    ids: Optional[List[RetrieveVStorageObjSpec]] = Field(default=None, description="The IDs of the virtual storage objects of the query.  ***Since:*** vSphere API 6.7 ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "ids": [RetrieveVStorageObjSpec.from_dict(_item) for _item in obj.get("ids")] if obj.get("ids") is not None else None
        })
        return _obj
