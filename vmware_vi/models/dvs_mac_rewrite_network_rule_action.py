...
class DvsMacRewriteNetworkRuleAction(DvsNetworkRuleAction):
    """
    This class defines network rule action to MAC Rewrite.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    rewrite_mac: StrictStr = Field(description="Rewrite Destination MAC with this MAC address.  ***Since:*** vSphere API 5.5 ", alias="rewriteMac")
