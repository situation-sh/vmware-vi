...
class NicSettingMismatch(CustomizationFault):
    ...
    """ # noqa: E501
    number_of_nics_in_spec: StrictInt = Field(description="The number of network adapter settings specified in the customization specification.  ***Since:*** VI API 2.5 ", alias="numberOfNicsInSpec")
    number_of_nics_in_vm: StrictInt = Field(description="The number of network adapters present in the virtual machine.  ***Since:*** VI API 2.5 ", alias="numberOfNicsInVM")
