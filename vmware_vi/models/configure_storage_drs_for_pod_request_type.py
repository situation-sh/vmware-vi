...
class ConfigureStorageDrsForPodRequestType(BaseModel):
    """
    ...
    modify: StrictBool = Field(description="Flag to specify whether the specification (\"spec\") should be applied incrementally. If \"modify\" is false and the operation succeeds, then the configuration of the storage pod matches the specification exactly; in this case any unset portions of the specification will result in unset or default portions of the configuration. ")
    __properties: ClassVar[List[str]] = ["pod", "spec", "modify"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "pod": ManagedObjectReference.from_dict(obj.get("pod")) if obj.get("pod") is not None else None,
            "spec": StorageDrsConfigSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None,
