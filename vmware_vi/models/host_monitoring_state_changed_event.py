...
class HostMonitoringStateChangedEvent(ClusterEvent):
    ...
    """ # noqa: E501
    state: StrictStr = Field(description="The service state in *ClusterDasConfigInfoServiceState_enum*  ***Since:*** vSphere API 4.0 ")
    prev_state: Optional[StrictStr] = Field(default=None, description="The previous service state in *ClusterDasConfigInfoServiceState_enum*  ***Since:*** vSphere API 6.5 ", alias="prevState")
