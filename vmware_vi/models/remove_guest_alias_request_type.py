...
class RemoveGuestAliasRequestType(BaseModel):
    """
    ...
    base64_cert: StrictStr = Field(description="The X.509 certificate associated with the alias to be removed, in base64 encoded DER format. ", alias="base64Cert")
    subject: GuestAuthSubject
    __properties: ClassVar[List[str]] = ["vm", "auth", "username", "base64Cert", "subject"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "subject": GuestAuthSubject.from_dict(obj.get("subject")) if obj.get("subject") is not None else None
        })
        return _obj
