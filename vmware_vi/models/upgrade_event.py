...
class UpgradeEvent(Event):
    ...
    """ # noqa: E501
    message: StrictStr = Field(description="The formatted message from the upgrade. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("UpgradeEvent failed to lookup discriminator value from " +
...
UpgradeEvent.model_rebuild(raise_errors=False)
