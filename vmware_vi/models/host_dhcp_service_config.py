...
class HostDhcpServiceConfig(DataObject):
    """
    ...
    """ # noqa: E501
    change_operation: Optional[StrictStr] = Field(default=None, description="Indicates the change operation to apply on this configuration specification.  See also *HostConfigChangeOperation_enum*.  ***Since:*** VI API 2.5 ", alias="changeOperation")
    key: StrictStr = Field(description="The instance ID of the DHCP service.  ***Since:*** VI API 2.5 ")
