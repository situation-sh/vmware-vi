...
class ConfigureLicenseSourceRequestType(BaseModel):
    """
    The parameters of *LicenseManager.ConfigureLicenseSource*. 
    """ # noqa: E501
    host: Optional[ManagedObjectReference] = None
    license_source: LicenseSource = Field(alias="licenseSource")
    __properties: ClassVar[List[str]] = ["host", "licenseSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of license_source
        if self.license_source:
            _dict['licenseSource'] = self.license_source.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "licenseSource": LicenseSource.from_dict(obj.get("licenseSource")) if obj.get("licenseSource") is not None else None
        })
        return _obj
