...
class VmFaultToleranceInvalidFileBacking(VmFaultToleranceIssue):
    ...
    """ # noqa: E501
    backing_type: Optional[StrictStr] = Field(default=None, description="The device type of the file backing  ***Since:*** vSphere API 4.0 ", alias="backingType")
    backing_filename: Optional[StrictStr] = Field(default=None, alias="backingFilename")
