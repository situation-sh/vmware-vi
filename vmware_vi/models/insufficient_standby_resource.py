...
class InsufficientStandbyResource(InsufficientResourcesFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InsufficientStandbyResource failed to lookup discriminator value from " +
...
InsufficientStandbyResource.model_rebuild(raise_errors=False)
