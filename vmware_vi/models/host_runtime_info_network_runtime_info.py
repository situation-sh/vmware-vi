...
class HostRuntimeInfoNetworkRuntimeInfo(DataObject):
    """
    This data type describes network related runtime info  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    net_stack_instance_runtime_info: Optional[List[HostRuntimeInfoNetStackInstanceRuntimeInfo]] = Field(default=None, description="The list of network stack runtime info  ***Since:*** vSphere API 5.5 ", alias="netStackInstanceRuntimeInfo")
    network_resource_runtime: Optional[HostNetworkResourceRuntime] = Field(default=None, alias="networkResourceRuntime")
