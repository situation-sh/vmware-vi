...
class OvfConstraint(OvfInvalidPackage):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the element  ***Since:*** vSphere API 4.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfConstraint failed to lookup discriminator value from " +
...
OvfConstraint.model_rebuild(raise_errors=False)
