...
class VsanFault(VimFault):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','CannotChangeVsanClusterUuid': 'CannotChangeVsanClusterUuid','CannotChangeVsanNodeUuid': 'CannotChangeVsanNodeUuid','CannotMoveVsanEnabledHost': 'CannotMoveVsanEnabledHost','CannotReconfigureVsanWhenHaEnabled': 'CannotReconfigureVsanWhenHaEnabled','DestinationVsanDisabled': 'DestinationVsanDisabled','DiskHasPartitions': 'DiskHasPartitions','DiskIsLastRemainingNonSSD': 'DiskIsLastRemainingNonSSD','DiskIsNonLocal': 'DiskIsNonLocal','DiskIsUSB': 'DiskIsUSB','DiskTooSmall': 'DiskTooSmall','DuplicateDisks': 'DuplicateDisks','DuplicateVsanNetworkInterface': 'DuplicateVsanNetworkInterface','InsufficientDisks': 'InsufficientDisks','VsanClusterUuidMismatch': 'VsanClusterUuidMismatch','VsanDiskFault': 'VsanDiskFault','VsanIncompatibleDiskMapping': 'VsanIncompatibleDiskMapping'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VsanFault failed to lookup discriminator value from " +
...
VsanFault.model_rebuild(raise_errors=False)
