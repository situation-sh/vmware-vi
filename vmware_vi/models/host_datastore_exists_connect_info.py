...
class HostDatastoreExistsConnectInfo(HostDatastoreConnectInfo):
    ...
    """ # noqa: E501
    new_datastore_name: StrictStr = Field(description="The name of a matching datastore on VirtualCenter.  The datastore on the host will be renamed to this name. ", alias="newDatastoreName")
