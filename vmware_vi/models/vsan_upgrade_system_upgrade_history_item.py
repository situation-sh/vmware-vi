...
class VsanUpgradeSystemUpgradeHistoryItem(DataObject):
    """
    Captures one \"log entry\" of an upgrade process.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    timestamp: datetime = Field(description="Time stamp when the history is record.  ***Since:*** vSphere API 6.0 ")
    host: Optional[ManagedObjectReference] = None
    message: StrictStr = Field(description="Description of the history item.  ***Since:*** vSphere API 6.0 ")
    task: Optional[ManagedObjectReference] = None
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VsanUpgradeSystemUpgradeHistoryItem failed to lookup discriminator value from " +
...
VsanUpgradeSystemUpgradeHistoryItem.model_rebuild(raise_errors=False)
