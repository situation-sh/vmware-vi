...
class SetTaskDescriptionRequestType(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "description": LocalizableMessage.from_dict(obj.get("description")) if obj.get("description") is not None else None
        })
        return _obj
