...
class ClusterFailoverHostAdmissionControlInfo(ClusterDasAdmissionControlInfo):
    ...
    """ # noqa: E501
    host_status: Optional[List[ClusterFailoverHostAdmissionControlInfoHostStatus]] = Field(default=None, description="Status of the failover hosts in the cluster.  ***Since:*** vSphere API 4.0 ", alias="hostStatus")
