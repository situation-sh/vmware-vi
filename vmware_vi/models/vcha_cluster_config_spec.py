...
class VchaClusterConfigSpec(DataObject):
    """
    ...
    """ # noqa: E501
    passive_ip: StrictStr = Field(description="IP Address of Passive node in the VCHA Cluster network.  ***Since:*** vSphere API 6.5 ", alias="passiveIp")
    witness_ip: StrictStr = Field(description="IP Address of Witness node in the VCHA Cluster network.  ***Since:*** vSphere API 6.5 ", alias="witnessIp")
