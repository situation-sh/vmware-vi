...
class HostScsiTopologyInterface(DataObject):
    """
    This data object type describes the SCSI interface that is associated with a list of targets. 
    """ # noqa: E501
    key: StrictStr = Field(description="The identifier for the SCSI interface ")
    adapter: HostHostBusAdapter
    target: Optional[List[HostScsiTopologyTarget]] = Field(default=None, description="The list of targets to which the SCSI interface is associated. ")
