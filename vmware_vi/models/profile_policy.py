...
class ProfilePolicy(DataObject):
    """
    The *ProfilePolicy* data object represents a policy.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    id: StrictStr = Field(description="Identifier for the policy.  ***Since:*** vSphere API 4.0 ")
    policy_option: PolicyOption = Field(alias="policyOption")
