...
class HostPlugStoreTopologyAdapter(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="The identifier for the host bus adapter.  ***Since:*** vSphere API 4.0 ")
    adapter: HostHostBusAdapter
    path: Optional[List[HostPlugStoreTopologyPath]] = Field(default=None, description="The list of paths to which the host bus adapter is associated.  ***Since:*** vSphere API 4.0 ")
...
HostPlugStoreTopologyAdapter.model_rebuild(raise_errors=False)
