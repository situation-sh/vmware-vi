...
class ClusterDasAdvancedRuntimeInfo(DataObject):
    """
    Base class for advanced runtime information related to the high availability service for a cluster.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    das_host_info: Optional[ClusterDasHostInfo] = Field(default=None, alias="dasHostInfo")
    vmcp_supported: Optional[ClusterDasAdvancedRuntimeInfoVmcpCapabilityInfo] = Field(default=None, alias="vmcpSupported")
    heartbeat_datastore_info: Optional[List[DasHeartbeatDatastoreInfo]] = Field(default=None, description="The map of a datastore to the set of hosts that are using the datastore for storage heartbeating.  ***Since:*** vSphere API 5.0 ", alias="heartbeatDatastoreInfo")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ClusterDasAdvancedRuntimeInfo failed to lookup discriminator value from " +
...
ClusterDasAdvancedRuntimeInfo.model_rebuild(raise_errors=False)
