...
class CustomizationEvent(VmEvent):
    ...
    """ # noqa: E501
    log_location: Optional[StrictStr] = Field(default=None, description="The location of the in-guest customization log which will contain details of the customization operation.  ***Since:*** VI API 2.5 ", alias="logLocation")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationEvent failed to lookup discriminator value from " +
...
CustomizationEvent.model_rebuild(raise_errors=False)
