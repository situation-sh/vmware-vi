...
class VirtualDevicePipeBackingOption(VirtualDeviceBackingOption):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDevicePipeBackingOption failed to lookup discriminator value from " +
...
VirtualDevicePipeBackingOption.model_rebuild(raise_errors=False)
