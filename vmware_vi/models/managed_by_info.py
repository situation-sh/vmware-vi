...
class ManagedByInfo(DataObject):
    """
    ...
    """ # noqa: E501
    extension_key: StrictStr = Field(description="Key of the extension managing the entity.  ***Since:*** vSphere API 5.0 ", alias="extensionKey")
    type: StrictStr = Field(description="Managed entity type, as defined by the extension managing the entity.  An extension can manage different types of entities - different kinds of virtual machines, vApps, etc. - and this property is used to find the corresponding *managedEntityInfo* entry from the extension.  ***Since:*** vSphere API 5.0 ")
