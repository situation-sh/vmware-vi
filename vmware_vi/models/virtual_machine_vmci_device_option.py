...
class VirtualMachineVMCIDeviceOption(VirtualDeviceOption):
    ...
    """ # noqa: E501
    allow_unrestricted_communication: BoolOption = Field(alias="allowUnrestrictedCommunication")
    filter_spec_option: Optional[VirtualMachineVMCIDeviceOptionFilterSpecOption] = Field(default=None, alias="filterSpecOption")
    filter_supported: Optional[BoolOption] = Field(default=None, alias="filterSupported")
