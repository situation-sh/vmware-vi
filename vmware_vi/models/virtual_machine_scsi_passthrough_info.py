...
class VirtualMachineScsiPassthroughInfo(VirtualMachineTargetInfo):
    ...
    """ # noqa: E501
    scsi_class: StrictStr = Field(description="The class of the generic SCSI device. ", alias="scsiClass")
    vendor: StrictStr = Field(description="The vendor name. ")
    physical_unit_number: StrictInt = Field(description="Unit number of the generic device on the physical host. ", alias="physicalUnitNumber")
