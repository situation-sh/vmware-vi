...
class NumVirtualCoresPerSocketNotSupported(VirtualHardwareCompatibilityIssue):
    ...
    """ # noqa: E501
    max_supported_cores_per_socket_dest: StrictInt = Field(description="The maximum number of cores per socket supported on the host.  ***Since:*** vSphere API 5.0 ", alias="maxSupportedCoresPerSocketDest")
    num_cores_per_socket_vm: StrictInt = Field(description="The number of cores per socket in the virtual machine.  ***Since:*** vSphere API 5.0 ", alias="numCoresPerSocketVm")
