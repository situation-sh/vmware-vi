...
class ActiveDirectoryFault(VimFault):
    ...
    """ # noqa: E501
    error_code: Optional[StrictInt] = Field(default=None, description="The error code reported by the Active Directory API.  ***Since:*** vSphere API 4.1 ", alias="errorCode")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ActiveDirectoryFault failed to lookup discriminator value from " +
...
ActiveDirectoryFault.model_rebuild(raise_errors=False)
