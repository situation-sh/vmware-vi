...
class HostSerialAttachedHba(HostHostBusAdapter):
    """
    The data object type describes the Serial Attached Scsi(SAS) interface.  ***Since:*** vSphere API 6.5 
    """ # noqa: E501
    node_world_wide_name: StrictStr = Field(description="The world wide node name for the adapter.  ***Since:*** vSphere API 6.5 ", alias="nodeWorldWideName")
