...
class VirtualEthernetCardNetworkBackingInfo(VirtualDeviceDeviceBackingInfo):
    ...
    in_passthrough_mode: Optional[StrictBool] = Field(default=None, description="Deprecated as of vSphere API 4.0, this property is not supported. &nbsp;.  &nbsp;  ***Since:*** vSphere API 4.0 ", alias="inPassthroughMode")
