...
class HostMultipathInfo(DataObject):
    """
    ...
    """ # noqa: E501
    lun: Optional[List[HostMultipathInfoLogicalUnit]] = Field(default=None, description="List of logical units that can be configured for multipathing. ")
