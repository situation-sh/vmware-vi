...
class InvalidProfileReferenceHost(RuntimeFault):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the invalid reference host if known.  ***Since:*** vSphere API 5.0 ")
    host: Optional[ManagedObjectReference] = None
    profile: Optional[ManagedObjectReference] = None
    profile_name: Optional[StrictStr] = Field(default=None, description="The profile name: the replacement of the member above.  ***Since:*** vSphere API 6.5 ", alias="profileName")
