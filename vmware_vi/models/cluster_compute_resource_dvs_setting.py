...
class ClusterComputeResourceDVSSetting(DataObject):
    """
    ...
    """ # noqa: E501
    dv_switch: ManagedObjectReference = Field(alias="dvSwitch")
    pnic_devices: Optional[List[StrictStr]] = Field(default=None, description="List of physical nics attached to the DVS.  ***Since:*** vSphere API 6.7.1 ", alias="pnicDevices")
    dv_portgroup_setting: Optional[List[ClusterComputeResourceDVSSettingDVPortgroupToServiceMapping]] = Field(default=None, description="Describes dvportgroups on the DVS and services residing on each one.  ***Since:*** vSphere API 6.7.1 ", alias="dvPortgroupSetting")
