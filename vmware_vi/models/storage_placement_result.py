...
class StoragePlacementResult(DataObject):
    """
    ...
    """ # noqa: E501
    recommendations: Optional[List[ClusterRecommendation]] = Field(default=None, description="The list of recommendations that the client needs to approve manually.  ***Since:*** vSphere API 5.0 ")
    drs_fault: Optional[ClusterDrsFaults] = Field(default=None, alias="drsFault")
