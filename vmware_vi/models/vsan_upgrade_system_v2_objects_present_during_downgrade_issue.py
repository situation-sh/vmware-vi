...
class VsanUpgradeSystemV2ObjectsPresentDuringDowngradeIssue(VsanUpgradeSystemPreflightCheckIssue):
    """
    Pre-flight check encountered v2 objects preventing a downgrade.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    uuids: List[StrictStr] = Field(description="Object UUIDs of v2 objects.  ***Since:*** vSphere API 6.0 ")
