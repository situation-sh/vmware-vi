...
class CreateProfileRequestType(BaseModel):
    """
    The parameters of *ProfileManager.CreateProfile*. 
    """ # noqa: E501
    create_spec: ProfileCreateSpec = Field(alias="createSpec")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "createSpec": ProfileCreateSpec.from_dict(obj.get("createSpec")) if obj.get("createSpec") is not None else None
        })
        return _obj
