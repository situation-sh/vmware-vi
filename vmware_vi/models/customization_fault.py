...
class CustomizationFault(VimFault):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','CannotDecryptPasswords': 'CannotDecryptPasswords','CustomizationPending': 'CustomizationPending','IpHostnameGeneratorError': 'IpHostnameGeneratorError','LinuxVolumeNotClean': 'LinuxVolumeNotClean','MissingLinuxCustResources': 'MissingLinuxCustResources','MissingWindowsCustResources': 'MissingWindowsCustResources','MountError': 'MountError','NicSettingMismatch': 'NicSettingMismatch','NoDisksToCustomize': 'NoDisksToCustomize','UncustomizableGuest': 'UncustomizableGuest','UnexpectedCustomizationFault': 'UnexpectedCustomizationFault','VolumeEditorError': 'VolumeEditorError'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationFault failed to lookup discriminator value from " +
...
CustomizationFault.model_rebuild(raise_errors=False)
