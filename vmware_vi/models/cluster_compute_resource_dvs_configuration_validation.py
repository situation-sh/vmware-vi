...
class ClusterComputeResourceDVSConfigurationValidation(ClusterComputeResourceValidationResultBase):
    """
    ...
    """ # noqa: E501
    is_dvs_valid: StrictBool = Field(description="Check if the DVS is alive.  ***Since:*** vSphere API 6.7.1 ", alias="isDvsValid")
    is_dvpg_valid: StrictBool = Field(description="Check if the portgroups are valid.  ***Since:*** vSphere API 6.7.1 ", alias="isDvpgValid")
