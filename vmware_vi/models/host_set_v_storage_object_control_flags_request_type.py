...
class HostSetVStorageObjectControlFlagsRequestType(BaseModel):
    """
    The parameters of *HostVStorageObjectManager.HostSetVStorageObjectControlFlags*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    control_flags: Optional[List[StrictStr]] = Field(default=None, description="control flags enum array to be set on the VStorageObject. All control flags not included in the array remain intact. ", alias="controlFlags")
