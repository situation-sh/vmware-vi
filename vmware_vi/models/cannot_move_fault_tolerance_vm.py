...
class CannotMoveFaultToleranceVm(VimFault):
    ...
    """ # noqa: E501
    move_type: StrictStr = Field(description="The type of the move  ***Since:*** vSphere API 4.0 ", alias="moveType")
    vm_name: StrictStr = Field(description="The virtual machine name to be moved.  ***Since:*** vSphere API 4.0 ", alias="vmName")
