...
class HostMemberUplinkHealthCheckResult(HostMemberHealthCheckResult):
    """
    This class defines healthcheck result of a specified Uplink port in vSphere Distributed Switch.  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    uplink_port_key: StrictStr = Field(description="The uplink port key.  ***Since:*** vSphere API 5.1 ", alias="uplinkPortKey")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostMemberUplinkHealthCheckResult failed to lookup discriminator value from " +
...
HostMemberUplinkHealthCheckResult.model_rebuild(raise_errors=False)
