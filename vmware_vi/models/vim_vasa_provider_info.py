...
class VimVasaProviderInfo(DataObject):
    """
    Data object representing VASA Provider information.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    provider: VimVasaProvider
    array_state: Optional[List[VimVasaProviderStatePerArray]] = Field(default=None, description="Per-array State  ***Since:*** vSphere API 6.0 ", alias="arrayState")
