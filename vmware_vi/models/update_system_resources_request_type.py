...
class UpdateSystemResourcesRequestType(BaseModel):
    """
    The parameters of *HostSystem.UpdateSystemResources*. 
    """ # noqa: E501
    resource_info: HostSystemResourceInfo = Field(alias="resourceInfo")
    __properties: ClassVar[List[str]] = ["resourceInfo"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "resourceInfo": HostSystemResourceInfo.from_dict(obj.get("resourceInfo")) if obj.get("resourceInfo") is not None else None
        })
        return _obj
