...
class HostIpRouteTableInfo(DataObject):
    """
    IpRouteTableInfo.  This is the list of all static routes on the host  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    ip_route: Optional[List[HostIpRouteEntry]] = Field(default=None, description="The array of IpRouteEntry  ***Since:*** vSphere API 4.0 ", alias="ipRoute")
    ipv6_route: Optional[List[HostIpRouteEntry]] = Field(default=None, alias="ipv6Route")
