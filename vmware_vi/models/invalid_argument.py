...
class InvalidArgument(RuntimeFault):
    ...
    """ # noqa: E501
    invalid_property: Optional[StrictStr] = Field(default=None, description="Optional name of the invalid property. ", alias="invalidProperty")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidArgument failed to lookup discriminator value from " +
...
InvalidArgument.model_rebuild(raise_errors=False)
