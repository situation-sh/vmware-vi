...
class NamePasswordAuthentication(GuestAuthentication):
    ...
    """ # noqa: E501
    username: StrictStr = Field(description="The user name for Name-Password authentication.  ***Since:*** vSphere API 5.0 ")
    password: SecretStr = Field(description="The password for Name-Password authentication.  ***Since:*** vSphere API 5.0 ")
