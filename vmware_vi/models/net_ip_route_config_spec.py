...
class NetIpRouteConfigSpec(DataObject):
    """
    Address family independent IP Route Table Configuration data object.  ***Since:*** vSphere API 4.1 
    """ # noqa: E501
    ip_route: Optional[List[NetIpRouteConfigSpecIpRouteSpec]] = Field(default=None, description="The set of updates to apply to the routing table.  ***Since:*** vSphere API 4.1 ", alias="ipRoute")
