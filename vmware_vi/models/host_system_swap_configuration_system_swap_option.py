...
class HostSystemSwapConfigurationSystemSwapOption(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictInt = Field(description="Specifies the order the options are preferred among each other.  The lower the value the more important.  ***Since:*** vSphere API 5.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostSystemSwapConfigurationSystemSwapOption failed to lookup discriminator value from " +
...
HostSystemSwapConfigurationSystemSwapOption.model_rebuild(raise_errors=False)
