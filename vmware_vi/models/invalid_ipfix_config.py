...
class InvalidIpfixConfig(DvsFault):
    ...
    """ # noqa: E501
    var_property: Optional[StrictStr] = Field(default=None, description="Path of the property in IpfixConfig that has an invalid value.  ***Since:*** vSphere API 5.1 ", alias="property")
