...
class OvfConsumerInvalidSection(OvfConsumerCallbackFault):
    ...
    """ # noqa: E501
    line_number: StrictInt = Field(description="The line number in the section on which the error was found.  ***Since:*** vSphere API 5.0 ", alias="lineNumber")
    description: StrictStr = Field(description="The XML parser error message.  ***Since:*** vSphere API 5.0 ")
