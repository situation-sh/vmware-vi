...
class CreateTemporaryDirectoryInGuestRequestType(BaseModel):
    """
    The parameters of *GuestFileManager.CreateTemporaryDirectoryInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    prefix: StrictStr = Field(description="The prefix to be given to the new temporary directory. ")
    suffix: StrictStr = Field(description="The suffix to be given to the new temporary directory. ")
    directory_path: Optional[StrictStr] = Field(default=None, description="The complete path to the directory in which to create the new directory. If unset or an empty string, a guest-specific location will be used. ", alias="directoryPath")
    __properties: ClassVar[List[str]] = ["vm", "auth", "prefix", "suffix", "directoryPath"]
