...
class DVPortState(DataObject):
    ...
    vendor_specific_state: Optional[List[DistributedVirtualSwitchKeyedOpaqueBlob]] = Field(default=None, description="Opaque binary blob that stores vendor-specific runtime state data.  ***Since:*** vSphere API 4.0 ", alias="vendorSpecificState")
