...
class MemorySizeNotSupportedByDatastore(VirtualHardwareCompatibilityIssue):
    ...
    memory_size_mb: StrictInt = Field(description="The configured memory size of the virtual machine.  ***Since:*** vSphere API 5.0 ", alias="memorySizeMB")
    max_memory_size_mb: StrictInt = Field(description="The maximum acceptable memory size supported by the datastore.  ***Since:*** vSphere API 5.0 ", alias="maxMemorySizeMB")
