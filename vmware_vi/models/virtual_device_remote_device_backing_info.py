...
class VirtualDeviceRemoteDeviceBackingInfo(VirtualDeviceBackingInfo):
    ...
    """ # noqa: E501
    device_name: StrictStr = Field(description="The name of the device on the remote system. ", alias="deviceName")
    use_auto_detect: Optional[StrictBool] = Field(default=None, description="Indicates whether the device should be auto detected instead of directly specified.  If this value is set to TRUE, <code>deviceName</code> is ignored.  ***Since:*** VI API 2.5 ", alias="useAutoDetect")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceRemoteDeviceBackingInfo failed to lookup discriminator value from " +
...
VirtualDeviceRemoteDeviceBackingInfo.model_rebuild(raise_errors=False)
