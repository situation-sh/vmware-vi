...
class VCenterUpdateVStorageObjectMetadataExRequestType(BaseModel):
    """
    The parameters of *VcenterVStorageObjectManager.VCenterUpdateVStorageObjectMetadataEx_Task*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    metadata: Optional[List[KeyValue]] = Field(default=None, description="array of key/value strings. (keys must be unique within the list)  ***Since:*** VI API 2.5 ")
    delete_keys: Optional[List[StrictStr]] = Field(default=None, description="array of keys need to be deleted ", alias="deleteKeys")
    __properties: ClassVar[List[str]] = ["id", "datastore", "metadata", "deleteKeys"]
