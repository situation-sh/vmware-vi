...
class HostPortGroupConfig(DataObject):
    """
    ...
    """ # noqa: E501
    change_operation: Optional[StrictStr] = Field(default=None, description="Indicates the change operation to apply on this configuration specification.  See also *HostConfigChangeOperation_enum*. ", alias="changeOperation")
    spec: Optional[HostPortGroupSpec] = None
