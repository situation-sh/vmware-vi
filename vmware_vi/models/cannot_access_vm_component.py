...
class CannotAccessVmComponent(VmConfigFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CannotAccessVmComponent failed to lookup discriminator value from " +
...
CannotAccessVmComponent.model_rebuild(raise_errors=False)
