...
class UpdateVirtualMachineFilesResult(DataObject):
    """
    ...
    """ # noqa: E501
    failed_vm_file: Optional[List[UpdateVirtualMachineFilesResultFailedVmFileInfo]] = Field(default=None, description="The list of virtual machines files the server has attempted to update but failed to update.  ***Since:*** vSphere API 4.1 ", alias="failedVmFile")
