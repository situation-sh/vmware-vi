...
class DvsNetworkRuleQualifier(DataObject):
    """
    This class is the base class for identifying network traffic.  ***Since:*** vSphere API 5.5 
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key of the Qualifier  ***Since:*** vSphere API 5.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsNetworkRuleQualifier failed to lookup discriminator value from " +
...
DvsNetworkRuleQualifier.model_rebuild(raise_errors=False)
