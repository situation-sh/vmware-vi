...
class FtIssuesOnHost(VmFaultToleranceIssue):
    ...
    host_name: StrictStr = Field(description="Name for the host which has Fault Tolerance issues.  ***Since:*** vSphere API 4.0 ", alias="hostName")
    errors: Optional[List[MethodFault]] = Field(default=None, description="Information on the details of the Fault Tolerance issues  ***Since:*** vSphere API 4.0 ")
