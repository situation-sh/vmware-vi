...
class DVSNetworkResourcePool(DataObject):
    """
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Key of the network resource pool.  ***Since:*** vSphere API 4.1 ")
    name: Optional[StrictStr] = Field(default=None, description="Name of the network resource pool.  ***Since:*** vSphere API 4.1 ")
    description: Optional[StrictStr] = Field(default=None, description="Description of the network resource pool.  ***Since:*** vSphere API 4.1 ")
    config_version: StrictStr = Field(description="Configuration version for the network resource pool.  ***Since:*** vSphere API 4.1 ", alias="configVersion")
    allocation_info: DVSNetworkResourcePoolAllocationInfo = Field(alias="allocationInfo")
