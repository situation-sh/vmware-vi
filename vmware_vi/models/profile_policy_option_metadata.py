...
class ProfilePolicyOptionMetadata(DataObject):
    """
    ...
    parameter: Optional[List[ProfileParameterMetadata]] = Field(default=None, description="Metadata about the parameters for the policy option.  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ProfilePolicyOptionMetadata failed to lookup discriminator value from " +
...
ProfilePolicyOptionMetadata.model_rebuild(raise_errors=False)
