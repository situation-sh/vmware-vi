...
class ConfigureVchaRequestType(BaseModel):
    """
    The parameters of *FailoverClusterConfigurator.configureVcha_Task*. 
    """ # noqa: E501
    config_spec: VchaClusterConfigSpec = Field(alias="configSpec")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configSpec": VchaClusterConfigSpec.from_dict(obj.get("configSpec")) if obj.get("configSpec") is not None else None
        })
        return _obj
