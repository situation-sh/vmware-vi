...
class VmConfigFileQuery(FileQuery):
    ...
    """ # noqa: E501
    filter: Optional[VmConfigFileQueryFilter] = None
    details: Optional[VmConfigFileQueryFlags] = None
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmConfigFileQuery failed to lookup discriminator value from " +
...
VmConfigFileQuery.model_rebuild(raise_errors=False)
