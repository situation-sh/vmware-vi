...
class VmFailedStartingSecondaryEvent(VmEvent):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason for the failure.  See *VmFailedStartingSecondaryEventFailureReason_enum*  ***Since:*** vSphere API 4.0 ")
