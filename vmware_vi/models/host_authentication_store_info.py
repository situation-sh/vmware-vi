...
class HostAuthenticationStoreInfo(DataObject):
    """
    ...
    """ # noqa: E501
    enabled: StrictBool = Field(description="Indicates whether the authentication store is configured. - Host Active Directory authentication - <code>enabled</code>   is <code>True</code> if the host is a member of a domain. - Local authentication - <code>enabled</code> is always <code>True</code>.    ***Since:*** vSphere API 4.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostAuthenticationStoreInfo failed to lookup discriminator value from " +
...
HostAuthenticationStoreInfo.model_rebuild(raise_errors=False)
