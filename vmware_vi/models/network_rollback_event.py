...
class NetworkRollbackEvent(Event):
    ...
    """ # noqa: E501
    method_name: StrictStr = Field(description="Method name which caused the disconnect  ***Since:*** vSphere API 5.1 ", alias="methodName")
    transaction_id: StrictStr = Field(description="Transaction ID for the method call that caused the disconnect  ***Since:*** vSphere API 5.1 ", alias="transactionId")
