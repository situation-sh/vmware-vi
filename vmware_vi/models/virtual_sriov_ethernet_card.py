...
class VirtualSriovEthernetCard(VirtualEthernetCard):
    ...
    """ # noqa: E501
    allow_guest_os_mtu_change: Optional[StrictBool] = Field(default=None, description="Indicates whether MTU can be changed from guest OS.  ***Since:*** vSphere API 5.5 ", alias="allowGuestOSMtuChange")
    sriov_backing: Optional[VirtualSriovEthernetCardSriovBackingInfo] = Field(default=None, alias="sriovBacking")
    dvx_backing_info: Optional[VirtualPCIPassthroughDvxBackingInfo] = Field(default=None, alias="dvxBackingInfo")
