...
class LicenseEvent(Event):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','AllVirtualMachinesLicensedEvent': 'AllVirtualMachinesLicensedEvent','HostInventoryFullEvent': 'HostInventoryFullEvent','HostLicenseExpiredEvent': 'HostLicenseExpiredEvent','IncorrectHostInformationEvent': 'IncorrectHostInformationEvent','InvalidEditionEvent': 'InvalidEditionEvent','LicenseNonComplianceEvent': 'LicenseNonComplianceEvent','LicenseRestrictedEvent': 'LicenseRestrictedEvent','LicenseServerAvailableEvent': 'LicenseServerAvailableEvent','LicenseServerUnavailableEvent': 'LicenseServerUnavailableEvent','NoLicenseEvent': 'NoLicenseEvent','ServerLicenseExpiredEvent': 'ServerLicenseExpiredEvent','UnlicensedVirtualMachinesEvent': 'UnlicensedVirtualMachinesEvent','UnlicensedVirtualMachinesFoundEvent': 'UnlicensedVirtualMachinesFoundEvent','VMotionLicenseExpiredEvent': 'VMotionLicenseExpiredEvent'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("LicenseEvent failed to lookup discriminator value from " +
...
LicenseEvent.model_rebuild(raise_errors=False)
