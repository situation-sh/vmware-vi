...
class VirtualDeviceBusSlotOption(DataObject):
    """
    The *VirtualDeviceBusSlotOption* data class defines options for device-specific bus slot objects.  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    type: StrictStr = Field(description="The name of the class the client should use to instantiate bus slot object for the virtual device.  ***Since:*** vSphere API 5.1 ")
