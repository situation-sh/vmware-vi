...
class VirtualDeviceRemoteDeviceBackingOption(VirtualDeviceBackingOption):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceRemoteDeviceBackingOption failed to lookup discriminator value from " +
...
VirtualDeviceRemoteDeviceBackingOption.model_rebuild(raise_errors=False)
