...
class VchaClusterNetworkSpec(DataObject):
    """
    The VchaClusterNetworkSpec class contains network configuration information for a VCHA Cluster.  ***Since:*** vSphere API 6.5 
    """ # noqa: E501
    witness_network_spec: NodeNetworkSpec = Field(alias="witnessNetworkSpec")
    passive_network_spec: PassiveNodeNetworkSpec = Field(alias="passiveNetworkSpec")
