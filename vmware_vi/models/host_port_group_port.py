...
class HostPortGroupPort(DataObject):
    """
    ...
    mac: Optional[List[StrictStr]] = Field(default=None, description="The Media Access Control (MAC) address of network service of the virtual machine connected on this port. ")
    type: StrictStr = Field(description="The type of component connected on this port.  Must be one of the values of *PortGroupConnecteeType_enum*. ")
