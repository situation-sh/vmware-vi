...
class DatacenterMismatch(MigrationFault):
    ...
    """ # noqa: E501
    invalid_argument: List[DatacenterMismatchArgument] = Field(description="The list of invalid arguments. ", alias="invalidArgument")
    expected_datacenter: ManagedObjectReference = Field(alias="expectedDatacenter")
