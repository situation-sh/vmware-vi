...
class EnableNetworkResourceManagementRequestType(BaseModel):
    """
    The parameters of *DistributedVirtualSwitch.EnableNetworkResourceManagement*. 
    """ # noqa: E501
    enable: StrictBool = Field(description="If true, enables I/O control. If false, disables network I/O control. ")
