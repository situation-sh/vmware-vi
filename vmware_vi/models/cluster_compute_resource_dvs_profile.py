...
class ClusterComputeResourceDvsProfile(DataObject):
    """
    ...
    """ # noqa: E501
    dvs_name: Optional[StrictStr] = Field(default=None, description="Name of the new *DistributedVirtualSwitch*.  ***Since:*** vSphere API 6.7.1 ", alias="dvsName")
    dv_switch: Optional[ManagedObjectReference] = Field(default=None, alias="dvSwitch")
    pnic_devices: Optional[List[StrictStr]] = Field(default=None, description="List of physical Nics to be attached to the DVS.  ***Since:*** vSphere API 6.7.1 ", alias="pnicDevices")
    dv_portgroup_mapping: Optional[List[ClusterComputeResourceDvsProfileDVPortgroupSpecToServiceMapping]] = Field(default=None, alias="dvPortgroupMapping")
