...
class ValidateHostRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ovfDescriptor", "host", "vhp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vhp
        if self.vhp:
            _dict['vhp'] = self.vhp.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "vhp": OvfValidateHostParams.from_dict(obj.get("vhp")) if obj.get("vhp") is not None else None
        })
        return _obj
