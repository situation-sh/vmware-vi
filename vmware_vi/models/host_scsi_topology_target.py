...
class HostScsiTopologyTarget(DataObject):
    """
    This data object type describes the SCSI target that is associated with a list of logical units. 
    """ # noqa: E501
    key: StrictStr = Field(description="The identifier for the SCSI target ")
    target: StrictInt = Field(description="The target identifier. ")
    lun: Optional[List[HostScsiTopologyLun]] = Field(default=None, description="The list of SCSI logical units with which a target is associated. ")
