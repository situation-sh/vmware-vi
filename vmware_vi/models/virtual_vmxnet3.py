...
class VirtualVmxnet3(VirtualVmxnet):
    ...
    """ # noqa: E501
    uptv2_enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether UPTv2(Uniform Pass-through version 2) compatibility is enabled on this network adapter.  UPTv2 is only available on Vmxnet3 adapter. Clients can set this property enabled or disabled if ethernet virtual device is Vmxnet3. It requires the VM hardware version is compatible with ESXi version which has enabled smartnic feature. ", alias="uptv2Enabled")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualVmxnet3 failed to lookup discriminator value from " +
...
VirtualVmxnet3.model_rebuild(raise_errors=False)
