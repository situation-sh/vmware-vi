...
class DatastoreFileCopiedEvent(DatastoreFileEvent):
    ...
    """ # noqa: E501
    source_datastore: DatastoreEventArgument = Field(alias="sourceDatastore")
    source_file: StrictStr = Field(description="Datastore path of the source file or directory.  ***Since:*** vSphere API 4.0 ", alias="sourceFile")
