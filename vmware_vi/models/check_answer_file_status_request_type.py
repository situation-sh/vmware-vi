...
class CheckAnswerFileStatusRequestType(BaseModel):
    """
    The parameters of *HostProfileManager.CheckAnswerFileStatus_Task*. 
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="Set of hosts for which the answer file status will be checked.  Refers instances of *HostSystem*. ")
