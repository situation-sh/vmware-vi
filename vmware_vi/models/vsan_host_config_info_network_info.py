...
class VsanHostConfigInfoNetworkInfo(DataObject):
    """
    ...
    """ # noqa: E501
    port: Optional[List[VsanHostConfigInfoNetworkInfoPortConfig]] = Field(default=None, description="Set of PortConfig entries for use by the VSAN service, one per \"virtual network\" as used by VSAN.  ***Since:*** vSphere API 5.5 ")
