...
class CustomizationName(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationName failed to lookup discriminator value from " +
...
CustomizationName.model_rebuild(raise_errors=False)
