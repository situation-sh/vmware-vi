...
class DVSSecurityPolicy(InheritablePolicy):
    ...
    """ # noqa: E501
    allow_promiscuous: Optional[BoolPolicy] = Field(default=None, alias="allowPromiscuous")
    mac_changes: Optional[BoolPolicy] = Field(default=None, alias="macChanges")
    forged_transmits: Optional[BoolPolicy] = Field(default=None, alias="forgedTransmits")
