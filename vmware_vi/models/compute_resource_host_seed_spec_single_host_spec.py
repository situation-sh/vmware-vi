...
class ComputeResourceHostSeedSpecSingleHostSpec(DataObject):
    """
    ...
    """ # noqa: E501
    new_host_cnx_spec: Optional[HostConnectSpec] = Field(default=None, alias="newHostCnxSpec")
    existing_host: Optional[ManagedObjectReference] = Field(default=None, alias="existingHost")
