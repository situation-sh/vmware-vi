...
class VsanUpgradeSystemRogueHostsInClusterIssue(VsanUpgradeSystemPreflightCheckIssue):
    """
    ...
    """ # noqa: E501
    uuids: List[StrictStr] = Field(description="Host UUIDs of rogue hosts.  ***Since:*** vSphere API 6.0 ")
