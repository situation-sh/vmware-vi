...
class AddInternetScsiStaticTargetsRequestType(BaseModel):
    """
    ...
    targets: List[HostInternetScsiHbaStaticTarget] = Field(description="An array of iSCSI static targets to add. ")
