...
class DatastoreCapacityIncreasedEvent(DatastoreEvent):
    ...
    """ # noqa: E501
    old_capacity: StrictInt = Field(description="The old datastore capacity.  ***Since:*** vSphere API 4.0 ", alias="oldCapacity")
    new_capacity: StrictInt = Field(description="The new datastore capacity.  ***Since:*** vSphere API 4.0 ", alias="newCapacity")
