...
class VirtualAppImportSpec(ImportSpec):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the vApp  ***Since:*** vSphere API 4.0 ")
    v_app_config_spec: VAppConfigSpec = Field(alias="vAppConfigSpec")
    resource_pool_spec: ResourceConfigSpec = Field(alias="resourcePoolSpec")
    child: Optional[List[ImportSpec]] = Field(default=None, description="Contains a list of children (*VirtualMachine*s and *VirtualApp*s).  ***Since:*** vSphere API 4.0 ")
