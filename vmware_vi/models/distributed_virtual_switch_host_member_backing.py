...
class DistributedVirtualSwitchHostMemberBacking(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DistributedVirtualSwitchHostMemberBacking failed to lookup discriminator value from " +
...
DistributedVirtualSwitchHostMemberBacking.model_rebuild(raise_errors=False)
