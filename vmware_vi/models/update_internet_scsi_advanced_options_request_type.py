...
class UpdateInternetScsiAdvancedOptionsRequestType(BaseModel):
    """
    ...
    options: List[HostInternetScsiHbaParamValue] = Field(description="The list of options to set.  ***Since:*** vSphere API 4.0 ")
    __properties: ClassVar[List[str]] = ["iScsiHbaDevice", "targetSet", "options"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "options": [HostInternetScsiHbaParamValue.from_dict(_item) for _item in obj.get("options")] if obj.get("options") is not None else None
        })
        return _obj
