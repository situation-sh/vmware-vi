...
class DvsTrafficFilterConfig(DvsFilterConfig):
    """
    ...
    """ # noqa: E501
    traffic_ruleset: Optional[DvsTrafficRuleset] = Field(default=None, alias="trafficRuleset")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsTrafficFilterConfig failed to lookup discriminator value from " +
...
DvsTrafficFilterConfig.model_rebuild(raise_errors=False)
