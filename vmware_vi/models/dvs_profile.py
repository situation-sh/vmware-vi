...
class DvsProfile(ApplyProfile):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Linkable identifier.  ***Since:*** vSphere API 4.0 ")
    name: StrictStr = Field(description="Unique identifier for the distributed virtual switch.  ***Since:*** vSphere API 4.0 ")
    uplink: Optional[List[PnicUplinkProfile]] = Field(default=None, description="List of subprofiles that map physical NICs to uplink ports.  Use the *PnicUplinkProfile.key* property to access subprofiles in the list.  ***Since:*** vSphere API 4.0 ")
