...
class AlarmEvent(Event):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("AlarmEvent failed to lookup discriminator value from " +
...
AlarmEvent.model_rebuild(raise_errors=False)
