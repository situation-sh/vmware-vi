...
class FetchDVPortKeysRequestType(BaseModel):
    """
    The parameters of *DistributedVirtualSwitch.FetchDVPortKeys*. 
    """ # noqa: E501
    criteria: Optional[DistributedVirtualSwitchPortCriteria] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "criteria": DistributedVirtualSwitchPortCriteria.from_dict(obj.get("criteria")) if obj.get("criteria") is not None else None
        })
        return _obj
