...
class DvsIpPort(NegatableExpression):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsIpPort failed to lookup discriminator value from " +
...
DvsIpPort.model_rebuild(raise_errors=False)
