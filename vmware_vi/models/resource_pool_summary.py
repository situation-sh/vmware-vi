...
class ResourcePoolSummary(DataObject):
    """
    ...
    quick_stats: Optional[ResourcePoolQuickStats] = Field(default=None, alias="quickStats")
    configured_memory_mb: Optional[StrictInt] = Field(default=None, description="Total configured memory of all virtual machines in the resource pool, in MB.  ***Since:*** vSphere API 4.0 ", alias="configuredMemoryMB")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("ResourcePoolSummary failed to lookup discriminator value from " +
...
ResourcePoolSummary.model_rebuild(raise_errors=False)
