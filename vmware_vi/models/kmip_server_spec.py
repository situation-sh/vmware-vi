...
class KmipServerSpec(DataObject):
    """
    ...
    info: KmipServerInfo
    password: Optional[SecretStr] = Field(default=None, description="Password to authenticate to the KMIP server.  Set value to empty string to delete the entry.  ***Since:*** vSphere API 6.5 ")
