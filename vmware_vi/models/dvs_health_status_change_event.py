...
class DvsHealthStatusChangeEvent(HostEvent):
    ...
    """ # noqa: E501
    switch_uuid: StrictStr = Field(description="UUID of the DVS the host is connected to.  ***Since:*** vSphere API 5.1 ", alias="switchUuid")
    health_result: Optional[HostMemberHealthCheckResult] = Field(default=None, alias="healthResult")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DvsHealthStatusChangeEvent failed to lookup discriminator value from " +
...
DvsHealthStatusChangeEvent.model_rebuild(raise_errors=False)
