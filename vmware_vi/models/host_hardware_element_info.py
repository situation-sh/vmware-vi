...
class HostHardwareElementInfo(DataObject):
    """
    Data object describing the operational status of a physical element.  ***Since:*** VI API 2.5 
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the physical element  ***Since:*** VI API 2.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostHardwareElementInfo failed to lookup discriminator value from " +
...
HostHardwareElementInfo.model_rebuild(raise_errors=False)
