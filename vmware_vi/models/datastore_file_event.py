...
class DatastoreFileEvent(DatastoreEvent):
    ...
    """ # noqa: E501
    target_file: StrictStr = Field(description="Datastore path of the target file or directory.  ***Since:*** vSphere API 4.0 ", alias="targetFile")
    source_of_operation: Optional[StrictStr] = Field(default=None, description="Identifier of the initiator of the file operation.  ***Since:*** vSphere API 6.5 ", alias="sourceOfOperation")
    succeeded: Optional[StrictBool] = Field(default=None, description="Indicator whether the datastore file operation succeeded.  ***Since:*** vSphere API 6.5 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DatastoreFileEvent failed to lookup discriminator value from " +
...
DatastoreFileEvent.model_rebuild(raise_errors=False)
