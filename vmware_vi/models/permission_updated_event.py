...
class PermissionUpdatedEvent(PermissionEvent):
    ...
    propagate: StrictBool = Field(description="Whether or not the permission applies to sub-entities. ")
    prev_role: Optional[RoleEventArgument] = Field(default=None, alias="prevRole")
    prev_propagate: Optional[StrictBool] = Field(default=None, description="Previous propogate value.  ***Since:*** vSphere API 6.5 ", alias="prevPropagate")
