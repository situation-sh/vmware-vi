...
class CreateDescriptorRequestType(BaseModel):
    """
    The parameters of *OvfManager.CreateDescriptor*. 
    """ # noqa: E501
    obj: ManagedObjectReference
    cdp: OvfCreateDescriptorParams
    __properties: ClassVar[List[str]] = ["obj", "cdp"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "cdp": OvfCreateDescriptorParams.from_dict(obj.get("cdp")) if obj.get("cdp") is not None else None
        })
        return _obj
