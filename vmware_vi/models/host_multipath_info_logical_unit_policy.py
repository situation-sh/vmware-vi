...
class HostMultipathInfoLogicalUnitPolicy(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostMultipathInfoLogicalUnitPolicy failed to lookup discriminator value from " +
...
HostMultipathInfoLogicalUnitPolicy.model_rebuild(raise_errors=False)
