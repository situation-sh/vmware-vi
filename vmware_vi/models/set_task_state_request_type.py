...
class SetTaskStateRequestType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["state", "result", "fault"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "state": obj.get("state"),
            "result": Any.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            "fault": MethodFault.from_dict(obj.get("fault")) if obj.get("fault") is not None else None
        })
        return _obj
