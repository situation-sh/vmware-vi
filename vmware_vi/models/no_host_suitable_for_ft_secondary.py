...
class NoHostSuitableForFtSecondary(VmFaultToleranceIssue):
    ...
    vm_name: StrictStr = Field(description="The name of the primary virtual machine corresponding to the secondary virtual machine.  ***Since:*** vSphere API 4.0 ", alias="vmName")
