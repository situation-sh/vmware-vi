...
class CertMgrRefreshCACertificatesAndCRLsRequestType(BaseModel):
    """
    The parameters of *CertificateManager.CertMgrRefreshCACertificatesAndCRLs_Task*. 
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="the hosts on which the certificates need to be refreshed  Refers instances of *HostSystem*. ")
