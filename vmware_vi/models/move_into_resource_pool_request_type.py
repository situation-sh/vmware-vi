...
class MoveIntoResourcePoolRequestType(BaseModel):
    """
    The parameters of *ResourcePool.MoveIntoResourcePool*. 
    """ # noqa: E501
    list: List[ManagedObjectReference] = Field(description="A list of ResourcePool and VirtualMachine objects.  Refers instances of *ManagedEntity*. ")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "list": [ManagedObjectReference.from_dict(_item) for _item in obj.get("list")] if obj.get("list") is not None else None
        })
        return _obj
