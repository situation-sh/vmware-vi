...
class GlobalMessageChangedEvent(SessionEvent):
    ...
    """ # noqa: E501
    message: StrictStr = Field(description="The new message that was set. ")
    prev_message: Optional[StrictStr] = Field(default=None, description="The previous message that was set.  ***Since:*** vSphere API 6.5 ", alias="prevMessage")
