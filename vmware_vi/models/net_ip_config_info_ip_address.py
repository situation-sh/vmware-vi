...
class NetIpConfigInfoIpAddress(DataObject):
    ...
    origin: Optional[StrictStr] = Field(default=None, description="How this address was configured.  This can be one of the values from the enum IpAddressOrigin See *NetIpConfigInfoIpAddressOrigin_enum* for values.  ***Since:*** vSphere API 4.1 ")
    state: Optional[StrictStr] = Field(default=None, description="The state of this ipAddress.  Can be one of *NetIpConfigInfoIpAddressStatus_enum*.  ***Since:*** vSphere API 4.1 ")
    lifetime: Optional[datetime] = Field(default=None, description="The time when will this address expire.  Durning this time *state* may change states but is still visible from the network.  ***Since:*** vSphere API 4.1 ")
