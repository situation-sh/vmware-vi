...
class CreateSecondaryVMExRequestType(BaseModel):
    """
    The parameters of *VirtualMachine.CreateSecondaryVMEx_Task*. 
    """ # noqa: E501
    host: Optional[ManagedObjectReference] = None
    spec: Optional[FaultToleranceConfigSpec] = None
    __properties: ClassVar[List[str]] = ["host", "spec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "spec": FaultToleranceConfigSpec.from_dict(obj.get("spec")) if obj.get("spec") is not None else None
        })
        return _obj
