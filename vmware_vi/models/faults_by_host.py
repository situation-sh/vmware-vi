...
class FaultsByHost(DataObject):
    """
    Group of faults associated with Host.  This Class is used in e.g. *HostEnterMaintenanceResult*.  ***Since:*** vSphere API 6.7 
    """ # noqa: E501
    host: ManagedObjectReference
    faults: Optional[List[MethodFault]] = Field(default=None, description="The array of faults related to the given Host.  ***Since:*** vSphere API 6.7 ")
