...
class EVCUnsupportedByHostHardware(EVCConfigFault):
    ...
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="The set of hosts which are blocking EVC because their CPU hardware does not support CPUID override.  ***Since:*** vSphere API 4.1  Refers instances of *HostSystem*. ")
