...
class EntityEventArgument(EventArgument):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the entity, including its full path from the root of the inventory. ")
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ArrayOfAnyURI': 'ArrayOfURI','ArrayOfBase64Binary': 'ArrayOfBinary','ArrayOfPropertyPath': 'ArrayOfPropPath','MethodName': 'PrimitiveMethodName','PropertyPath': 'PrimitivePropPath','TypeName': 'PrimitiveTypeName','anyURI': 'PrimitiveURI','base64Binary': 'PrimitiveBinary','boolean': 'PrimitiveBoolean','byte': 'PrimitiveByte','dateTime': 'PrimitiveDateTime','double': 'PrimitiveDouble','float': 'PrimitiveFloat','int': 'PrimitiveInt','long': 'PrimitiveLong','short': 'PrimitiveShort','string': 'PrimitiveString','AlarmEventArgument': 'AlarmEventArgument','ComputeResourceEventArgument': 'ComputeResourceEventArgument','DatacenterEventArgument': 'DatacenterEventArgument','DatastoreEventArgument': 'DatastoreEventArgument','DvsEventArgument': 'DvsEventArgument','FolderEventArgument': 'FolderEventArgument','HostEventArgument': 'HostEventArgument','ManagedEntityEventArgument': 'ManagedEntityEventArgument','NetworkEventArgument': 'NetworkEventArgument','ResourcePoolEventArgument': 'ResourcePoolEventArgument','ScheduledTaskEventArgument': 'ScheduledTaskEventArgument','VmEventArgument': 'VmEventArgument'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("EntityEventArgument failed to lookup discriminator value from " +
...
EntityEventArgument.model_rebuild(raise_errors=False)
