...
class VStorageObjectSnapshotInfo(DataObject):
    """
    This data object type contains the brief information of a virtual storage snapshot.  ***Since:*** vSphere API 6.7 
    """ # noqa: E501
    snapshots: Optional[List[VStorageObjectSnapshotInfoVStorageObjectSnapshot]] = Field(default=None, description="An array of snapshots  ***Since:*** vSphere API 6.7 ")
