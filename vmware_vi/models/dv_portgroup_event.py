...
class DVPortgroupEvent(Event):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DVPortgroupEvent failed to lookup discriminator value from " +
...
DVPortgroupEvent.model_rebuild(raise_errors=False)
