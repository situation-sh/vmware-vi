...
class OvfUnsupportedPackage(OvfFault):
    ...
    """ # noqa: E501
    line_number: Optional[StrictInt] = Field(default=None, description="OVF descriptor linenumber  ***Since:*** vSphere API 4.0 ", alias="lineNumber")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfUnsupportedPackage failed to lookup discriminator value from " +
...
OvfUnsupportedPackage.model_rebuild(raise_errors=False)
