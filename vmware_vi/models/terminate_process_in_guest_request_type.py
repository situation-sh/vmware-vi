...
class TerminateProcessInGuestRequestType(BaseModel):
    """
    The parameters of *GuestProcessManager.TerminateProcessInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    pid: StrictInt = Field(description="Process ID of the process to be terminated ")
    __properties: ClassVar[List[str]] = ["vm", "auth", "pid"]
