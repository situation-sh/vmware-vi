...
class HostSystemIdentificationInfo(DataObject):
    """
    ...
    """ # noqa: E501
    identifier_value: StrictStr = Field(description="The system identification information  ***Since:*** VI API 2.5 ", alias="identifierValue")
    identifier_type: ElementDescription = Field(alias="identifierType")
