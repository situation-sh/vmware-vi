...
class PatchNotApplicable(VimFault):
    ...
    """ # noqa: E501
    patch_id: StrictStr = Field(description="The ID of the patch that is not applicable to the host. ", alias="patchID")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PatchNotApplicable failed to lookup discriminator value from " +
...
PatchNotApplicable.model_rebuild(raise_errors=False)
