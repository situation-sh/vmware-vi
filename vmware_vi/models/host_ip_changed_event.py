...
class HostIpChangedEvent(HostEvent):
    ...
    """ # noqa: E501
    old_ip: StrictStr = Field(description="Old IP address of the host.  ***Since:*** VI API 2.5 ", alias="oldIP")
    new_ip: StrictStr = Field(description="New IP address of the host.  ***Since:*** VI API 2.5 ", alias="newIP")
