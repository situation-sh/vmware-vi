...
class VmWwnConflict(InvalidVmConfig):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the virtual machine/host that is using the same WWN.  ***Since:*** VI API 2.5 ")
    wwn: Optional[StrictInt] = Field(default=None, description="The WWN that is in conflict.  ***Since:*** VI API 2.5 ")
