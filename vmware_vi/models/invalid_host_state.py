...
class InvalidHostState(InvalidState):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("InvalidHostState failed to lookup discriminator value from " +
...
InvalidHostState.model_rebuild(raise_errors=False)
