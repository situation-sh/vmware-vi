...
class HostMultipathInfoLogicalUnit(DataObject):
    """
    ...
    id: StrictStr = Field(description="Identifier of LogicalUnit.  Use this id to configure LogicalUnit multipathing policy using *HostStorageSystem.SetMultipathLunPolicy*. ")
    lun: ScsiLun
    path: List[HostMultipathInfoPath] = Field(description="Array of paths available to access this LogicalUnit. ")
    policy: HostMultipathInfoLogicalUnitPolicy
    storage_array_type_policy: Optional[HostMultipathInfoLogicalUnitStorageArrayTypePolicy] = Field(default=None, alias="storageArrayTypePolicy")
...
HostMultipathInfoLogicalUnit.model_rebuild(raise_errors=False)
