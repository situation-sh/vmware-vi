...
class GuestAuthenticationChallenge(GuestOperationsFault):
    ...
    """ # noqa: E501
    server_challenge: GuestAuthentication = Field(alias="serverChallenge")
    session_id: StrictInt = Field(description="Contains a session ID number that associates the server response with the initial request.  ***Since:*** vSphere API 5.0 ", alias="sessionID")
