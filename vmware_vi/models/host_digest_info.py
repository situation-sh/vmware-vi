...
class HostDigestInfo(DataObject):
    """
    This data object type describes the digest information  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    digest_method: StrictStr = Field(description="Method in which the digest value is calculated.  The set of possible values is described in *HostDigestInfoDigestMethodType_enum*.  ***Since:*** vSphere API 4.0 ", alias="digestMethod")
    digest_value: List[Annotated[int, Field(le=127, strict=True, ge=-128)]] = Field(description="The variable length byte array containing the digest value calculated by the specified digestMethod.  ***Since:*** vSphere API 4.0 ", alias="digestValue")
    object_name: Optional[StrictStr] = Field(default=None, description="The name of the object from which this digest value is calcaulated.  ***Since:*** vSphere API 4.0 ", alias="objectName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostDigestInfo failed to lookup discriminator value from " +
...
HostDigestInfo.model_rebuild(raise_errors=False)
