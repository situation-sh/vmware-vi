...
class NoPermission(SecurityError):
    ...
    """ # noqa: E501
    object: Optional[ManagedObjectReference] = None
    privilege_id: Optional[StrictStr] = Field(default=None, description="Deprecated as of vSphere 8.0, use the *NoPermission.missingPrivileges* field.  The privilege identifier required ", alias="privilegeId")
    missing_privileges: Optional[List[NoPermissionEntityPrivileges]] = Field(default=None, description="List of entities and missing privileges for each entity ", alias="missingPrivileges")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("NoPermission failed to lookup discriminator value from " +
...
NoPermission.model_rebuild(raise_errors=False)
