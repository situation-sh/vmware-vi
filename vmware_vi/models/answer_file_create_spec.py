...
class AnswerFileCreateSpec(DataObject):
    """
    Base class for host-specific answer file options.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    validating: Optional[StrictBool] = Field(default=None, description="If \"false\", then the answer file will be saved without being validated.  The default if not specified is \"true\". This option should be used with caution, since the resulting answer file will not be checked for errors.  ***Since:*** vSphere API 6.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("AnswerFileCreateSpec failed to lookup discriminator value from " +
...
AnswerFileCreateSpec.model_rebuild(raise_errors=False)
