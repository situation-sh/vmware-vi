...
class ResourcePoolEvent(Event):
    ...
    """ # noqa: E501
    resource_pool: ResourcePoolEventArgument = Field(alias="resourcePool")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ResourcePoolEvent failed to lookup discriminator value from " +
...
ResourcePoolEvent.model_rebuild(raise_errors=False)
