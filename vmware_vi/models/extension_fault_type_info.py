...
class ExtensionFaultTypeInfo(DataObject):
    """
    This data object type describes fault types defined by the extension.  ***Since:*** VI API 2.5 
    """ # noqa: E501
    fault_id: StrictStr = Field(description="The ID of the fault type.  Should follow java package naming conventions for uniqueness.  ***Since:*** VI API 2.5 ", alias="faultID")
