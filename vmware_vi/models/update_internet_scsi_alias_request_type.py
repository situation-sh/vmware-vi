...
class UpdateInternetScsiAliasRequestType(BaseModel):
    """
    ...
    i_scsi_alias: StrictStr = Field(description="The new value for the alias of the adapter. ", alias="iScsiAlias")
    __properties: ClassVar[List[str]] = ["iScsiHbaDevice", "iScsiAlias"]
