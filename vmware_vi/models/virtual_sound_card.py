...
class VirtualSoundCard(VirtualDevice):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualSoundCard failed to lookup discriminator value from " +
...
VirtualSoundCard.model_rebuild(raise_errors=False)
