...
class MoveIntoRequestType(BaseModel):
    """
    The parameters of *ClusterComputeResource.MoveInto_Task*. 
    """ # noqa: E501
    host: List[ManagedObjectReference] = Field(description="The list of hosts to move into the cluster.  ***Required privileges:*** Host.Inventory.MoveHost  Refers instances of *HostSystem*. ")
