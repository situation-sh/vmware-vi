...
class VsanUpgradeSystemNetworkPartitionIssue(VsanUpgradeSystemPreflightCheckIssue):
    """
    ...
    """ # noqa: E501
    partitions: List[VsanUpgradeSystemNetworkPartitionInfo] = Field(description="List of network partitions  ***Since:*** vSphere API 6.0 ")
