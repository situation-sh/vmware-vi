...
class GuestRegValueMultiStringSpec(GuestRegValueDataSpec):
    """
    This describes the registry value multi string.  ***Since:*** vSphere API 6.0 
    """ # noqa: E501
    value: Optional[List[StrictStr]] = Field(default=None, description="The data of the registry value.  The Windows registry allows this type of value to exist without having any data associated with it.  ***Since:*** vSphere API 6.0 ")
