...
class HourlyTaskScheduler(RecurrentTaskScheduler):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HourlyTaskScheduler failed to lookup discriminator value from " +
...
HourlyTaskScheduler.model_rebuild(raise_errors=False)
