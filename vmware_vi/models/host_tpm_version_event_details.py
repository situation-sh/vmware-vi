...
class HostTpmVersionEventDetails(HostTpmEventDetails):
    """
    Details of a Trusted Platform Module (TPM) event recording the measurement of a module version. 
    """ # noqa: E501
    version: Union[StrictBytes, StrictStr] = Field(description="A packed structure containing the module version. ")
