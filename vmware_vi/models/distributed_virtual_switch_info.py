...
class DistributedVirtualSwitchInfo(DataObject):
    """
    ...
    distributed_virtual_switch: ManagedObjectReference = Field(alias="distributedVirtualSwitch")
    network_reservation_supported: Optional[StrictBool] = Field(default=None, description="Indicates whether network bandwidth reservation is supported on the switch  ***Since:*** vSphere API 6.0 ", alias="networkReservationSupported")
