...
class HostVirtualSwitchAutoBridge(HostVirtualSwitchBridge):
    ...
    """ # noqa: E501
    excluded_nic_device: Optional[List[StrictStr]] = Field(default=None, description="List of physical network adapters that have been excluded from participating in the AutoBridge  ***Since:*** VI API 2.5 ", alias="excludedNicDevice")
