...
class RDMNotSupported(DeviceNotSupported):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("RDMNotSupported failed to lookup discriminator value from " +
...
RDMNotSupported.model_rebuild(raise_errors=False)
