...
class VirtualDiskRawDiskVer2BackingOption(VirtualDeviceDeviceBackingOption):
    ...
    """ # noqa: E501
    descriptor_file_name_extensions: ChoiceOption = Field(alias="descriptorFileNameExtensions")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDiskRawDiskVer2BackingOption failed to lookup discriminator value from " +
...
VirtualDiskRawDiskVer2BackingOption.model_rebuild(raise_errors=False)
