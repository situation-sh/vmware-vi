...
class VmInstanceUuidChangedEvent(VmEvent):
    ...
    """ # noqa: E501
    old_instance_uuid: StrictStr = Field(description="The old instance UUID.  ***Since:*** vSphere API 4.0 ", alias="oldInstanceUuid")
    new_instance_uuid: StrictStr = Field(description="The new instance UUID.  ***Since:*** vSphere API 4.0 ", alias="newInstanceUuid")
