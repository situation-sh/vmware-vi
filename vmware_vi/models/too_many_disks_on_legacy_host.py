...
class TooManyDisksOnLegacyHost(MigrationFault):
    ...
    """ # noqa: E501
    disk_count: StrictInt = Field(description="The number disks this VM has.  ***Since:*** VI API 2.5 ", alias="diskCount")
    timeout_danger: StrictBool = Field(description="Whether this number of disks will cause a timeout failure.  ***Since:*** VI API 2.5 ", alias="timeoutDanger")
