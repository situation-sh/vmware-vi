...
class TaskInProgress(VimFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("TaskInProgress failed to lookup discriminator value from " +
...
TaskInProgress.model_rebuild(raise_errors=False)
