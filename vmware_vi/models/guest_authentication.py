...
class GuestAuthentication(DataObject):
    """
    GuestAuthentication is an abstract base class for authentication in the guest.  ***Since:*** vSphere API 5.0 
    """ # noqa: E501
    interactive_session: StrictBool = Field(description="This is set to true if the client wants an interactive session in the guest.  Setting this is supported only for *NamePasswordAuthentication*.  ***Since:*** vSphere API 5.0 ", alias="interactiveSession")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("GuestAuthentication failed to lookup discriminator value from " +
...
GuestAuthentication.model_rebuild(raise_errors=False)
