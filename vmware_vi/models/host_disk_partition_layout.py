...
class HostDiskPartitionLayout(DataObject):
    """
    ...
    """ # noqa: E501
    total: Optional[HostDiskDimensionsLba] = None
    partition: List[HostDiskPartitionBlockRange] = Field(description="List of block ranges on the disk. ")
