...
class RevertToCurrentSnapshotRequestType(BaseModel):
    """
    The parameters of *VirtualMachine.RevertToCurrentSnapshot_Task*. 
    """ # noqa: E501
    host: Optional[ManagedObjectReference] = None
    suppress_power_on: Optional[StrictBool] = Field(default=None, description="(optional) If set to true, the virtual machine will not be powered on regardless of the power state when the current snapshot was created. Default to false. ", alias="suppressPowerOn")
    __properties: ClassVar[List[str]] = ["host", "suppressPowerOn"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "suppressPowerOn": obj.get("suppressPowerOn")
        })
        return _obj
