...
class HostUnresolvedVmfsResignatureSpec(DataObject):
    """
    Specification to resignature an Unresolved VMFS volume.  ***Since:*** vSphere API 4.0 
    """ # noqa: E501
    extent_device_path: List[StrictStr] = Field(description="List of device path each specifying VMFS extents.  ***Since:*** vSphere API 4.0 ", alias="extentDevicePath")
