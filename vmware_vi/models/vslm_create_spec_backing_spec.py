...
class VslmCreateSpecBackingSpec(DataObject):
    """
    Specification of the backing of a virtual storage object.  ***Since:*** vSphere API 6.5 
    """ # noqa: E501
    datastore: ManagedObjectReference
    path: Optional[StrictStr] = Field(default=None, description="Relative location in the specified datastore where disk needs to be created.  If not specified disk gets created at the defualt VStorageObject location on the specified datastore.  ***Since:*** vSphere API 6.7 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VslmCreateSpecBackingSpec failed to lookup discriminator value from " +
...
VslmCreateSpecBackingSpec.model_rebuild(raise_errors=False)
