...
class DVSUplinkPortPolicy(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("DVSUplinkPortPolicy failed to lookup discriminator value from " +
...
DVSUplinkPortPolicy.model_rebuild(raise_errors=False)
