...
class RemoveAuthorizationRoleRequestType(BaseModel):
    """
    The parameters of *AuthorizationManager.RemoveAuthorizationRole*. 
    """ # noqa: E501
    role_id: StrictInt = Field(alias="roleId")
    fail_if_used: StrictBool = Field(description="If true, prevents the role from being removed if any permissions are using it. ", alias="failIfUsed")
    __properties: ClassVar[List[str]] = ["roleId", "failIfUsed"]
