...
class UpdateAssignableHardwareConfigRequestType(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "config": HostAssignableHardwareConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None
        })
        return _obj
