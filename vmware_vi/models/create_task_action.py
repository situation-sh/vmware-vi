...
class CreateTaskAction(Action):
    ...
    """ # noqa: E501
    task_type_id: StrictStr = Field(description="Extension registered task type identifier for type of task being created.  ***Since:*** VI API 2.5 ", alias="taskTypeId")
    cancelable: StrictBool = Field(description="Whether the task should be cancelable.  ***Since:*** VI API 2.5 ")
