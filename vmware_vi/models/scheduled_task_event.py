...
class ScheduledTaskEvent(Event):
    ...
    """ # noqa: E501
    scheduled_task: ScheduledTaskEventArgument = Field(alias="scheduledTask")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ScheduledTaskEvent failed to lookup discriminator value from " +
...
ScheduledTaskEvent.model_rebuild(raise_errors=False)
