...
class IncompatibleHostForFtSecondary(VmFaultToleranceIssue):
    ...
    error: Optional[List[MethodFault]] = Field(default=None, description="Information on why the host that was specified could not be used for the FaultTolerance Secondary VirtualMachine.  ***Since:*** vSphere API 4.0 ")
