...
class InsufficientAgentVmsDeployed(InsufficientResourcesFault):
    ...
    required_num_agent_vms: StrictInt = Field(description="The number of agent virtual machines required to be deployed on the host.  ***Since:*** vSphere API 5.0 ", alias="requiredNumAgentVms")
    current_num_agent_vms: StrictInt = Field(description="The number of agent virtual machines currently deployed on the host.  ***Since:*** vSphere API 5.0 ", alias="currentNumAgentVms")
