...
class RemoveSmartCardTrustAnchorRequestType(BaseModel):
    """
    ...
    serial: StrictStr = Field(description="Certificate serial number (decimal integer) ")
    __properties: ClassVar[List[str]] = ["issuer", "serial"]
