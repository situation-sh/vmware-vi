...
class SessionTerminatedEvent(SessionEvent):
    ...
    """ # noqa: E501
    session_id: StrictStr = Field(description="The unique identifier of the terminated session. ", alias="sessionId")
    terminated_username: StrictStr = Field(description="The name of the user owning the terminated session. ", alias="terminatedUsername")
