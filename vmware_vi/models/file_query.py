...
class FileQuery(DataObject):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("FileQuery failed to lookup discriminator value from " +
...
FileQuery.model_rebuild(raise_errors=False)
