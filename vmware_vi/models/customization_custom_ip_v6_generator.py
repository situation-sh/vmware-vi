...
class CustomizationCustomIpV6Generator(CustomizationIpV6Generator):
    ...
    """ # noqa: E501
    argument: Optional[StrictStr] = Field(default=None, description="An optional argument that is passed to the utility for this ipv6 address.  The meaning of this field is user-defined, in the script.  ***Since:*** vSphere API 4.0 ")
