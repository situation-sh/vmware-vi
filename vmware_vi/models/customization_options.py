...
class CustomizationOptions(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("CustomizationOptions failed to lookup discriminator value from " +
...
CustomizationOptions.model_rebuild(raise_errors=False)
