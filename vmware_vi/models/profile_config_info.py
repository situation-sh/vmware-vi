...
class ProfileConfigInfo(DataObject):
    """
    ProfileConfigInfo
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the profile  ***Since:*** vSphere API 4.0 ")
    ...
    enabled: StrictBool = Field(description="Flag indicating if the Profile is enabled  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("ProfileConfigInfo failed to lookup discriminator value from " +
...
ProfileConfigInfo.model_rebuild(raise_errors=False)
