...
class RectifyDvsOnHostRequestType(BaseModel):
    """
    The parameters of *DistributedVirtualSwitchManager.RectifyDvsOnHost_Task*. 
    """ # noqa: E501
    hosts: List[ManagedObjectReference] = Field(description="The hosts to be rectified.  Refers instances of *HostSystem*. ")
