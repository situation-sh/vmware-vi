...
class VmDasBeingResetWithScreenshotEvent(VmDasBeingResetEvent):
    ...
    """ # noqa: E501
    screenshot_file_path: StrictStr = Field(description="The datastore path of the screenshot taken before resetting.  ***Since:*** vSphere API 4.0 ", alias="screenshotFilePath")
