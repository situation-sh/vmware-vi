...
class RemoveInternetScsiStaticTargetsRequestType(BaseModel):
    """
    ...
    targets: List[HostInternetScsiHbaStaticTarget] = Field(description="An array of iSCSI static targets to remove. ")
    __properties: ClassVar[List[str]] = ["iScsiHbaDevice", "targets"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "targets": [HostInternetScsiHbaStaticTarget.from_dict(_item) for _item in obj.get("targets")] if obj.get("targets") is not None else None
        })
        return _obj
