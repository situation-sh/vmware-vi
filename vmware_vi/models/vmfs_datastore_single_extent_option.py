...
class VmfsDatastoreSingleExtentOption(VmfsDatastoreBaseOption):
    ...
    """ # noqa: E501
    vmfs_extent: HostDiskPartitionBlockRange = Field(alias="vmfsExtent")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmfsDatastoreSingleExtentOption failed to lookup discriminator value from " +
...
VmfsDatastoreSingleExtentOption.model_rebuild(raise_errors=False)
