...
class ProfileDescriptionSection(DataObject):
    """
    ...
    message: Optional[List[LocalizableMessage]] = Field(default=None, description="List of messages that make up the section.  ***Since:*** vSphere API 4.0 ")
