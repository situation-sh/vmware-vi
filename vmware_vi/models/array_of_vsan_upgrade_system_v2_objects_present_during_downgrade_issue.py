...
class ArrayOfVsanUpgradeSystemV2ObjectsPresentDuringDowngradeIssue(Any):
    """
    A boxed array of *VsanUpgradeSystemV2ObjectsPresentDuringDowngradeIssue*. To be used in *Any* placeholders. 
    """ # noqa: E501
    value: List[VsanUpgradeSystemV2ObjectsPresentDuringDowngradeIssue] = Field(alias="_value")
