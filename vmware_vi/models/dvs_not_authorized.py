...
class DvsNotAuthorized(DvsFault):
    ...
    """ # noqa: E501
    session_extension_key: Optional[StrictStr] = Field(default=None, description="The extension key associated with the user-session.  ***Since:*** vSphere API 4.0 ", alias="sessionExtensionKey")
    dvs_extension_key: Optional[StrictStr] = Field(default=None, description="The value of *DVSConfigInfo.extensionKey*.  ***Since:*** vSphere API 4.0 ", alias="dvsExtensionKey")
