...
class HostStorageElementInfo(HostHardwareElementInfo):
    ...
    """ # noqa: E501
    operational_info: Optional[List[HostStorageOperationalInfo]] = Field(default=None, description="Other information regarding the operational state of the storage element.  ***Since:*** VI API 2.5 ", alias="operationalInfo")
