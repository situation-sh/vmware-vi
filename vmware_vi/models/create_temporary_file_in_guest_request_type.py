...
class CreateTemporaryFileInGuestRequestType(BaseModel):
    """
    The parameters of *GuestFileManager.CreateTemporaryFileInGuest*. 
    """ # noqa: E501
    vm: ManagedObjectReference
    auth: GuestAuthentication
    prefix: StrictStr = Field(description="The prefix to be given to the new temporary file. ")
    suffix: StrictStr = Field(description="The suffix to be given to the new temporary file. ")
    directory_path: Optional[StrictStr] = Field(default=None, description="The complete path to the directory in which to create the file. If unset, or an empty string, a guest-specific location will be used. ", alias="directoryPath")
