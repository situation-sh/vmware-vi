...
class VirtualDiskDeltaDiskFormatsSupported(DataObject):
    """
    Delta disk format supported for each datastore type.  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    datastore_type: StrictStr = Field(description="Datastore type name  ***Since:*** vSphere API 5.1 ", alias="datastoreType")
