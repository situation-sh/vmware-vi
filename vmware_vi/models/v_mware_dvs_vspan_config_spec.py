...
class VMwareDVSVspanConfigSpec(DataObject):
    """
    ...
    """ # noqa: E501
    vspan_session: VMwareVspanSession = Field(alias="vspanSession")
    operation: StrictStr = Field(description="Operation type, see *ConfigSpecOperation_enum* for valid values.  ***Since:*** vSphere API 5.0 ")
