...
class AffinityConfigured(MigrationFault):
    ...
    """ # noqa: E501
    configured_affinity: List[StrictStr] = Field(description="Configured affinity types for the virtual machine.  See *AffinityType_enum* for valid values. ", alias="configuredAffinity")
