...
class ClusterFixedSizeSlotPolicy(ClusterSlotPolicy):
    """
    This policy allows setting a fixed slot size  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    cpu: StrictInt = Field(description="The cpu component of the slot size (in MHz)  ***Since:*** vSphere API 5.1 ")
    memory: StrictInt = Field(description="The memory component of the slot size (in megabytes)  ***Since:*** vSphere API 5.1 ")
