...
class EnteringStandbyModeEvent(HostEvent):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("EnteringStandbyModeEvent failed to lookup discriminator value from " +
...
EnteringStandbyModeEvent.model_rebuild(raise_errors=False)
