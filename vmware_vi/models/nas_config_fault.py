...
class NasConfigFault(HostConfigFault):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Nas datastore being configured.  ***Since:*** vSphere API 4.0 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("NasConfigFault failed to lookup discriminator value from " +
...
NasConfigFault.model_rebuild(raise_errors=False)
