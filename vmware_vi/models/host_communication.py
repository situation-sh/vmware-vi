...
class HostCommunication(RuntimeFault):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostCommunication failed to lookup discriminator value from " +
...
HostCommunication.model_rebuild(raise_errors=False)
