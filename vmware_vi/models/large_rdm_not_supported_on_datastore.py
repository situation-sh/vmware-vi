...
class LargeRDMNotSupportedOnDatastore(VmConfigFault):
    ...
    """ # noqa: E501
    device: StrictStr = Field(description="The label of the 2TB+ RDM device that would have its backing placed on the datastore.  This is not guaranteed to be the only such device.  ***Since:*** vSphere API 5.0 ")
    datastore: ManagedObjectReference
    datastore_name: StrictStr = Field(description="The name of the datastore.  ***Since:*** vSphere API 5.0 ", alias="datastoreName")
