...
class VirtualDeviceFileBackingOption(VirtualDeviceBackingOption):
    ...
    """ # noqa: E501
    file_name_extensions: Optional[ChoiceOption] = Field(default=None, alias="fileNameExtensions")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualDeviceFileBackingOption failed to lookup discriminator value from " +
...
VirtualDeviceFileBackingOption.model_rebuild(raise_errors=False)
