...
class PlatformConfigFault(HostConfigFault):
    ...
    """ # noqa: E501
    text: StrictStr = Field(description="Platform specific text string describing this error. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("PlatformConfigFault failed to lookup discriminator value from " +
...
PlatformConfigFault.model_rebuild(raise_errors=False)
