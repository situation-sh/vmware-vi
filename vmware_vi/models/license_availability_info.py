...
class LicenseAvailabilityInfo(DataObject):
    """
    ...
    total: StrictInt = Field(description="Total number of licenses for this given type that are installed on the source. ")
    available: StrictInt = Field(description="The number of licenses that have not yet been reserved on the source. ")
