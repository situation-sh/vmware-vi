...
class VmWwnAssignedEvent(VmEvent):
    ...
    """ # noqa: E501
    node_wwns: List[StrictInt] = Field(description="The new node WWN.  ***Since:*** VI API 2.5 ", alias="nodeWwns")
    port_wwns: List[StrictInt] = Field(description="The new port WWN.  ***Since:*** VI API 2.5 ", alias="portWwns")
