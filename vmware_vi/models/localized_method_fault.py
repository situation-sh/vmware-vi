...
class LocalizedMethodFault(DataObject):
    ...
    """ # noqa: E501
    fault: MethodFault
    localized_message: Optional[StrictStr] = Field(default=None, description="The localized message that would be sent in the faultstring element of the SOAP Fault.  It is optional so that clients are not required to send a localized message to the server, but servers are required to send the localized message to clients. ", alias="localizedMessage")
