...
class VspanPortMoveFault(DvsFault):
    ...
    """ # noqa: E501
    src_portgroup_name: StrictStr = Field(description="The key of the source portgroup.  ***Since:*** vSphere API 5.0 ", alias="srcPortgroupName")
    dest_portgroup_name: StrictStr = Field(description="The key of the dest portgroup.  ***Since:*** vSphere API 5.0 ", alias="destPortgroupName")
    port_key: StrictStr = Field(description="The key of the port.  ***Since:*** vSphere API 5.0 ", alias="portKey")
