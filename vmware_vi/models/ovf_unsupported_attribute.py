...
class OvfUnsupportedAttribute(OvfUnsupportedPackage):
    ...
    """ # noqa: E501
    element_name: StrictStr = Field(description="The name of the element with the unsupported attribute  ***Since:*** vSphere API 4.0 ", alias="elementName")
    attribute_name: StrictStr = Field(description="The name of the unsupported attribute  ***Since:*** vSphere API 4.0 ", alias="attributeName")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("OvfUnsupportedAttribute failed to lookup discriminator value from " +
...
OvfUnsupportedAttribute.model_rebuild(raise_errors=False)
