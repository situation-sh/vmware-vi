...
class VmwareDistributedVirtualSwitchVlanSpec(InheritablePolicy):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VmwareDistributedVirtualSwitchVlanSpec failed to lookup discriminator value from " +
...
VmwareDistributedVirtualSwitchVlanSpec.model_rebuild(raise_errors=False)
