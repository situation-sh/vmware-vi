...
class StringOption(OptionType):
    ...
    """ # noqa: E501
    default_value: StrictStr = Field(description="The default value. ", alias="defaultValue")
    valid_characters: Optional[StrictStr] = Field(default=None, description="The string containing the set of valid characters.  If a string option is not specified, all strings are allowed. ", alias="validCharacters")
