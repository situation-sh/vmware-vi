...
class PatchBinariesNotFound(VimFault):
    ...
    """ # noqa: E501
    patch_id: StrictStr = Field(description="The patch whose associated binaries are not found. ", alias="patchID")
    binary: Optional[List[StrictStr]] = Field(default=None, description="The binaries that are not found. ")
