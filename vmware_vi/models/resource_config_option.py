...
class ResourceConfigOption(DataObject):
    """
    ...
    """ # noqa: E501
    cpu_allocation_option: ResourceAllocationOption = Field(alias="cpuAllocationOption")
    memory_allocation_option: ResourceAllocationOption = Field(alias="memoryAllocationOption")
