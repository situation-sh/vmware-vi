...
class ClusterHostRecommendation(DataObject):
    """
    ...
    rating: StrictInt = Field(description="Rating for the recommendation.  Ratings range from 1 to 5, and the higher the rating, the stronger DRS suggests this host is picked for the operation. ")
