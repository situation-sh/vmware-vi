...
class CryptoSpecNoOp(CryptoSpec):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("CryptoSpecNoOp failed to lookup discriminator value from " +
...
CryptoSpecNoOp.model_rebuild(raise_errors=False)
