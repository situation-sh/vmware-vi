...
class HostFibreChannelHba(HostHostBusAdapter):
    ...
    """ # noqa: E501
    port_world_wide_name: StrictInt = Field(description="The world wide port name for the adapter. ", alias="portWorldWideName")
    node_world_wide_name: StrictInt = Field(description="The world wide node name for the adapter. ", alias="nodeWorldWideName")
    port_type: FibreChannelPortTypeEnum = Field(alias="portType")
    speed: StrictInt = Field(description="The current operating speed of the adapter in bits per second. ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self]:
        ...
        if object_type:
            ...
            raise ValueError("HostFibreChannelHba failed to lookup discriminator value from " +
...
HostFibreChannelHba.model_rebuild(raise_errors=False)
