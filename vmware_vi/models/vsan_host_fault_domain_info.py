...
class VsanHostFaultDomainInfo(DataObject):
    """
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The configured VSAN fault domain.  The length of fault domain name should not exceed 256. Empty string indicates that the default fault domain is used.  ***Since:*** vSphere API 6.0 ")
