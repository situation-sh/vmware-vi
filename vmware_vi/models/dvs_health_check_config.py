...
class DVSHealthCheckConfig(DataObject):
    """
    The *DVSHealthCheckConfig* data object defines vSphere Distributed Switch health check configuration.  ***Since:*** vSphere API 5.1 
    """ # noqa: E501
    enable: Optional[StrictBool] = Field(default=None, description="True if enable health check.  ***Since:*** vSphere API 5.1 ")
    interval: Optional[StrictInt] = Field(default=None, description="Interval of health check, in minutes.  ***Since:*** vSphere API 5.1 ")
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("DVSHealthCheckConfig failed to lookup discriminator value from " +
...
DVSHealthCheckConfig.model_rebuild(raise_errors=False)
