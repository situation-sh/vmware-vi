...
class UnSupportedDatastoreForVFlash(UnsupportedDatastore):
    ...
    """ # noqa: E501
    datastore_name: StrictStr = Field(description="The name of the Datastore.  ***Since:*** vSphere API 5.5 ", alias="datastoreName")
    type: StrictStr = Field(description="Datastore file system volume type.  See *DatastoreSummary.type*  ***Since:*** vSphere API 5.5 ")
