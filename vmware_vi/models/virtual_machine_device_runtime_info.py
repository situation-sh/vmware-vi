...
class VirtualMachineDeviceRuntimeInfo(DataObject):
    """
    ...
    """ # noqa: E501
    runtime_state: VirtualMachineDeviceRuntimeInfoDeviceRuntimeState = Field(alias="runtimeState")
    key: StrictInt = Field(description="The device key.  ***Since:*** vSphere API 4.1 ")
