...
class GatewayToHostAuthFault(GatewayToHostConnectFault):
    ...
    """ # noqa: E501
    invalid_properties: List[StrictStr] = Field(description="List of properties that have been provided in the authentication data but have wrong values.  ***Since:*** vSphere API 6.0 ", alias="invalidProperties")
    missing_properties: List[StrictStr] = Field(description="List of properties that do not have their values specified in the provided authentication data but are required.  ***Since:*** vSphere API 6.0 ", alias="missingProperties")
