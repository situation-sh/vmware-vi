...
class ClusterDrsFaults(DataObject):
    """
    ...
    """ # noqa: E501
    reason: StrictStr = Field(description="A reason code explaining why this set of recommendations were attempted by DRS when it generated the faults.  ***Since:*** vSphere API 4.0 ")
    faults_by_vm: List[ClusterDrsFaultsFaultsByVm] = Field(description="The faults grouped by VMs that DRS was trying to migrate.  ***Since:*** vSphere API 4.0 ", alias="faultsByVm")
