...
class CustomizationCustomIpGenerator(CustomizationIpGenerator):
    ...
    """ # noqa: E501
    argument: Optional[StrictStr] = Field(default=None, description="An optional argument that is passed to the utility for this IP address.  The meaning of this field is user-defined, in the script. ")
