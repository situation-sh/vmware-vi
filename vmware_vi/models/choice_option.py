...
class ChoiceOption(OptionType):
    ...
    """ # noqa: E501
    choice_info: List[ElementDescription] = Field(description="The set of possible selections and descriptions. ", alias="choiceInfo")
    default_index: Optional[StrictInt] = Field(default=None, description="The index in ChoiceOption.value that serves as the default value. ", alias="defaultIndex")
