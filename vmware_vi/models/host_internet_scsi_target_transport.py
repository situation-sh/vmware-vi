...
class HostInternetScsiTargetTransport(HostTargetTransport):
    ...
    """ # noqa: E501
    i_scsi_name: StrictStr = Field(description="The iSCSI name of the target. ", alias="iScsiName")
    i_scsi_alias: StrictStr = Field(description="The iSCSI alias of the target. ", alias="iScsiAlias")
    address: Optional[List[StrictStr]] = Field(default=None, description="The IP addresses through which the target may be reached. ")
