...
class CreateNvdimmPMemNamespaceRequestType(BaseModel):
    """
    The parameters of *HostNvdimmSystem.CreateNvdimmPMemNamespace_Task*. 
    """ # noqa: E501
    create_spec: NvdimmPMemNamespaceCreateSpec = Field(alias="createSpec")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "createSpec": NvdimmPMemNamespaceCreateSpec.from_dict(obj.get("createSpec")) if obj.get("createSpec") is not None else None
        })
        return _obj
