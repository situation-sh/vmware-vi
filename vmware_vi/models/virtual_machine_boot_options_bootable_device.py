...
class VirtualMachineBootOptionsBootableDevice(DataObject):
    """
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualMachineBootOptionsBootableDevice failed to lookup discriminator value from " +
...
VirtualMachineBootOptionsBootableDevice.model_rebuild(raise_errors=False)
