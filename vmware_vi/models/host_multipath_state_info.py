...
class HostMultipathStateInfo(DataObject):
    """
    ...
    """ # noqa: E501
    path: Optional[List[HostMultipathStateInfoPath]] = Field(default=None, description="List of paths on the system and their path states.  ***Since:*** vSphere API 4.0 ")
