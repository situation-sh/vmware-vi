...
class MonthlyTaskScheduler(DailyTaskScheduler):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("MonthlyTaskScheduler failed to lookup discriminator value from " +
...
MonthlyTaskScheduler.model_rebuild(raise_errors=False)
