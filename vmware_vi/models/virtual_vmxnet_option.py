...
class VirtualVmxnetOption(VirtualEthernetCardOption):
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("VirtualVmxnetOption failed to lookup discriminator value from " +
...
VirtualVmxnetOption.model_rebuild(raise_errors=False)
