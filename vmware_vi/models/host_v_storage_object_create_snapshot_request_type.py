...
class HostVStorageObjectCreateSnapshotRequestType(BaseModel):
    """
    The parameters of *HostVStorageObjectManager.HostVStorageObjectCreateSnapshot_Task*. 
    """ # noqa: E501
    id: ID
    datastore: ManagedObjectReference
    description: StrictStr = Field(description="A short description to be associated with the snapshot. ")
    __properties: ClassVar[List[str]] = ["id", "datastore", "description"]
