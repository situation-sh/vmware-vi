...
class ConfigureHCIRequestType(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cluster_spec:
            _dict['clusterSpec'] = self.cluster_spec.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "clusterSpec": ClusterComputeResourceHCIConfigSpec.from_dict(obj.get("clusterSpec")) if obj.get("clusterSpec") is not None else None,
