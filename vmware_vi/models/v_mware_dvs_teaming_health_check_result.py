...
class VMwareDVSTeamingHealthCheckResult(HostMemberHealthCheckResult):
    """
    ...
    """ # noqa: E501
    teaming_status: StrictStr = Field(description="Teaming check status.  See *VMwareDVSTeamingMatchStatus_enum* for valid values.  ***Since:*** vSphere API 5.1 ", alias="teamingStatus")
