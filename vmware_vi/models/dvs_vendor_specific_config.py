...
class DVSVendorSpecificConfig(InheritablePolicy):
    ...
    """ # noqa: E501
    key_value: Optional[List[DistributedVirtualSwitchKeyedOpaqueBlob]] = Field(default=None, description="An opaque binary blob that stores vendor specific configuration.  ***Since:*** vSphere API 4.0 ", alias="keyValue")
