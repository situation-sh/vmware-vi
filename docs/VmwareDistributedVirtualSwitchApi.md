# vmware_vi.VmwareDistributedVirtualSwitchApi
...
[**vmware_distributed_virtual_switch_get_disabled_method**](VmwareDistributedVirtualSwitchApi.md#vmware_distributed_virtual_switch_get_disabled_method) | **GET** /VmwareDistributedVirtualSwitch/{moId}/disabledMethod | List of operations that are disabled, given the current runtime state of the entity. 
...
[**vmware_distributed_virtual_switch_reconfigure_dv_port_task**](VmwareDistributedVirtualSwitchApi.md#vmware_distributed_virtual_switch_reconfigure_dv_port_task) | **POST** /VmwareDistributedVirtualSwitch/{moId}/ReconfigureDVPort_Task | Reconfigure individual ports. 
...
# **vmware_distributed_virtual_switch_get_disabled_method**
...
# **vmware_distributed_virtual_switch_get_triggered_alarm_state**
> List[AlarmState] vmware_distributed_virtual_switch_get_triggered_alarm_state(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # A set of alarm states for alarms triggered by this entity or by its descendants. 
        api_response = api_instance.vmware_distributed_virtual_switch_get_triggered_alarm_state(mo_id)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_get_triggered_alarm_state:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_get_triggered_alarm_state: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_get_uuid**
> str vmware_distributed_virtual_switch_get_uuid(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Generated UUID of the switch. 
        api_response = api_instance.vmware_distributed_virtual_switch_get_uuid(mo_id)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_get_uuid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_get_uuid: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_get_value**
> List[CustomFieldValue] vmware_distributed_virtual_switch_get_value(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # List of custom field values. 
        api_response = api_instance.vmware_distributed_virtual_switch_get_value(mo_id)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_get_value:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_get_value: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_lookup_dv_port_group**
> ManagedObjectReference vmware_distributed_virtual_switch_lookup_dv_port_group(mo_id, lookup_dv_port_group_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the portgroup identified by the key within this VDS. 
        api_response = api_instance.vmware_distributed_virtual_switch_lookup_dv_port_group(mo_id, lookup_dv_port_group_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_lookup_dv_port_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_lookup_dv_port_group: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_merge_dvs_task**
> ManagedObjectReference vmware_distributed_virtual_switch_merge_dvs_task(mo_id, merge_dvs_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Merge an existing DistributedVirtualSwitch (source) to this switch (destination). 
        api_response = api_instance.vmware_distributed_virtual_switch_merge_dvs_task(mo_id, merge_dvs_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_merge_dvs_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_merge_dvs_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_move_dv_port_task**
> ManagedObjectReference vmware_distributed_virtual_switch_move_dv_port_task(mo_id, move_dv_port_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Move the ports out of their current portgroup into the specified portgroup. 
        api_response = api_instance.vmware_distributed_virtual_switch_move_dv_port_task(mo_id, move_dv_port_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_move_dv_port_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_move_dv_port_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_perform_dvs_product_spec_operation_task**
> ManagedObjectReference vmware_distributed_virtual_switch_perform_dvs_product_spec_operation_task(mo_id, perform_dvs_product_spec_operation_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # This method updates the *DistributedVirtualSwitch* product specifications. 
        api_response = api_instance.vmware_distributed_virtual_switch_perform_dvs_product_spec_operation_task(mo_id, perform_dvs_product_spec_operation_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_perform_dvs_product_spec_operation_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_perform_dvs_product_spec_operation_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_query_used_vlan_id_in_dvs**
> List[int] vmware_distributed_virtual_switch_query_used_vlan_id_in_dvs(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Return the used VLAN ID (PVLAN excluded) in the switch. 
        api_response = api_instance.vmware_distributed_virtual_switch_query_used_vlan_id_in_dvs(mo_id)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_query_used_vlan_id_in_dvs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_query_used_vlan_id_in_dvs: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_reconfigure_dv_port_task**
> ManagedObjectReference vmware_distributed_virtual_switch_reconfigure_dv_port_task(mo_id, reconfigure_dv_port_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reconfigure individual ports. 
        api_response = api_instance.vmware_distributed_virtual_switch_reconfigure_dv_port_task(mo_id, reconfigure_dv_port_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_reconfigure_dv_port_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_reconfigure_dv_port_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_reconfigure_dvs_task**
> ManagedObjectReference vmware_distributed_virtual_switch_reconfigure_dvs_task(mo_id, reconfigure_dvs_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reconfigures a distributed virtual switch. 
        api_response = api_instance.vmware_distributed_virtual_switch_reconfigure_dvs_task(mo_id, reconfigure_dvs_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_reconfigure_dvs_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_reconfigure_dvs_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_rectify_dvs_host_task**
> ManagedObjectReference vmware_distributed_virtual_switch_rectify_dvs_host_task(mo_id, rectify_dvs_host_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update the switch configuration on the host to bring them in sync with the current configuration in vCenter Server. 
        api_response = api_instance.vmware_distributed_virtual_switch_rectify_dvs_host_task(mo_id, rectify_dvs_host_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_rectify_dvs_host_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_rectify_dvs_host_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_refresh_dv_port_state**
> vmware_distributed_virtual_switch_refresh_dv_port_state(mo_id, refresh_dv_port_state_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Refresh port states. 
        api_instance.vmware_distributed_virtual_switch_refresh_dv_port_state(mo_id, refresh_dv_port_state_request_type)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_refresh_dv_port_state: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_reload**
> vmware_distributed_virtual_switch_reload(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reload the entity state. 
        api_instance.vmware_distributed_virtual_switch_reload(mo_id)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_reload: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_remove_network_resource_pool**
> vmware_distributed_virtual_switch_remove_network_resource_pool(mo_id, remove_network_resource_pool_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove a network resource pool. 
        api_instance.vmware_distributed_virtual_switch_remove_network_resource_pool(mo_id, remove_network_resource_pool_request_type)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_remove_network_resource_pool: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_rename_task**
> ManagedObjectReference vmware_distributed_virtual_switch_rename_task(mo_id, rename_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Renames this managed entity. 
        api_response = api_instance.vmware_distributed_virtual_switch_rename_task(mo_id, rename_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_rename_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_rename_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_set_custom_value**
> vmware_distributed_virtual_switch_set_custom_value(mo_id, set_custom_value_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Assigns a value to a custom field. 
        api_instance.vmware_distributed_virtual_switch_set_custom_value(mo_id, set_custom_value_request_type)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_set_custom_value: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_update_dvs_capability**
> vmware_distributed_virtual_switch_update_dvs_capability(mo_id, update_dvs_capability_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Set the capability of the switch. 
        api_instance.vmware_distributed_virtual_switch_update_dvs_capability(mo_id, update_dvs_capability_request_type)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_update_dvs_capability: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_update_dvs_health_check_config_task**
> ManagedObjectReference vmware_distributed_virtual_switch_update_dvs_health_check_config_task(mo_id, update_dvs_health_check_config_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update health check configuration. 
        api_response = api_instance.vmware_distributed_virtual_switch_update_dvs_health_check_config_task(mo_id, update_dvs_health_check_config_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_update_dvs_health_check_config_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_update_dvs_health_check_config_task: %s\n" % e)
```
...
# **vmware_distributed_virtual_switch_update_dvs_lacp_group_config_task**
> ManagedObjectReference vmware_distributed_virtual_switch_update_dvs_lacp_group_config_task(mo_id, update_dvs_lacp_group_config_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    api_instance = vmware_vi.VmwareDistributedVirtualSwitchApi(api_client)
    mo_id = 'mo_id_example' # str | A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.
    update_dvs_lacp_group_config_request_type = vmware_vi.UpdateDVSLacpGroupConfigRequestType() # UpdateDVSLacpGroupConfigRequestType | 

    try:
        # Update Link Aggregation Control Protocol groups. 
        api_response = api_instance.vmware_distributed_virtual_switch_update_dvs_lacp_group_config_task(mo_id, update_dvs_lacp_group_config_request_type)
        print("The response of VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_update_dvs_lacp_group_config_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_update_dvs_lacp_group_config_task: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **mo_id** | **str**| A unique identifier (within this vCenter Server instance) for a specific managed object such as &#x60;group-d1&#x60; or &#x60;vm-015&#x60; or &#x60;ServiceInstance&#x60;. | 
 **update_dvs_lacp_group_config_request_type** | [**UpdateDVSLacpGroupConfigRequestType**](UpdateDVSLacpGroupConfigRequestType.md)|  | 
...
|-------------|-------------|------------------|
**200** | Refers instance of *Task*.  |  -  |
**500** | ***DvsFault***: if operation fails on any host or if there are other update failures.  ***NotSupported***: if multiple Link Aggregation Control Protocol is not supported on the switch.  |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **vmware_distributed_virtual_switch_update_network_resource_pool**
> vmware_distributed_virtual_switch_update_network_resource_pool(mo_id, update_network_resource_pool_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Update the network resource pool configuration. 
        api_instance.vmware_distributed_virtual_switch_update_network_resource_pool(mo_id, update_network_resource_pool_request_type)
    except Exception as e:
        print("Exception when calling VmwareDistributedVirtualSwitchApi->vmware_distributed_virtual_switch_update_network_resource_pool: %s\n" % e)
```
