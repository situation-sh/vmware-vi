# vmware_vi.ResourcePoolApi

All URIs are relative to *https://localhost/sdk/vim25/8.0.1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**resource_pool_create_child_vm_task**](ResourcePoolApi.md#resource_pool_create_child_vm_task) | **POST** /ResourcePool/{moId}/CreateChildVM_Task | Creates a new virtual machine in a vApp container. 
[**resource_pool_create_resource_pool**](ResourcePoolApi.md#resource_pool_create_resource_pool) | **POST** /ResourcePool/{moId}/CreateResourcePool | Creates a new resource pool. 
[**resource_pool_create_v_app**](ResourcePoolApi.md#resource_pool_create_v_app) | **POST** /ResourcePool/{moId}/CreateVApp | Creates a new vApp container. 
[**resource_pool_destroy_children**](ResourcePoolApi.md#resource_pool_destroy_children) | **POST** /ResourcePool/{moId}/DestroyChildren | Removes all child resource pools recursively. 
[**resource_pool_destroy_task**](ResourcePoolApi.md#resource_pool_destroy_task) | **POST** /ResourcePool/{moId}/Destroy_Task | Destroys this object, deleting its contents and removing it from its parent folder (if any). 
[**resource_pool_get_alarm_actions_enabled**](ResourcePoolApi.md#resource_pool_get_alarm_actions_enabled) | **GET** /ResourcePool/{moId}/alarmActionsEnabled | Whether alarm actions are enabled for this entity. 
[**resource_pool_get_available_field**](ResourcePoolApi.md#resource_pool_get_available_field) | **GET** /ResourcePool/{moId}/availableField | List of custom field definitions that are valid for the object&#39;s type. 
[**resource_pool_get_child_configuration**](ResourcePoolApi.md#resource_pool_get_child_configuration) | **GET** /ResourcePool/{moId}/childConfiguration | The resource configuration of all direct children (VirtualMachine and ResourcePool) of this resource group. 
[**resource_pool_get_config**](ResourcePoolApi.md#resource_pool_get_config) | **GET** /ResourcePool/{moId}/config | Configuration of this resource pool. 
[**resource_pool_get_config_issue**](ResourcePoolApi.md#resource_pool_get_config_issue) | **GET** /ResourcePool/{moId}/configIssue | Current configuration issues that have been detected for this entity. 
[**resource_pool_get_config_status**](ResourcePoolApi.md#resource_pool_get_config_status) | **GET** /ResourcePool/{moId}/configStatus | The configStatus indicates whether or not the system has detected a configuration issue involving this entity. 
[**resource_pool_get_custom_value**](ResourcePoolApi.md#resource_pool_get_custom_value) | **GET** /ResourcePool/{moId}/customValue | Custom field values. 
[**resource_pool_get_declared_alarm_state**](ResourcePoolApi.md#resource_pool_get_declared_alarm_state) | **GET** /ResourcePool/{moId}/declaredAlarmState | A set of alarm states for alarms that apply to this managed entity. 
[**resource_pool_get_disabled_method**](ResourcePoolApi.md#resource_pool_get_disabled_method) | **GET** /ResourcePool/{moId}/disabledMethod | List of operations that are disabled, given the current runtime state of the entity. 
[**resource_pool_get_effective_role**](ResourcePoolApi.md#resource_pool_get_effective_role) | **GET** /ResourcePool/{moId}/effectiveRole | Access rights the current session has to this entity. 
[**resource_pool_get_name**](ResourcePoolApi.md#resource_pool_get_name) | **GET** /ResourcePool/{moId}/name | Name of this entity, unique relative to its parent. 
[**resource_pool_get_namespace**](ResourcePoolApi.md#resource_pool_get_namespace) | **GET** /ResourcePool/{moId}/namespace | The namespace with which the ResourcePool is associated. 
[**resource_pool_get_overall_status**](ResourcePoolApi.md#resource_pool_get_overall_status) | **GET** /ResourcePool/{moId}/overallStatus | General health of this managed entity. 
[**resource_pool_get_owner**](ResourcePoolApi.md#resource_pool_get_owner) | **GET** /ResourcePool/{moId}/owner | The ComputeResource to which this set of one or more nested resource pools belong. 
[**resource_pool_get_parent**](ResourcePoolApi.md#resource_pool_get_parent) | **GET** /ResourcePool/{moId}/parent | Parent of this entity. 
[**resource_pool_get_permission**](ResourcePoolApi.md#resource_pool_get_permission) | **GET** /ResourcePool/{moId}/permission | List of permissions defined for this entity. 
[**resource_pool_get_recent_task**](ResourcePoolApi.md#resource_pool_get_recent_task) | **GET** /ResourcePool/{moId}/recentTask | The set of recent tasks operating on this managed entity. 
[**resource_pool_get_resource_pool**](ResourcePoolApi.md#resource_pool_get_resource_pool) | **GET** /ResourcePool/{moId}/resourcePool | The set of child resource pools. 
[**resource_pool_get_runtime**](ResourcePoolApi.md#resource_pool_get_runtime) | **GET** /ResourcePool/{moId}/runtime | Runtime information about a resource pool. 
[**resource_pool_get_summary**](ResourcePoolApi.md#resource_pool_get_summary) | **GET** /ResourcePool/{moId}/summary | Basic information about a resource pool. 
...
# **resource_pool_register_child_vm_task**
> ManagedObjectReference resource_pool_register_child_vm_task(mo_id, register_child_vm_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Adds an existing virtual machine to this resource pool or vApp. 
        api_response = api_instance.resource_pool_register_child_vm_task(mo_id, register_child_vm_request_type)
        print("The response of ResourcePoolApi->resource_pool_register_child_vm_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcePoolApi->resource_pool_register_child_vm_task: %s\n" % e)
```
...
# **resource_pool_reload**
> resource_pool_reload(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reload the entity state. 
        api_instance.resource_pool_reload(mo_id)
    except Exception as e:
        print("Exception when calling ResourcePoolApi->resource_pool_reload: %s\n" % e)
```
...
# **resource_pool_rename_task**
> ManagedObjectReference resource_pool_rename_task(mo_id, rename_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Renames this managed entity. 
        api_response = api_instance.resource_pool_rename_task(mo_id, rename_request_type)
        print("The response of ResourcePoolApi->resource_pool_rename_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcePoolApi->resource_pool_rename_task: %s\n" % e)
```
...
# **resource_pool_set_custom_value**
> resource_pool_set_custom_value(mo_id, set_custom_value_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Assigns a value to a custom field. 
        api_instance.resource_pool_set_custom_value(mo_id, set_custom_value_request_type)
    except Exception as e:
        print("Exception when calling ResourcePoolApi->resource_pool_set_custom_value: %s\n" % e)
```
...
# **resource_pool_update_child_resource_configuration**
> resource_pool_update_child_resource_configuration(mo_id, update_child_resource_configuration_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Changes resource configuration of a set of children of this resource pool. 
        api_instance.resource_pool_update_child_resource_configuration(mo_id, update_child_resource_configuration_request_type)
    except Exception as e:
        print("Exception when calling ResourcePoolApi->resource_pool_update_child_resource_configuration: %s\n" % e)
```
...
# **resource_pool_update_config**
> resource_pool_update_config(mo_id, update_config_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates the configuration of the resource pool. 
        api_instance.resource_pool_update_config(mo_id, update_config_request_type)
    except Exception as e:
        print("Exception when calling ResourcePoolApi->resource_pool_update_config: %s\n" % e)
```
