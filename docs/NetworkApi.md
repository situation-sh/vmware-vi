# vmware_vi.NetworkApi

All URIs are relative to *https://localhost/sdk/vim25/8.0.1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**network_destroy_network**](NetworkApi.md#network_destroy_network) | **POST** /Network/{moId}/DestroyNetwork | Removes a network. 
[**network_destroy_task**](NetworkApi.md#network_destroy_task) | **POST** /Network/{moId}/Destroy_Task | Destroys this object, deleting its contents and removing it from its parent folder (if any). 
[**network_get_alarm_actions_enabled**](NetworkApi.md#network_get_alarm_actions_enabled) | **GET** /Network/{moId}/alarmActionsEnabled | Whether alarm actions are enabled for this entity. 
[**network_get_available_field**](NetworkApi.md#network_get_available_field) | **GET** /Network/{moId}/availableField | List of custom field definitions that are valid for the object&#39;s type. 
[**network_get_config_issue**](NetworkApi.md#network_get_config_issue) | **GET** /Network/{moId}/configIssue | Current configuration issues that have been detected for this entity. 
[**network_get_config_status**](NetworkApi.md#network_get_config_status) | **GET** /Network/{moId}/configStatus | The configStatus indicates whether or not the system has detected a configuration issue involving this entity. 
[**network_get_custom_value**](NetworkApi.md#network_get_custom_value) | **GET** /Network/{moId}/customValue | Custom field values. 
[**network_get_declared_alarm_state**](NetworkApi.md#network_get_declared_alarm_state) | **GET** /Network/{moId}/declaredAlarmState | A set of alarm states for alarms that apply to this managed entity. 
[**network_get_disabled_method**](NetworkApi.md#network_get_disabled_method) | **GET** /Network/{moId}/disabledMethod | List of operations that are disabled, given the current runtime state of the entity. 
[**network_get_effective_role**](NetworkApi.md#network_get_effective_role) | **GET** /Network/{moId}/effectiveRole | Access rights the current session has to this entity. 
[**network_get_host**](NetworkApi.md#network_get_host) | **GET** /Network/{moId}/host | Hosts attached to this network. 
[**network_get_name**](NetworkApi.md#network_get_name) | **GET** /Network/{moId}/name | Name of this entity, unique relative to its parent. 
[**network_get_overall_status**](NetworkApi.md#network_get_overall_status) | **GET** /Network/{moId}/overallStatus | General health of this managed entity. 
[**network_get_parent**](NetworkApi.md#network_get_parent) | **GET** /Network/{moId}/parent | Parent of this entity. 
[**network_get_permission**](NetworkApi.md#network_get_permission) | **GET** /Network/{moId}/permission | List of permissions defined for this entity. 
[**network_get_recent_task**](NetworkApi.md#network_get_recent_task) | **GET** /Network/{moId}/recentTask | The set of recent tasks operating on this managed entity. 
[**network_get_summary**](NetworkApi.md#network_get_summary) | **GET** /Network/{moId}/summary | Properties of a network. 
[**network_get_tag**](NetworkApi.md#network_get_tag) | **GET** /Network/{moId}/tag | The set of tags associated with this managed entity. 
[**network_get_triggered_alarm_state**](NetworkApi.md#network_get_triggered_alarm_state) | **GET** /Network/{moId}/triggeredAlarmState | A set of alarm states for alarms triggered by this entity or by its descendants. 
[**network_get_value**](NetworkApi.md#network_get_value) | **GET** /Network/{moId}/value | List of custom field values. 
[**network_get_vm**](NetworkApi.md#network_get_vm) | **GET** /Network/{moId}/vm | Virtual machines using this network. 
[**network_reload**](NetworkApi.md#network_reload) | **POST** /Network/{moId}/Reload | Reload the entity state. 
[**network_rename_task**](NetworkApi.md#network_rename_task) | **POST** /Network/{moId}/Rename_Task | Renames this managed entity. 
[**network_set_custom_value**](NetworkApi.md#network_set_custom_value) | **POST** /Network/{moId}/setCustomValue | Assigns a value to a custom field. 


# **network_destroy_network**
> network_destroy_network(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    api_instance = vmware_vi.NetworkApi(api_client)
    mo_id = 'mo_id_example' # str | A unique identifier (within this vCenter Server instance) for a specific managed object such as `group-d1` or `vm-015` or `ServiceInstance`.

    try:
        # Removes a network. 
        api_instance.network_destroy_network(mo_id)
    except Exception as e:
        print("Exception when calling NetworkApi->network_destroy_network: %s\n" % e)
```
...
# **network_destroy_task**
> ManagedObjectReference network_destroy_task(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Destroys this object, deleting its contents and removing it from its parent folder (if any). 
        api_response = api_instance.network_destroy_task(mo_id)
        print("The response of NetworkApi->network_destroy_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_destroy_task: %s\n" % e)
```
...
# **network_get_alarm_actions_enabled**
> bool network_get_alarm_actions_enabled(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Whether alarm actions are enabled for this entity. 
        api_response = api_instance.network_get_alarm_actions_enabled(mo_id)
        print("The response of NetworkApi->network_get_alarm_actions_enabled:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_alarm_actions_enabled: %s\n" % e)
```
...
# **network_get_available_field**
> List[CustomFieldDef] network_get_available_field(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # List of custom field definitions that are valid for the object's type. 
        api_response = api_instance.network_get_available_field(mo_id)
        print("The response of NetworkApi->network_get_available_field:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_available_field: %s\n" % e)
```
...
# **network_get_config_issue**
> List[Event] network_get_config_issue(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Current configuration issues that have been detected for this entity. 
        api_response = api_instance.network_get_config_issue(mo_id)
        print("The response of NetworkApi->network_get_config_issue:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_config_issue: %s\n" % e)
```
...
# **network_get_config_status**
> ManagedEntityStatusEnum network_get_config_status(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # The configStatus indicates whether or not the system has detected a configuration issue involving this entity. 
        api_response = api_instance.network_get_config_status(mo_id)
        print("The response of NetworkApi->network_get_config_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_config_status: %s\n" % e)
```
...
# **network_get_custom_value**
> List[CustomFieldValue] network_get_custom_value(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Custom field values. 
        api_response = api_instance.network_get_custom_value(mo_id)
        print("The response of NetworkApi->network_get_custom_value:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_custom_value: %s\n" % e)
```
...
# **network_get_declared_alarm_state**
> List[AlarmState] network_get_declared_alarm_state(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # A set of alarm states for alarms that apply to this managed entity. 
        api_response = api_instance.network_get_declared_alarm_state(mo_id)
        print("The response of NetworkApi->network_get_declared_alarm_state:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_declared_alarm_state: %s\n" % e)
```
...
# **network_get_disabled_method**
> List[str] network_get_disabled_method(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # List of operations that are disabled, given the current runtime state of the entity. 
        api_response = api_instance.network_get_disabled_method(mo_id)
        print("The response of NetworkApi->network_get_disabled_method:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_disabled_method: %s\n" % e)
```
...
# **network_get_effective_role**
> List[int] network_get_effective_role(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Access rights the current session has to this entity. 
        api_response = api_instance.network_get_effective_role(mo_id)
        print("The response of NetworkApi->network_get_effective_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_effective_role: %s\n" % e)
```
...
# **network_get_host**
> List[ManagedObjectReference] network_get_host(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Hosts attached to this network. 
        api_response = api_instance.network_get_host(mo_id)
        print("The response of NetworkApi->network_get_host:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_host: %s\n" % e)
```
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Name of this entity, unique relative to its parent. 
        api_response = api_instance.network_get_name(mo_id)
        print("The response of NetworkApi->network_get_name:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_name: %s\n" % e)
```
...
# **network_get_overall_status**
> ManagedEntityStatusEnum network_get_overall_status(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # General health of this managed entity. 
        api_response = api_instance.network_get_overall_status(mo_id)
        print("The response of NetworkApi->network_get_overall_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_overall_status: %s\n" % e)
```
...
# **network_get_parent**
> ManagedObjectReference network_get_parent(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Parent of this entity. 
        api_response = api_instance.network_get_parent(mo_id)
        print("The response of NetworkApi->network_get_parent:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_parent: %s\n" % e)
```
...
> List[Permission] network_get_permission(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # List of permissions defined for this entity. 
        api_response = api_instance.network_get_permission(mo_id)
        print("The response of NetworkApi->network_get_permission:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_permission: %s\n" % e)
```
...
# **network_get_recent_task**
> List[ManagedObjectReference] network_get_recent_task(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # The set of recent tasks operating on this managed entity. 
        api_response = api_instance.network_get_recent_task(mo_id)
        print("The response of NetworkApi->network_get_recent_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_recent_task: %s\n" % e)
```
...
# **network_get_summary**
> NetworkSummary network_get_summary(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Properties of a network. 
        api_response = api_instance.network_get_summary(mo_id)
        print("The response of NetworkApi->network_get_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_summary: %s\n" % e)
```
...
# **network_get_tag**
> List[Tag] network_get_tag(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # The set of tags associated with this managed entity. 
        api_response = api_instance.network_get_tag(mo_id)
        print("The response of NetworkApi->network_get_tag:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_tag: %s\n" % e)
```
...
# **network_get_triggered_alarm_state**
> List[AlarmState] network_get_triggered_alarm_state(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # A set of alarm states for alarms triggered by this entity or by its descendants. 
        api_response = api_instance.network_get_triggered_alarm_state(mo_id)
        print("The response of NetworkApi->network_get_triggered_alarm_state:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_triggered_alarm_state: %s\n" % e)
```
...
# **network_get_value**
> List[CustomFieldValue] network_get_value(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # List of custom field values. 
        api_response = api_instance.network_get_value(mo_id)
        print("The response of NetworkApi->network_get_value:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_value: %s\n" % e)
```
...
# **network_get_vm**
> List[ManagedObjectReference] network_get_vm(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Virtual machines using this network. 
        api_response = api_instance.network_get_vm(mo_id)
        print("The response of NetworkApi->network_get_vm:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_get_vm: %s\n" % e)
```
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reload the entity state. 
        api_instance.network_reload(mo_id)
    except Exception as e:
        print("Exception when calling NetworkApi->network_reload: %s\n" % e)
```
...
# **network_rename_task**
> ManagedObjectReference network_rename_task(mo_id, rename_request_type)

Renames this managed entity. 

Renames this managed entity.  Any % (percent) character used in this name parameter must be escaped, unless it is used to start an escape sequence. Clients may also escape any other characters in this name parameter.  See also *ManagedEntity.name*.  ***Required privileges:*** System.Read 
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Renames this managed entity. 
        api_response = api_instance.network_rename_task(mo_id, rename_request_type)
        print("The response of NetworkApi->network_rename_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NetworkApi->network_rename_task: %s\n" % e)
```
...
# **network_set_custom_value**
> network_set_custom_value(mo_id, set_custom_value_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Assigns a value to a custom field. 
        api_instance.network_set_custom_value(mo_id, set_custom_value_request_type)
    except Exception as e:
        print("Exception when calling NetworkApi->network_set_custom_value: %s\n" % e)
```
