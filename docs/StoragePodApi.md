...
[**storage_pod_get_overall_status**](StoragePodApi.md#storage_pod_get_overall_status) | **GET** /StoragePod/{moId}/overallStatus | General health of this managed entity. 
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling StoragePodApi->storage_pod_get_triggered_alarm_state: %s\n" % e)
```
...
# **storage_pod_get_value**
> List[CustomFieldValue] storage_pod_get_value(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # List of custom field values. 
        api_response = api_instance.storage_pod_get_value(mo_id)
        print("The response of StoragePodApi->storage_pod_get_value:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_get_value: %s\n" % e)
```
...
# **storage_pod_move_into_folder_task**
> ManagedObjectReference storage_pod_move_into_folder_task(mo_id, move_into_folder_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Moves a set of managed entities into this folder. 
        api_response = api_instance.storage_pod_move_into_folder_task(mo_id, move_into_folder_request_type)
        print("The response of StoragePodApi->storage_pod_move_into_folder_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_move_into_folder_task: %s\n" % e)
```
...
# **storage_pod_register_vm_task**
> ManagedObjectReference storage_pod_register_vm_task(mo_id, register_vm_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Adds an existing virtual machine to the folder. 
        api_response = api_instance.storage_pod_register_vm_task(mo_id, register_vm_request_type)
        print("The response of StoragePodApi->storage_pod_register_vm_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_register_vm_task: %s\n" % e)
```
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Reload the entity state. 
        api_instance.storage_pod_reload(mo_id)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_reload: %s\n" % e)
```
...
# **storage_pod_rename_task**
> ManagedObjectReference storage_pod_rename_task(mo_id, rename_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Renames this managed entity. 
        api_response = api_instance.storage_pod_rename_task(mo_id, rename_request_type)
        print("The response of StoragePodApi->storage_pod_rename_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_rename_task: %s\n" % e)
```
...
# **storage_pod_set_custom_value**
> storage_pod_set_custom_value(mo_id, set_custom_value_request_type)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Assigns a value to a custom field. 
        api_instance.storage_pod_set_custom_value(mo_id, set_custom_value_request_type)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_set_custom_value: %s\n" % e)
```
...
# **storage_pod_unregister_and_destroy_task**
> ManagedObjectReference storage_pod_unregister_and_destroy_task(mo_id)
...
with vmware_vi.ApiClient(configuration) as api_client:
    ...
    try:
        # Recursively unregisters all virtual machines and vApps, and destroys all child virtual machine folders. 
        api_response = api_instance.storage_pod_unregister_and_destroy_task(mo_id)
        print("The response of StoragePodApi->storage_pod_unregister_and_destroy_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StoragePodApi->storage_pod_unregister_and_destroy_task: %s\n" % e)
```
